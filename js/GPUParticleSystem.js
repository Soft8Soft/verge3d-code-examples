...
v3d.GPUParticleSystem = function(options) {

    v3d.Object3D.apply(this, arguments);
    ...
    this.particleNoiseTex.wrapS = this.particleNoiseTex.wrapT = v3d.RepeatWrapping;

    this.particleSpriteTex = this.PARTICLE_SPRITE_TEXTURE || textureLoader.load('textures/particle2.png');
    this.particleSpriteTex.wrapS = this.particleSpriteTex.wrapT = v3d.RepeatWrapping;

    this.particleShaderMat = new v3d.ShaderMaterial({
        transparent: true,
        depthWrite: false,
        uniforms: {
            'uTime': {
    ...
    this.init = function() {
        ...
        for (var i = 0; i < this.PARTICLE_CONTAINERS; i++) {
            ...
            var c = new v3d.GPUParticleContainer(this.PARTICLES_PER_CONTAINER, this);
...
v3d.GPUParticleSystem.prototype = Object.create(v3d.Object3D.prototype);
v3d.GPUParticleSystem.prototype.constructor = v3d.GPUParticleSystem;


// Subclass for particle containers, allows for very large arrays to be spread out

v3d.GPUParticleContainer = function(maxParticles, particleSystem) {
    ...
    this.particleShaderGeo = new v3d.BufferGeometry();

    this.particleShaderGeo.addAttribute('position', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3).setDynamic(true));
    this.particleShaderGeo.addAttribute('positionStart', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3).setDynamic(true));
    this.particleShaderGeo.addAttribute('startTime', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1).setDynamic(true));
    this.particleShaderGeo.addAttribute('velocity', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3).setDynamic(true));
    this.particleShaderGeo.addAttribute('turbulence', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1).setDynamic(true));
    this.particleShaderGeo.addAttribute('color', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3).setDynamic(true));
    this.particleShaderGeo.addAttribute('size', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1).setDynamic(true));
    this.particleShaderGeo.addAttribute('lifeTime', new v3d.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1).setDynamic(true));
    ...
    this.spawnParticle = function(options) {
        ...
        velX = v3d.Math.clamp((velX - (- maxVel)) / (maxVel - (- maxVel)), 0, 1);
        velY = v3d.Math.clamp((velY - (- maxVel)) / (maxVel - (- maxVel)), 0, 1);
        velZ = v3d.Math.clamp((velZ - (- maxVel)) / (maxVel - (- maxVel)), 0, 1);
        ...
        color.r = v3d.Math.clamp(color.r + particleSystem.random() * colorRandomness, 0, 1);
        color.g = v3d.Math.clamp(color.g + particleSystem.random() * colorRandomness, 0, 1);
        color.b = v3d.Math.clamp(color.b + particleSystem.random() * colorRandomness, 0, 1);
    ...
    this.init = function() {
        ...
        this.particleSystem = new v3d.Points(this.particleShaderGeo, this.particleShaderMat);
...
v3d.GPUParticleContainer.prototype = Object.create(v3d.Object3D.prototype);
v3d.GPUParticleContainer.prototype.constructor = v3d.GPUParticleContainer;
