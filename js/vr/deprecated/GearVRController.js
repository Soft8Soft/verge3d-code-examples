...
v3d.GearVRController = function() {
    ...
    var angularVelocity = new v3d.Vector3();
    ...
    this.getTouchPadState = function() {
        ...
        console.warn('v3d.GearVRController: getTouchPadState() is now getTouchpadState()');
        return touchpadIsPressed;
    ...
    this.setHand = function() {
        ...
        console.warn('v3d.GearVRController: setHand() has been removed.');

    };

};

v3d.GearVRController.prototype = Object.create(v3d.Object3D.prototype);
v3d.GearVRController.prototype.constructor = v3d.GearVRController;
