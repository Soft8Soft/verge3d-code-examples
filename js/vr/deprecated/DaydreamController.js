...
v3d.DaydreamController = function() {
    ...
    this.getTouchPadState = function() {
        ...
        console.warn('v3d.DaydreamController: getTouchPadState() is now getTouchpadState()');
        return touchpadIsPressed;
...
v3d.DaydreamController.prototype = Object.create(v3d.Object3D.prototype);
v3d.DaydreamController.prototype.constructor = v3d.DaydreamController;
