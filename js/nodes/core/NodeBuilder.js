...
NodeBuilder.prototype = {
            ...
            if (nodeCandidate !== undefined) {
                ...
                if (nodeCandidate.isNode) {
                    ...
                    switch (nodeCandidate.mapping) {
                        ...
                        case v3d.CubeReflectionMapping:
                        case v3d.CubeRefractionMapping:

                            return new CubeTextureNode(nodeCandidate);

                            break;

                        case v3d.CubeUVReflectionMapping:
                        case v3d.CubeUVRefractionMapping:
    ...
    getTextureEncodingFromMap: function(map, gammaOverrideLinear) {
        ...
        if (!map) {
            ...
            console.warn("v3d.WebGLPrograms.getTextureEncodingFromMap: don't use render targets as textures. Use their .texture property instead.");
            encoding = map.texture.encoding;

        }

        // add backwards compatibility for WebGLRenderer.gammaInput/gammaOutput parameter, should probably be removed at some point.
        if (encoding === v3d.LinearEncoding && gammaOverrideLinear) {

            encoding = v3d.GammaEncoding;
