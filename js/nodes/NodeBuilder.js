...
v3d.NodeBuilder = function(material) {
...
v3d.NodeBuilder.prototype = {

    constructor: v3d.NodeBuilder,
    ...
    getConstructorFromLength : function(len) {
        ...
        return v3d.NodeBuilder.constructors[len - 1];
    ...
    getTypeByFormat : function(format) {
        ...
        return v3d.NodeBuilder.type[format] || format;
    ...
    getElementByIndex : function(index) {
        ...
        return v3d.NodeBuilder.elements[index];

    },

    getIndexByElement : function(elm) {

        return v3d.NodeBuilder.elements.indexOf(elm);
