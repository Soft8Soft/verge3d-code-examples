...
v3d.NodeMaterial = function(vertex, fragment) {

    v3d.ShaderMaterial.call(this);

    this.vertex = vertex || new v3d.RawNode(new v3d.PositionNode(v3d.PositionNode.PROJECTION));
    this.fragment = fragment || new v3d.RawNode(new v3d.ColorNode(0xFF0000));

};

v3d.NodeMaterial.types = {
    t : 'sampler2D',
    tc : 'samplerCube',
    bv1 : 'bool',
    iv1 : 'int',
...
v3d.NodeMaterial.addShortcuts = function(proto, prop, list) {
...
v3d.NodeMaterial.prototype = Object.create(v3d.ShaderMaterial.prototype);
v3d.NodeMaterial.prototype.constructor = v3d.NodeMaterial;

v3d.NodeMaterial.prototype.updateFrame = function(delta) {
...
v3d.NodeMaterial.prototype.build = function() {
    ...
    var builder = new v3d.NodeBuilder(this);
    ...
    this.transparent = this.requestAttribs.transparent || this.blending > v3d.NormalBlending;
...
v3d.NodeMaterial.prototype.define = function(name, value) {

    this.defines[name] = value == undefined ? 1 : value;

};

v3d.NodeMaterial.prototype.isDefined = function(name) {

    return this.defines[name] != undefined;

};

v3d.NodeMaterial.prototype.mergeUniform = function(uniforms) {
...
v3d.NodeMaterial.prototype.createUniform = function(type, value, ns, needsUpdate) {
...
v3d.NodeMaterial.prototype.getVertexTemp = function(uuid, type, ns) {
...
v3d.NodeMaterial.prototype.getFragmentTemp = function(uuid, type, ns) {
...
v3d.NodeMaterial.prototype.getVar = function(uuid, type, ns) {
...
v3d.NodeMaterial.prototype.getAttribute = function(name, type) {
...
v3d.NodeMaterial.prototype.getIncludes = function() {
...
v3d.NodeMaterial.prototype.addVertexPars = function(code) {

    this.vertexPars += code + '\n';

};

v3d.NodeMaterial.prototype.addFragmentPars = function(code) {

    this.fragmentPars += code + '\n';

};

v3d.NodeMaterial.prototype.addVertexCode = function(code) {

    this.vertexCode += code + '\n';

};

v3d.NodeMaterial.prototype.addFragmentCode = function(code) {

    this.fragmentCode += code + '\n';

};

v3d.NodeMaterial.prototype.addVertexNode = function(code) {

    this.vertexNode += code + '\n';

};

v3d.NodeMaterial.prototype.clearVertexNode = function() {
...
v3d.NodeMaterial.prototype.addFragmentNode = function(code) {

    this.fragmentNode += code + '\n';

};

v3d.NodeMaterial.prototype.clearFragmentNode = function() {
...
v3d.NodeMaterial.prototype.getCodePars = function(pars, prefix) {
    ...
    for (var i = 0, l = pars.length; i < l; ++ i) {
        ...
        if (parsType == 't' && parsValue instanceof v3d.CubeTexture) parsType = 'tc';

        var type = v3d.NodeMaterial.types[parsType];
...
v3d.NodeMaterial.prototype.createVertexUniform = function(type, value, ns, needsUpdate) {
...
v3d.NodeMaterial.prototype.createFragmentUniform = function(type, value, ns, needsUpdate) {
...
v3d.NodeMaterial.prototype.getDataNode = function(uuid) {

    return this.nodeData[uuid] = this.nodeData[uuid] || {};

};

v3d.NodeMaterial.prototype.include = function(builder, node, parent, source) {

    var includes;

    node = typeof node === 'string' ? v3d.NodeLib.get(node) : node;

    if (node instanceof v3d.FunctionNode) {

        includes = this.functions[builder.shader] = this.functions[builder.shader] || [];

    } else if (node instanceof v3d.ConstNode) {
    ...
    if (node instanceof v3d.FunctionNode && parent && includes[parent.name] && includes[parent.name].deps.indexOf(node) == - 1) {
