...
function RTTNode(width, height, input, options) {
    ...
    this.renderTarget = new v3d.WebGLRenderTarget(width, height, options);
...
RTTNode.prototype.build = function(builder, output, uuid) {
    ...
    var rttBuilder = new v3d.NodeBuilder();
...
RTTNode.prototype.updateFramesaveTo = function(frame) {
    ...
    if (this.saveTo !== this.saveToCurrent) {
        ...
        var quad = new v3d.Mesh(new v3d.PlaneBufferGeometry(2, 2), material);
...
RTTNode.prototype.toJSON = function(meta) {
    ...
    if (!data) {
        ...
        data = v3d.TextureNode.prototype.toJSON.call(this, meta);
