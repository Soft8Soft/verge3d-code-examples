...
v3d.StandardNode = function() {

    v3d.GLNode.call(this);

    this.color = new v3d.ColorNode(0xEEEEEE);
    this.roughness = new v3d.FloatNode(0.5);
    this.metalness = new v3d.FloatNode(0.5);

};

v3d.StandardNode.prototype = Object.create(v3d.GLNode.prototype);
v3d.StandardNode.prototype.constructor = v3d.StandardNode;

v3d.StandardNode.prototype.build = function(builder) {
    ...
    if (builder.isShader('vertex')) {
        ...
        material.mergeUniform(v3d.UniformsUtils.merge([
        ...
        var requires = {
            bias: new v3d.RoughnessToBlinnExponentNode(),
            offsetU: 0,
            offsetV: 0
        };
        ...
        if (normal) {
            ...
            output.push(
                ...
                normal.result + ',' +
                new v3d.UVNode().build(builder, 'v2') + ',' +
