...
v3d.PhongNode = function() {

    v3d.GLNode.call(this);

    this.color = new v3d.ColorNode(0xEEEEEE);
    this.specular = new v3d.ColorNode(0x111111);
    this.shininess = new v3d.FloatNode(30);

};

v3d.PhongNode.prototype = Object.create(v3d.GLNode.prototype);
v3d.PhongNode.prototype.constructor = v3d.PhongNode;

v3d.PhongNode.prototype.build = function(builder) {
