...
NodeMaterial.prototype = Object.create(v3d.ShaderMaterial.prototype);
...
NodeMaterial.prototype.build = function(params) {
    ...
    this.transparent = builder.requires.transparent || this.blending > v3d.NormalBlending;
...
NodeMaterial.prototype.toJSON = function(meta) {
    ...
    if (!meta.materials[this.uuid]) {
        ...
        if (this.blending !== v3d.NormalBlending) data.blending = this.blending;
        if (this.flatShading === true) data.flatShading = this.flatShading;
        if (this.side !== v3d.FrontSide) data.side = this.side;
        if (this.vertexColors !== v3d.NoColors) data.vertexColors = this.vertexColors;

        if (this.depthFunc !== v3d.LessEqualDepth) data.depthFunc = this.depthFunc;
