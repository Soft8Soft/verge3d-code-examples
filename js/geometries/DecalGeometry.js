...
v3d.DecalGeometry = function(mesh, position, orientation, size) {
    ...
    var plane = new v3d.Vector3();

    // this matrix represents the transformation of the decal projector

    var projectorMatrix = new v3d.Matrix4();
    ...
    function pushDecalVertex(decalVertices, vertex, normal) {
        ...
        decalVertices.push(new v3d.DecalVertex(vertex.clone(), normal.clone()));
...
v3d.DecalGeometry.prototype = Object.create(v3d.BufferGeometry.prototype);
v3d.DecalGeometry.prototype.constructor = v3d.DecalGeometry;

// helper

v3d.DecalVertex = function(position, normal) {
...
v3d.DecalVertex.prototype.clone = function() {
