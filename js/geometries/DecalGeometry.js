 ...
 */
    ...
    class DecalGeometry extends v3d.BufferGeometry {
        ...
        constructor(mesh, position, orientation, size) {
            ...
            const plane = new v3d.Vector3(); // this matrix represents the transformation of the decal projector

            const projectorMatrix = new v3d.Matrix4();
            projectorMatrix.makeRotationFromEuler(orientation);
            projectorMatrix.setPosition(position);
            const projectorMatrixInverse = new v3d.Matrix4();
            ...
            function generate() {
                ...
                const normal = new v3d.Vector3(); // handle different geometry types

                if (mesh.geometry.isGeometry === true) {

                    console.error('v3d.DecalGeometry no longer supports v3d.Geometry. Use v3d.BufferGeometry instead.');
                    return;
                ...
                if (geometry.index !== null) {
                    ...
                    // non-indexed v3d.BufferGeometry
            ...
            function clip(v0, v1, p, s) {
                ...
                const s0 = d0 / (d0 - d1);
                const v = new DecalVertex(new v3d.Vector3(v0.position.x + s0 * (v1.position.x - v0.position.x), v0.position.y + s0 * (v1.position.y - v0.position.y), v0.position.z + s0 * (v1.position.z - v0.position.z)), new v3d.Vector3(v0.normal.x + s0 * (v1.normal.x - v0.normal.x), v0.normal.y + s0 * (v1.normal.y - v0.normal.y), v0.normal.z + s0 * (v1.normal.z - v0.normal.z))); // need to clip more values (texture coordinates)? do it this way:
    ...
    v3d.DecalGeometry = DecalGeometry;
    v3d.DecalVertex = DecalVertex;
