...
v3d.ParametricGeometries.TubeGeometry = function(path, segments, radius, segmentsRadius, closed, debug) {
    ...
    v3d.ParametricGeometry.call(this, ParametricTube, segments, segmentsRadius);

};

v3d.ParametricGeometries.TubeGeometry.prototype = Object.create(v3d.Geometry.prototype);
v3d.ParametricGeometries.TubeGeometry.prototype.constructor = v3d.ParametricGeometries.TubeGeometry;
...
/*********************************************
  ...
  *
  *********************************************/
v3d.ParametricGeometries.TorusKnotGeometry = function(radius, tube, segmentsT, segmentsR, p, q) {
    ...
    v3d.ParametricGeometries.TubeGeometry.call(this, extrudePath, segments, tube, radiusSegments, true, false);

};

v3d.ParametricGeometries.TorusKnotGeometry.prototype = Object.create(v3d.Geometry.prototype);
v3d.ParametricGeometries.TorusKnotGeometry.prototype.constructor = v3d.ParametricGeometries.TorusKnotGeometry;
...
v3d.ParametricGeometries.SphereGeometry.prototype = Object.create(v3d.Geometry.prototype);
v3d.ParametricGeometries.SphereGeometry.prototype.constructor = v3d.ParametricGeometries.SphereGeometry;
...
v3d.ParametricGeometries.PlaneGeometry = function(width, depth, segmentsWidth, segmentsDepth) {
    ...
    v3d.ParametricGeometry.call(this, plane, segmentsWidth, segmentsDepth);

};

v3d.ParametricGeometries.PlaneGeometry.prototype = Object.create(v3d.Geometry.prototype);
v3d.ParametricGeometries.PlaneGeometry.prototype.constructor = v3d.ParametricGeometries.PlaneGeometry;
