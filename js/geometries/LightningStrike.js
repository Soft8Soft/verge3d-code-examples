...
v3d.LightningStrike.prototype.fractalRay = function(time, segmentCallback) {
    ...
    for (var subrayIndex = 0; subrayIndex < this.numSubrays; subrayIndex++) {
        ...
        subray.endPropagationTime = v3d.Math.lerp(subray.birthTime, subray.deathTime, subray.propagationTimeFactor);
        subray.beginVanishingTime = v3d.Math.lerp(subray.deathTime, subray.birthTime, 1 - subray.vanishingTimeFactor);
...
v3d.LightningStrike.prototype.createDefaultSubrayCreationCallbacks = function() {
    ...
    this.onDecideSubrayCreation = function(segment, lightningStrike) {
        ...
        var phase0 = (lightningStrike.rayParameters.isEternal && subray.recursion == 0) ? - random1() * period : v3d.Math.lerp(subray.birthTime, subray.endPropagationTime, segment.fraction0) - random1() * period;
