 ...
 * Usage
 *
 * var myRay = new v3d.LightningStrike(paramsObject);
 * var myRayMesh = new v3d.Mesh(myRay, myMaterial);
 * scene.add(myRayMesh);
 * ...
...
v3d.LightningStrike = function(rayParameters) {
    ...
    this.init(v3d.LightningStrike.copyParameters(rayParameters, rayParameters));
...
v3d.LightningStrike.prototype = Object.create(v3d.BufferGeometry.prototype);

v3d.LightningStrike.prototype.constructor = v3d.LightningStrike;

v3d.LightningStrike.prototype.isLightningStrike = true;

// Ray states
v3d.LightningStrike.RAY_INITIALIZED = 0;
v3d.LightningStrike.RAY_UNBORN = 1;
v3d.LightningStrike.RAY_PROPAGATING = 2;
v3d.LightningStrike.RAY_STEADY = 3;
v3d.LightningStrike.RAY_VANISHING = 4;
v3d.LightningStrike.RAY_EXTINGUISHED = 5;

v3d.LightningStrike.COS30DEG = Math.cos(30 * Math.PI / 180);
v3d.LightningStrike.SIN30DEG = Math.sin(30 * Math.PI / 180);

v3d.LightningStrike.createRandomGenerator = function() {
...
v3d.LightningStrike.copyParameters = function(dest, source) {
    ...
    dest.sourceOffset = source.sourceOffset !== undefined ? vecCopy(source.sourceOffset) : new v3d.Vector3(0, 100, 0),
    dest.destOffset = source.destOffset !== undefined ? vecCopy(source.destOffset) : new v3d.Vector3(0, 0, 0),
    ...
    dest.up0 = source.up0 !== undefined ? vecCopy(source.up0) : new v3d.Vector3(0, 0, 1);
    dest.up1 = source.up1 !== undefined ? vecCopy(source.up1) : new v3d.Vector3(0, 0, 1),
...
v3d.LightningStrike.prototype.update = function(time) {
    ...
    if (this.rayParameters.isEternal || (this.rayParameters.birthTime <= time && time <= this.rayParameters.deathTime)) {
        ...
        if (time < this.subrays[0].endPropagationTime) {
            ...
            this.state = v3d.LightningStrike.RAY_PROPAGATING;

        } else if (time > this.subrays[0].beginVanishingTime) {

            this.state = v3d.LightningStrike.RAY_VANISHING;

        } else {

            this.state = v3d.LightningStrike.RAY_STEADY;
        ...
        if (time < this.rayParameters.birthTime) {
            ...
            this.state = v3d.LightningStrike.RAY_UNBORN;

        } else {

            this.state = v3d.LightningStrike.RAY_EXTINGUISHED;
...
v3d.LightningStrike.prototype.init = function(rayParameters) {
    ...
    if (rayParameters.randomGenerator !== undefined) {
        ...
        this.randomGenerator = v3d.LightningStrike.createRandomGenerator();
    ...
    this.state = v3d.LightningStrike.RAY_INITIALIZED;
    ...
    this.simplexX = new v3d.SimplexNoise(this.seedGenerator);
    this.simplexY = new v3d.SimplexNoise(this.seedGenerator);
    this.simplexZ = new v3d.SimplexNoise(this.seedGenerator);

    // Temp vectors
    this.forwards = new v3d.Vector3();
    this.forwardsFill = new v3d.Vector3();
    this.side = new v3d.Vector3();
    this.down = new v3d.Vector3();
    this.middlePos = new v3d.Vector3();
    this.middleLinPos = new v3d.Vector3();
    this.newPos = new v3d.Vector3();
    this.vPos = new v3d.Vector3();
    this.cross1 = new v3d.Vector3();

};

v3d.LightningStrike.prototype.createMesh = function() {
    ...
    this.setIndex(new v3d.Uint32BufferAttribute(this.indices, 1));

    this.positionAttribute = new v3d.Float32BufferAttribute(this.vertices, 3);
    this.setAttribute('position', this.positionAttribute);

    if (this.generateUVs) {

        this.uvsAttribute = new v3d.Float32BufferAttribute(new Float32Array(this.uvs), 2);
    ...
    if (!this.isStatic) {
        ...
        this.index.usage = v3d.DynamicDrawUsage;
        this.positionAttribute.usage = v3d.DynamicDrawUsage;
        if (this.generateUVs) {

            this.uvsAttribute.usage = v3d.DynamicDrawUsage;
...
v3d.LightningStrike.prototype.updateMesh = function(time) {
...
v3d.LightningStrike.prototype.fillMesh = function(time) {
...
v3d.LightningStrike.prototype.addNewSubray = function(/*rayParameters*/) {

    return this.subrays[this.numSubrays ++];

};

v3d.LightningStrike.prototype.initSubray = function(subray, rayParameters) {
...
v3d.LightningStrike.prototype.fractalRay = function(time, segmentCallback) {
    ...
    for (var subrayIndex = 0; subrayIndex < this.numSubrays; subrayIndex ++) {
        ...
        subray.endPropagationTime = v3d.MathUtils.lerp(subray.birthTime, subray.deathTime, subray.propagationTimeFactor);
        subray.beginVanishingTime = v3d.MathUtils.lerp(subray.deathTime, subray.birthTime, 1 - subray.vanishingTimeFactor);
...
v3d.LightningStrike.prototype.fractalRayRecursive = function(segment) {
...
v3d.LightningStrike.prototype.createPrism = function(segment) {
...
v3d.LightningStrike.prototype.createTriangleVerticesWithoutUVs = function(pos, up, forwards, radius) {

    // Create an equilateral triangle (only vertices)

    this.side.crossVectors(up, forwards).multiplyScalar(radius * v3d.LightningStrike.COS30DEG);
    this.down.copy(up).multiplyScalar(- radius * v3d.LightningStrike.SIN30DEG);
...
v3d.LightningStrike.prototype.createTriangleVerticesWithUVs = function(pos, up, forwards, radius, u) {
...
v3d.LightningStrike.prototype.createPrismFaces = function(vertex/*, index*/) {
...
v3d.LightningStrike.prototype.createDefaultSubrayCreationCallbacks = function() {
    ...
    this.onDecideSubrayCreation = function(segment, lightningStrike) {
        ...
        var phase0 = (lightningStrike.rayParameters.isEternal && subray.recursion == 0) ? - random1() * period : v3d.MathUtils.lerp(subray.birthTime, subray.endPropagationTime, segment.fraction0) - random1() * period;
    ...
    var vec1Pos = new v3d.Vector3();
    var vec2Forward = new v3d.Vector3();
    var vec3Side = new v3d.Vector3();
    var vec4Up = new v3d.Vector3();
...
v3d.LightningStrike.prototype.createSubray = function() {
    ...
    return {
        ...
        maxIterations: 0,
        recursion: 0,
        pos0: new v3d.Vector3(),
        pos1: new v3d.Vector3(),
        linPos0: new v3d.Vector3(),
        linPos1: new v3d.Vector3(),
        up0: new v3d.Vector3(),
        up1: new v3d.Vector3(),
        radius0: 0,
        radius1: 0,
...
v3d.LightningStrike.prototype.createSegment = function() {
...
v3d.LightningStrike.prototype.getNewSegment = function() {

    return this.raySegments[this.currentSegmentIndex ++];

};

v3d.LightningStrike.prototype.copy = function(source) {

    v3d.BufferGeometry.prototype.copy.call(this, source);

    this.init(v3d.LightningStrike.copyParameters({}, source.rayParameters));
...
v3d.LightningStrike.prototype.clone = function() {
    ...
    return new this.constructor(v3d.LightningStrike.copyParameters({}, this.rayParameters));
