 ...
 *
 * @param {Object} randomGenerator Set here your random number generator which will seed the v3d.SimplexNoise and other decisions during ray tree creation.
...
*/
    ...
    class LightningStrike extends v3d.BufferGeometry {
        ...
        init(rayParameters) {
            ...
            this.simplexZ = new v3d.SimplexNoise(this.seedGenerator); // Temp vectors
        ...
        createDefaultSubrayCreationCallbacks() {
            ...
            this.onDecideSubrayCreation = function(segment, lightningStrike) {
                ...
                const phase0 = lightningStrike.rayParameters.isEternal && subray.recursion == 0 ? - random1() * period : v3d.MathUtils.lerp(subray.birthTime, subray.endPropagationTime, segment.fraction0) - random1() * period;
            ...
            const vec1Pos = new v3d.Vector3();
            const vec2Forward = new v3d.Vector3();
            const vec3Side = new v3d.Vector3();
            const vec4Up = new v3d.Vector3();
    ...
    v3d.LightningStrike = LightningStrike;
