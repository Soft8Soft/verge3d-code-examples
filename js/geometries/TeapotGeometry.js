 ...
 */
    ...
    class TeapotGeometry extends v3d.BufferGeometry {
        ...
        constructor(size = 50, segments = 10, bottom = true, lid = true, body = true, fitLid = true, blinn = true) {
            ...
            let dsval = 0;
            let dtval = 0;
            const normOut = new v3d.Vector3();
            const gmx = new v3d.Matrix4();
            const tmtx = new v3d.Matrix4();
            const vsp = new v3d.Vector4();
            const vtp = new v3d.Vector4();
            const vdsp = new v3d.Vector4();
            const vdtp = new v3d.Vector4();
            const vsdir = new v3d.Vector3();
            const vtdir = new v3d.Vector3();
            const mst = ms.clone();
    ...
    v3d.TeapotGeometry = TeapotGeometry;
