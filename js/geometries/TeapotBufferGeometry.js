...
1.5,-0.84,0.075
    ...
    var normOut = new v3d.Vector3();
    var v1, v2, v3, v4;

    var gmx = new v3d.Matrix4();
    var tmtx = new v3d.Matrix4();

    var vsp = new v3d.Vector4();
    var vtp = new v3d.Vector4();
    var vdsp = new v3d.Vector4();
    var vdtp = new v3d.Vector4();

    var vsdir = new v3d.Vector3();
    var vtdir = new v3d.Vector3();
...
v3d.TeapotBufferGeometry.prototype = Object.create(v3d.BufferGeometry.prototype);
v3d.TeapotBufferGeometry.prototype.constructor = v3d.TeapotBufferGeometry;

v3d.TeapotBufferGeometry.prototype.clone = function() {

    var bufferGeometry = new v3d.TeapotBufferGeometry(
