v3d.Ocean = function(renderer, camera, scene, options) {
    ...
    var fullscreeenVertexShader = v3d.ShaderLib["ocean_sim_vertex"];

    // 1 - Horizontal wave vertices used for FFT
    var oceanHorizontalShader = v3d.ShaderLib["ocean_subtransform"];
    ...
    var oceanVerticalShader = v3d.ShaderLib["ocean_subtransform"];
    ...
    var initialSpectrumShader = v3d.ShaderLib["ocean_initial_spectrum"];
    ...
    var phaseShader = v3d.ShaderLib["ocean_phase"];
    ...
    var spectrumShader = v3d.ShaderLib["ocean_spectrum"];
    ...
    var normalShader = v3d.ShaderLib["ocean_normals"];
    ...
    var oceanShader = v3d.ShaderLib["ocean_main"];
