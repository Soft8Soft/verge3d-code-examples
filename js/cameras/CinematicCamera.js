...
v3d.CinematicCamera = function(fov, aspect, near, far) {
    ...
    this.material_depth = new v3d.MeshDepthMaterial();
...
v3d.CinematicCamera.prototype = Object.create(v3d.PerspectiveCamera.prototype);
v3d.CinematicCamera.prototype.constructor = v3d.CinematicCamera;


// providing fnumber and coc(Circle of Confusion) as extra arguments
v3d.CinematicCamera.prototype.setLens = function(focalLength, filmGauge, fNumber, coc) {
...
v3d.CinematicCamera.prototype.linearize = function(depth) {
...
v3d.CinematicCamera.prototype.smoothstep = function(near, far, depth) {
...
v3d.CinematicCamera.prototype.saturate = function(x) {
...
v3d.CinematicCamera.prototype.focusAt = function(focusDistance) {
...
v3d.CinematicCamera.prototype.initPostProcessing = function() {
    ...
    if (this.postprocessing.enabled) {
        ...
        this.postprocessing.quad = new v3d.Mesh(new v3d.PlaneBufferGeometry(window.innerWidth, window.innerHeight), this.postprocessing.materialBokeh);
...
v3d.CinematicCamera.prototype.renderCinematic = function(scene, renderer) {
