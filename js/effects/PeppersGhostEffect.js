 ...
 */
    ...
    class PeppersGhostEffect {
        ...
        constructor(renderer) {
            ...
            const _cameraF = new v3d.PerspectiveCamera(); //front


            const _cameraB = new v3d.PerspectiveCamera(); //back


            const _cameraL = new v3d.PerspectiveCamera(); //left


            const _cameraR = new v3d.PerspectiveCamera(); //right
            ...
            const _scale = new v3d.Vector3(); // Initialization
    ...
    v3d.PeppersGhostEffect = PeppersGhostEffect;
