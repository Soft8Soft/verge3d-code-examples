...
v3d.VREffect = function(renderer, onError) {

    var vrDisplay, vrDisplays;
    var eyeTranslationL = new v3d.Vector3();
    var eyeTranslationR = new v3d.Vector3();
    var renderRectL, renderRectR;
    var headMatrix = new v3d.Matrix4();
    var eyeMatrixL = new v3d.Matrix4();
    var eyeMatrixR = new v3d.Matrix4();
    ...
    if (navigator.getVRDisplays) {
        ...
        navigator.getVRDisplays().then(gotVRDisplays).catch(function() {
            ...
            console.warn('v3d.VREffect: Unable to get VR Displays');
    ...
    this.getVRDisplays = function() {
        ...
        console.warn('v3d.VREffect: getVRDisplays() is being deprecated.');
        return vrDisplays;
    ...
    var cameraL = new v3d.PerspectiveCamera();
    cameraL.layers.enable(1);

    var cameraR = new v3d.PerspectiveCamera();
    ...
    this.render = function(scene, camera, renderTarget, forceClear) {
        ...
        if (vrDisplay && scope.isPresenting) {
            ...
            if (Array.isArray(scene)) {
                ...
                console.warn('v3d.VREffect.render() no longer supports arrays. Use object.layers instead.');
                scene = scene[0];
    ...
    var poseOrientation = new v3d.Quaternion();
    var posePosition = new v3d.Vector3();
