...
v3d.AnaglyphEffect = function(renderer, width, height) {

    // Matrices generated with angler.js https://github.com/tschw/angler.js/
    // (in column-major element order, as accepted by WebGL)

    this.colorMatrixLeft = new v3d.Matrix3().fromArray([
    ...
    this.colorMatrixRight = new v3d.Matrix3().fromArray([
    ...
    var _renderTargetL = new v3d.WebGLRenderTarget(width, height, _params);
    var _renderTargetR = new v3d.WebGLRenderTarget(width, height, _params);
