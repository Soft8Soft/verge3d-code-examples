 ...
 * 1. Traditional
 *
 * var effect = new v3d.OutlineEffect(renderer);
 *
 * function render() {
 *
...
v3d.OutlineEffect = function(renderer, parameters) {
    ...
    var vertexShader = [
        ...
        "    vec3 outlineNormal = - objectNormal;", // the outline material is always rendered with v3d.BackSide
    ...
    function createMaterial() {
        ...
        return new v3d.ShaderMaterial({
            ...
            uniforms: v3d.UniformsUtils.merge([
                v3d.UniformsLib['fog'],
                v3d.UniformsLib['displacementmap'],
                uniformsOutline
            ]),
