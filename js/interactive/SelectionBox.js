...
SelectionBox.prototype.createFrustum = function(startPoint, endPoint) {
    ...
    var vecTopRight = new v3d.Vector3(endPoint.x, tmpPoint.y, 0);
    var vecDownRight = endPoint.clone();
    var vecDownLeft = new v3d.Vector3(tmpPoint.x, endPoint.y, 0);
