(function() {
    ...
    class HTMLMesh extends v3d.Mesh {

        constructor(dom) {

            const texture = new HTMLTexture(dom);
            const geometry = new v3d.PlaneGeometry(texture.image.width * 0.001, texture.image.height * 0.001);
    ...
    class HTMLTexture extends v3d.CanvasTexture {
        ...
        constructor(dom) {
            ...
            this.dom = dom;
            this.anisotropy = 16;
            this.encoding = v3d.sRGBEncoding;
            this.minFilter = v3d.LinearFilter;
