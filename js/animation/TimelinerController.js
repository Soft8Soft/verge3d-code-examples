...
v3d.TimelinerController = function TimelinerController(scene, trackInfo, onUpdate) {
    ...
    this._mixer = new v3d.AnimationMixer(scene);
    this._clip = null;
    this._action = null;
...
v3d.TimelinerController.prototype = {

    constructor: v3d.TimelinerController,
    ...
    init: function() {
        ...
        this._clip = new v3d.AnimationClip('editclip', 0, tracks);
    ...
    _sort: function(track) {
        ...
        var times = track.times, order = v3d.AnimationUtils.getKeyframeOrder(times);

        this._setArray(times, v3d.AnimationUtils.sortedArray(times, 1, order));

        var values = track.values,
            stride = track.getValueSize();

        this._setArray(values, v3d.AnimationUtils.sortedArray(values, stride, order));
    ...
    _addTrack: function(type, prop, initialValue, interpolation) {
        ...
        this._propRefs[prop] =
                new v3d.PropertyBinding(this._scene, prop);
