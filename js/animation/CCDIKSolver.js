(function() {
    ...
    const _targetPos = new v3d.Vector3();

    const _targetVec = new v3d.Vector3();

    const _effectorPos = new v3d.Vector3();

    const _effectorVec = new v3d.Vector3();

    const _linkPos = new v3d.Vector3();

    const _invLinkQ = new v3d.Quaternion();

    const _linkScale = new v3d.Vector3();

    const _axis = new v3d.Vector3();

    const _vector = new v3d.Vector3();
 ...
 */
    ...
    class CCDIKHelper extends v3d.Object3D {
        ...
        constructor(mesh, iks = []) {
            ...
            this.sphereGeometry = new v3d.SphereGeometry(0.25, 16, 8);
