 ...
 * for MMD model loaded by v3d.MMDLoader.
 *
 * TODO
 *  - Physics in Worker
 */
...
v3d.MMDPhysics = (function() {
     ...
     * @param {v3d.Vector3} params.gravity - Default is (0, - 9.8 * 10, 0)
     */
    ...
    MMDPhysicsHelper.prototype = Object.assign(Object.create(v3d.Object3D.prototype), {
        ...
        updateMatrixWorld: function() {
            ...
            var matrixWorldInv = new v3d.Matrix4();
            ...
            return function updateMatrixWorld(force) {
                ...
                v3d.Object3D.prototype.updateMatrixWorld.call(this, force);
