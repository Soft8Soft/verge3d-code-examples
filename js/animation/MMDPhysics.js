 ...
 *
 * See v3d.MMDLoader for the passed parameter list of RigidBody/Constraint.
 *
 * Requirement:
...
v3d.MMDPhysics = function(mesh, params) {

    if (params === undefined) params = {};

    this.mesh = mesh;
    this.helper = new v3d.MMDPhysics.ResourceHelper();
...
v3d.MMDPhysics.prototype = {

    constructor: v3d.MMDPhysics,
    ...
    initRigidBodies: function() {
        ...
        for (var i = 0; i < bodies.length; i++) {
            ...
            var b = new v3d.MMDPhysics.RigidBody(this.mesh, this.world, bodies[i], this.helper);
            this.bodies.push(b);
    ...
    initConstraints: function() {
        ...
        for (var i = 0; i < constraints.length; i++) {
            ...
            var c = new v3d.MMDPhysics.Constraint(this.mesh, this.world, bodyA, bodyB, params, this.helper);
 ...
 */
v3d.MMDPhysics.ResourceHelper = function() {
...
v3d.MMDPhysics.ResourceHelper.prototype = {

    allocThreeVector3: function() {

        return (this.threeVector3s.length > 0) ? this.threeVector3s.pop() : new v3d.Vector3();
    ...
    allocThreeMatrix4: function() {
        ...
        return (this.threeMatrix4s.length > 0) ? this.threeMatrix4s.pop() : new v3d.Matrix4();
    ...
    allocThreeQuaternion: function() {
        ...
        return (this.threeQuaternions.length > 0) ? this.threeQuaternions.pop() : new v3d.Quaternion();
    ...
    allocThreeEuler: function() {
        ...
        return (this.threeEulers.length > 0) ? this.threeEulers.pop() : new v3d.Euler();
...
v3d.MMDPhysics.RigidBody = function(mesh, world, params, helper) {
...
v3d.MMDPhysics.RigidBody.prototype = {

    constructor: v3d.MMDPhysics.RigidBody,
    ...
    init: function() {
        ...
        var bone = (params.boneIndex === -1) ? new v3d.Bone() : bones[params.boneIndex];
...
v3d.MMDPhysics.Constraint = function(mesh, world, bodyA, bodyB, params, helper) {
...
v3d.MMDPhysics.Constraint.prototype = {

    constructor: v3d.MMDPhysics.Constraint,
...
v3d.MMDPhysicsHelper = function(mesh) {

    if (mesh.physics === undefined || mesh.geometry.rigidBodies === undefined) {

        throw 'v3d.MMDPhysicsHelper requires physics in mesh and rigidBodies in mesh.geometry.';
...
v3d.MMDPhysicsHelper.prototype = Object.create(v3d.Object3D.prototype);
v3d.MMDPhysicsHelper.prototype.constructor = v3d.MMDPhysicsHelper;

v3d.MMDPhysicsHelper.prototype._init = function() {
    ...
    function createGeometry(param) {
        ...
        switch (param.shapeType) {
            ...
            case 0:
                return new v3d.SphereBufferGeometry(param.width, 16, 8);

            case 1:
                return new v3d.BoxBufferGeometry(param.width * 2, param.height * 2, param.depth * 2, 8, 8, 8);
    ...
    function createCapsuleGeometry(radius, cylinderHeight, segmentsRadius, segmentsHeight) {
        ...
        var geometry = new v3d.CylinderBufferGeometry(radius, radius, cylinderHeight, segmentsRadius, segmentsHeight, true);
        var upperSphere = new v3d.Mesh(new v3d.SphereBufferGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, 0, Math.PI / 2));
        var lowerSphere = new v3d.Mesh(new v3d.SphereBufferGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, Math.PI / 2, Math.PI / 2));
    ...
    for (var i = 0, il = rigidBodies.length; i < il; i++) {
        ...
        this.add(new v3d.Mesh(createGeometry(param), this.materials[param.type]));

    }

};

v3d.MMDPhysicsHelper.prototype.update = function() {
    ...
    var quaternion2 = new v3d.Quaternion();
