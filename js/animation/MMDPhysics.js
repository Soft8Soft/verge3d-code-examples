   ...
   */
        constructor(mesh, rigidBodyParams, constraintParams = [], params = {}) {
            ...
            if (typeof Ammo === 'undefined') {
                ...
                throw new Error('v3d.MMDPhysics: Import ammo.js https://github.com/kripken/ammo.js');
     ...
     */
            ...
            this.gravity = new v3d.Vector3(0, - 9.8 * 10, 0);
 ...
 */
   ...
   */
        ...
        _init() {
            ...
            const bone = params.boneIndex === - 1 ? new v3d.Bone() : bones[params.boneIndex];
   ...
   */
    ...
    const _scale = new v3d.Vector3();

    const _matrixWorldInv = new v3d.Matrix4();

    class MMDPhysicsHelper extends v3d.Object3D {
   ...
   */
        constructor(mesh, physics) {
            ...
            this.materials = [];
            this.materials.push(new v3d.MeshBasicMaterial({
        ...
        _init() {
            ...
            function createGeometry(param) {
                ...
                switch (param.shapeType) {
                    ...
                    case 0:
                        return new v3d.SphereGeometry(param.width, 16, 8);

                    case 1:
                        return new v3d.BoxGeometry(param.width * 2, param.height * 2, param.depth * 2, 8, 8, 8);
            ...
            function createCapsuleGeometry(radius, cylinderHeight, segmentsRadius, segmentsHeight) {
                ...
                var geometry = new v3d.CylinderGeometry(radius, radius, cylinderHeight, segmentsRadius, segmentsHeight, true);
                var upperSphere = new v3d.Mesh(new v3d.SphereGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, 0, Math.PI / 2));
                var lowerSphere = new v3d.Mesh(new v3d.SphereGeometry(radius, segmentsRadius, segmentsHeight, 0, Math.PI * 2, Math.PI / 2, Math.PI / 2));
