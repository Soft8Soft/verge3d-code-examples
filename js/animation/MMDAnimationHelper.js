...
v3d.MMDAnimationHelper = (function() {
    ...
    MMDAnimationHelper.prototype = {
         ...
         * @param {v3d.Vector3} params.gravity - Only for v3d.SkinnedMesh and physics is true. Default (0, - 9.8 * 10, 0).
         * @param {Number} params.delayTime - Only for v3d.Audio. Default is 0.0.
         * @return {v3d.MMDAnimationHelper}
         */
        add: function(object, params) {
            ...
            if (object.isSkinnedMesh) {
                ...
                throw new Error('v3d.MMDAnimationHelper.add: '
                    + 'accepts only '
                    + 'v3d.SkinnedMesh or '
                    + 'v3d.Camera or '
                    + 'v3d.Audio instance.');
        ...
        remove: function(object) {
            ...
            if (object.isSkinnedMesh) {
                ...
                throw new Error('v3d.MMDAnimationHelper.remove: '
                    + 'accepts only '
                    + 'v3d.SkinnedMesh or '
                    + 'v3d.Camera or '
                    + 'v3d.Audio instance.');
        ...
        enable: function(key, enabled) {
            ...
            if (this.enabled[key] === undefined) {
                ...
                throw new Error('v3d.MMDAnimationHelper.enable: '
                    + 'unknown key ' + key);
        ...
        _addMesh: function(mesh, params) {
            ...
            if (this.meshes.indexOf(mesh) >= 0) {
                ...
                throw new Error('v3d.MMDAnimationHelper._addMesh: '
        ...
        _setupCamera: function(camera, params) {
            ...
            if (this.camera === camera) {
                ...
                throw new Error('v3d.MMDAnimationHelper._setupCamera: '
        ...
        _setupAudio: function(audio, params) {
            ...
            if (this.audio === audio) {
                ...
                throw new Error('v3d.MMDAnimationHelper._setupAudio: '
        ...
        _removeMesh: function(mesh) {
            ...
            if (!found) {
                ...
                throw new Error('v3d.MMDAnimationHelper._removeMesh: '
        ...
        _clearCamera: function(camera) {
            ...
            if (camera !== this.camera) {
                ...
                throw new Error('v3d.MMDAnimationHelper._clearCamera: '
        ...
        _clearAudio: function(audio) {
            ...
            if (audio !== this.audio) {
                ...
                throw new Error('v3d.MMDAnimationHelper._clearAudio: '
