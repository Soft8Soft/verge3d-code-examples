 ...
 */
   ...
   */
        constructor(params = {}) {
            ...
            this.meshes = [];
            this.camera = null;
            this.cameraTarget = new v3d.Object3D();
   ...
   *
   * @param {v3d.SkinnedMesh|v3d.Camera|v3d.Audio} object
   * @param {Object} params - (optional)
   * @param {v3d.AnimationClip|Array<v3d.AnimationClip>} params.animation - Only for v3d.SkinnedMesh and v3d.Camera. Default is undefined.
   * @param {boolean} params.physics - Only for v3d.SkinnedMesh. Default is true.
   ...
   */
        ...
        add(object, params = {}) {
            ...
            if (object.isSkinnedMesh) {
                ...
                throw new Error('v3d.MMDAnimationHelper.add: ' + 'accepts only ' + 'v3d.SkinnedMesh or ' + 'v3d.Camera or ' + 'v3d.Audio instance.');
   ...
   */
        ...
        remove(object) {
            ...
            if (object.isSkinnedMesh) {
                ...
                throw new Error('v3d.MMDAnimationHelper.remove: ' + 'accepts only ' + 'v3d.SkinnedMesh or ' + 'v3d.Camera or ' + 'v3d.Audio instance.');
   ...
   */
        ...
        enable(key, enabled) {
            ...
            if (this.enabled[key] === undefined) {
                ...
                throw new Error('v3d.MMDAnimationHelper.enable: ' + 'unknown key ' + key);
   ...
   */
        ...
        _addMesh(mesh, params) {
            ...
            if (this.meshes.indexOf(mesh) >= 0) {
                ...
                throw new Error('v3d.MMDAnimationHelper._addMesh: ' + 'SkinnedMesh \'' + mesh.name + '\' has already been added.');
        ...
        _setupCamera(camera, params) {
            ...
            if (this.camera === camera) {
                ...
                throw new Error('v3d.MMDAnimationHelper._setupCamera: ' + 'Camera \'' + camera.name + '\' has already been set.');
        ...
        _setupAudio(audio, params) {
            ...
            if (this.audio === audio) {
                ...
                throw new Error('v3d.MMDAnimationHelper._setupAudio: ' + 'Audio \'' + audio.name + '\' has already been set.');
        ...
        _removeMesh(mesh) {
            ...
            if (!found) {
                ...
                throw new Error('v3d.MMDAnimationHelper._removeMesh: ' + 'SkinnedMesh \'' + mesh.name + '\' has not been added yet.');
        ...
        _clearCamera(camera) {
            ...
            if (camera !== this.camera) {
                ...
                throw new Error('v3d.MMDAnimationHelper._clearCamera: ' + 'Camera \'' + camera.name + '\' has not been set yet.');
        ...
        _clearAudio(audio) {
            ...
            if (audio !== this.audio) {
                ...
                throw new Error('v3d.MMDAnimationHelper._clearAudio: ' + 'Audio \'' + audio.name + '\' has not been set yet.');
        ...
        _setupMeshAnimation(mesh, animation) {
            ...
            if (animation !== undefined) {
                ...
                objects.mixer = new v3d.AnimationMixer(mesh);
        ...
        _setupCameraAnimation(camera, animation) {
            ...
            objects.mixer = new v3d.AnimationMixer(camera);
        ...
        _createCCDIKSolver(mesh) {
            ...
            if (v3d.CCDIKSolver === undefined) {

                throw new Error('v3d.MMDAnimationHelper: Import v3d.CCDIKSolver.');

            }

            return new v3d.CCDIKSolver(mesh, mesh.geometry.userData.MMD.iks);

        }

        _createMMDPhysics(mesh, params) {

            if (v3d.MMDPhysics === undefined) {

                throw new Error('v3d.MMDPhysics: Import v3d.MMDPhysics.');

            }

            return new v3d.MMDPhysics(mesh, mesh.geometry.userData.MMD.rigidBodies, mesh.geometry.userData.MMD.constraints, params);
   ...
   *
   * 1. PropertyMixer used by v3d.AnimationMixer holds cache value in .buffer.
   ...
   */
    ...
    function getQuaternion() {
        ...
        if (_quaternionIndex >= _quaternions.length) {
            ...
            _quaternions.push(new v3d.Quaternion());
 ...
 */
   ...
   */
    ...
    v3d.MMDAnimationHelper = MMDAnimationHelper;
