(function() {
    ...
    class LightProbeGenerator {
        ...
        static fromCubeTexture(cubeTexture) {
            ...
            let totalWeight = 0;
            const coord = new v3d.Vector3();
            const dir = new v3d.Vector3();
            const color = new v3d.Color();
            const shBasis = [0, 0, 0, 0, 0, 0, 0, 0, 0];
            const sh = new v3d.SphericalHarmonics3();
            ...
            for (let faceIndex = 0; faceIndex < 6; faceIndex ++) {
                ...
                for (let i = 0, il = data.length; i < il; i += 4) {
                    ...
                    v3d.SphericalHarmonics3.getBasisAt(dir, shBasis); // accummuulate
    ...
    function convertColorToLinear(color, encoding) {
        ...
        switch (encoding) {
            ...
            case v3d.sRGBEncoding:
                color.convertSRGBToLinear();
                break;

            case v3d.LinearEncoding:
                break;
    ...
    v3d.LightProbeGenerator = LightProbeGenerator;
