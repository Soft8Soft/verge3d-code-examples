...
v3d.LineSegments2.prototype = Object.assign(Object.create(v3d.Mesh.prototype), {
    ...
    raycast: (function() {
        ...
        var start = new v3d.Vector4();
        var end = new v3d.Vector4();

        var ssOrigin = new v3d.Vector4();
        var ssOrigin3 = new v3d.Vector3();
        var mvMatrix = new v3d.Matrix4();
        var line = new v3d.Line3();
        var closestPoint = new v3d.Vector3();
        ...
        return function raycast(raycaster, intersects) {
            ...
            for (var i = 0, l = instanceStart.count; i < l; i++) {
                ...
                var zPos = v3d.MathUtils.lerp(start.z, end.z, param);
                ...
                if (isInClipSpace && isInside) {
                    ...
                    var pointOnLine = new v3d.Vector3();
