(function() {
    ...
    const _start = new v3d.Vector3();

    const _end = new v3d.Vector3();

    const _start4 = new v3d.Vector4();

    const _end4 = new v3d.Vector4();

    const _ssOrigin = new v3d.Vector4();

    const _ssOrigin3 = new v3d.Vector3();

    const _mvMatrix = new v3d.Matrix4();

    const _line = new v3d.Line3();

    const _closestPoint = new v3d.Vector3();

    const _box = new v3d.Box3();

    const _sphere = new v3d.Sphere();

    const _clipToWorldVector = new v3d.Vector4(); // Returns the margin required to expand by in world space given the distance from the camera,
    ...
    class LineSegments2 extends v3d.Mesh {

        constructor(geometry = new v3d.LineSegmentsGeometry(), material = new v3d.LineMaterial({
        ...
        } // for backwards-compatability, but could be a method of v3d.LineSegmentsGeometry...
        ...
        computeLineDistances() {
            ...
            const instanceDistanceBuffer = new v3d.InstancedInterleavedBuffer(lineDistances, 2, 1); // d0, d1
        ...
        raycast(raycaster, intersects) {
            ...
            for (let i = 0, l = instanceStart.count; i < l; i++) {
                ...
                const zPos = v3d.MathUtils.lerp(_start4.z, _end4.z, param);
                ...
                if (isInClipSpace && isInside) {
                    ...
                    const pointOnLine = new v3d.Vector3();
    ...
    v3d.LineSegments2 = LineSegments2;
