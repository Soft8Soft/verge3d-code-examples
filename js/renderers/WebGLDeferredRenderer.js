...
v3d.WebGLDeferredRenderer = function(parameters) {
    ...
    var _tmpMaterial = new v3d.ShaderMaterial({ visible: false });
    var _tmpVector3 = new v3d.Vector3();
    ...
    function init(parameters) {
        ...
        _width = parameters.width !== undefined ? parameters.width : _this.renderer.getSize(new v3d.Vector2()).width;
        _height = parameters.height !== undefined ? parameters.height : _this.renderer.getSize(new v3d.Vector2()).height;
    ...
    function initDepthTexture() {
        ...
        _depthTexture = new v3d.DepthTexture(
            _width,
            _height,
    ...
    function initPassNormalDepth() {
        ...
        _passNormalDepth = new v3d.RenderPass();
        _passNormalDepth.clear = true;

        var rt = new v3d.WebGLRenderTarget(_width, _height, {
        ...
        _compNormalDepth = new v3d.EffectComposer(_this.renderer, rt);
    ...
    function initPassColor() {
        ...
        _compColor = new v3d.EffectComposer(_this.renderer, rt);
    ...
    function initPassLight() {
        ...
        _passLightFullscreen = new v3d.RenderPass();
        _passLightFullscreen.clear = true;
        _passLightFullscreen.camera = new v3d.OrthographicCamera(- 1, 1, 1, - 1, 0, 1);

        _passLight = new v3d.RenderPass();
        ...
        _compLight = new v3d.EffectComposer(_this.renderer, rt);
    ...
    function initPassReconstruction() {
        ...
        _passReconstruction = new v3d.RenderPass();
        ...
        _compReconstruction = new v3d.EffectComposer(_this.renderer, rt);
    ...
    function initPassFinal() {
        ...
        _passFinal = new v3d.ShaderPass(v3d.ShaderDeferred['final']);
        _passFinal.clear = true;
        _passFinal.uniforms.samplerResult.value = _compLight.renderTarget2.texture;
        _passFinal.material.blending = v3d.NoBlending;
        _passFinal.material.depthWrite = false;
        _passFinal.material.depthTest = false;

        _passForward = new v3d.RenderPass();
        _passForward.clear = false;

        _passCopy = new v3d.ShaderPass(v3d.CopyShader);

        _passFXAA = new v3d.ShaderPass(v3d.FXAAShader);
        ...
        _compFinal = new v3d.EffectComposer(_this.renderer, rt);
    ...
    function createDeferredNormalDepthMaterial(originalMaterial) {
        ...
        var shader = (_lightPrePass) ? v3d.ShaderDeferred['normalDepthShininess'] : v3d.ShaderDeferred['normalDepth'];
    ...
    function createDeferredColorMaterial(originalMaterial) {
        ...
        var shader = v3d.ShaderDeferred['color'];
    ...
    function createDeferredReconstructionMaterial(originalMaterial) {
        ...
        var shader = v3d.ShaderDeferred['reconstruction'];
    ...
    function createDeferredEmissiveLight() {
        ...
        var shader = v3d.ShaderDeferred['emissiveLight'];
    ...
    function createDeferredLightMesh(light, geometry) {
        ...
        var mesh = new v3d.Mesh(geometry, _tmpMaterial);
    ...
    function createDeferredPointLightMaterial() {
        ...
        var shader = (_lightPrePass) ? v3d.ShaderDeferred['pointLightPre'] : v3d.ShaderDeferred['pointLight'];

        var material = createDeferredLightShaderMaterial(shader);

        material.side = v3d.BackSide;
        material.depthFunc = v3d.GreaterEqualDepth;
    ...
    function createDeferredSpotLight(light) {
        ...
        var mesh = createDeferredLightMesh(light, new v3d.PlaneBufferGeometry(2, 2));
    ...
    function createDeferredSpotLightMaterial() {
        ...
        var shader = (_lightPrePass) ? v3d.ShaderDeferred['spotLightPre'] : v3d.ShaderDeferred['spotLight'];
    ...
    function createDeferredDirectionalLightMaterial() {
        ...
        var shader = (_lightPrePass) ? v3d.ShaderDeferred['directionalLightPre'] : v3d.ShaderDeferred['directionalLight'];
    ...
    function updateDeferredCommonUniforms(camera) {
        ...
        var uniforms = v3d.ShaderDeferredCommon['commonUniforms'];
...
v3d.ShaderDeferredCommon = {

    commonUniforms: {

        matProjInverse: new v3d.Uniform(new v3d.Matrix4()),

        viewWidth: new v3d.Uniform(800),
        viewHeight: new v3d.Uniform(600)
...
v3d.ShaderDeferred = {
    ...
    normalDepth: {
        ...
        fragmentShader: [
            ...
            v3d.DeferredShaderChunk["packNormalDepth"],
    ...
    color: {
        ...
        uniforms: {
            ...
            map: new v3d.Uniform(null),
            offsetRepeat: new v3d.Uniform(new v3d.Vector4(0, 0, 1, 1)),

            diffuse: new v3d.Uniform(new v3d.Color(0x000000)),
            emissive: new v3d.Uniform(new v3d.Color(0x000000)),
            specular: new v3d.Uniform(new v3d.Color(0x000000)),
            shininess: new v3d.Uniform(30.0)
        ...
        fragmentShader: [
            ...
            v3d.DeferredShaderChunk["packVector3"],
            ...
            v3d.DeferredShaderChunk["packColor"],
    ...
    emissiveLight: {
        ...
        uniforms: Object.assign(

            {
                ...
                samplerColor: new v3d.Uniform(null)

            },

            v3d.ShaderDeferredCommon['commonUniforms']
        ...
        fragmentShader: [
            ...
            v3d.DeferredShaderChunk["unpackFloat"],

            "void main() {",

            v3d.DeferredShaderChunk["computeTextureCoord"],
            v3d.DeferredShaderChunk["unpackColor"],
    ...
    pointLight: {
        ...
        uniforms: Object.assign(

            {
                ...
                samplerNormalDepth: new v3d.Uniform(null),
                samplerColor: new v3d.Uniform(null),

                lightColor: new v3d.Uniform(new v3d.Color(0x000000)),
                lightPositionVS: new v3d.Uniform(new v3d.Vector3(0, 1, 0)),
                lightIntensity: new v3d.Uniform(1.0),
                lightRadius: new v3d.Uniform(1.0)
        ...
        fragmentShader: [
            ...
            v3d.DeferredShaderChunk["computeTextureCoord"],
            v3d.DeferredShaderChunk["unpackNormalDepth"],
            v3d.DeferredShaderChunk["computeVertexPositionVS"],
            ...
            v3d.DeferredShaderChunk["unpackColor"],
            v3d.DeferredShaderChunk["computeSpecular"],
            ...
            v3d.DeferredShaderChunk["combine"],
    ...
    spotLight: {
        ...
        uniforms: Object.assign(

            {
                ...
                lightColor: new v3d.Uniform(new v3d.Color(0x000000)),
                lightDirectionVS: new v3d.Uniform(new v3d.Vector3(0, 1, 0)),
                lightPositionVS: new v3d.Uniform(new v3d.Vector3(0, 1, 0)),
                lightAngle: new v3d.Uniform(1.0),
                lightIntensity: new v3d.Uniform(1.0)
    ...
    normalDepthShininess: {
        ...
        fragmentShader: [
            ...
            v3d.DeferredShaderChunk["packNormal"],
            ...
            v3d.DeferredShaderChunk["packNormalDepthShininess"],
    ...
    pointLightPre: {
        ...
        uniforms: Object.assign(

            {
                ...
                samplerNormalDepthShininess: new v3d.Uniform(null),
        ...
        fragmentShader: [
            ...
            v3d.DeferredShaderChunk["unpackFloat"],
            v3d.DeferredShaderChunk["unpackVector2"],

            "void main() {",

            v3d.DeferredShaderChunk["computeTextureCoord"],
            v3d.DeferredShaderChunk["unpackNormalDepthShininess"],
            v3d.DeferredShaderChunk["computeVertexPositionVS"],
            ...
            v3d.DeferredShaderChunk["packLight"],
    ...
    reconstruction: {
        ...
        uniforms: Object.assign(

            {
                ...
                samplerLight: new v3d.Uniform(null),
    ...
    final: {
        ...
        uniforms: {
            ...
            samplerResult: new v3d.Uniform(null)
