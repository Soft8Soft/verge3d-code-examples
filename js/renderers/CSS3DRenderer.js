...
v3d.CSS3DSprite = function(element) {
    ...
    v3d.CSS3DObject.call(this, element);

};

v3d.CSS3DSprite.prototype = Object.create(v3d.CSS3DObject.prototype);
v3d.CSS3DSprite.prototype.constructor = v3d.CSS3DSprite;

//

v3d.CSS3DRenderer = function() {

    console.log('v3d.CSS3DRenderer', v3d.REVISION);
    ...
    function renderObject(object, camera, cameraCSSMatrix) {
        ...
        if (object instanceof v3d.CSS3DObject) {
    ...
    function filterAndFlatten(scene) {
        ...
        scene.traverse(function(object) {
            ...
            if (object instanceof v3d.CSS3DObject) result.push(object);
