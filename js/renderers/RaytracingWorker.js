...
v3d.RaytracingRendererWorker = function() {
    ...
    var raycaster = new v3d.Raycaster(origin, direction);
    var ray = raycaster.ray;

    var raycasterLight = new v3d.Raycaster();
    var rayLight = raycasterLight.ray;

    var perspective;
    var cameraNormalMatrix = new v3d.Matrix3();
    ...
    var spawnRay = (function() {
        ...
        var lightColor = new v3d.Color();
        var schlick = new v3d.Color();

        var lightContribution = new v3d.Color();

        var eyeVector = new v3d.Vector3();
        var lightVector = new v3d.Vector3();
        var normalVector = new v3d.Vector3();
        var halfVector = new v3d.Vector3();

        var localPoint = new v3d.Vector3();
        var reflectionVector = new v3d.Vector3();

        var tmpVec = new v3d.Vector3();

        var tmpColor = [];

        for (var i = 0; i < maxRecursionDepth; i++) {

            tmpColor[i] = new v3d.Color();
    ...
    this.render = function(scene, camera) {
        ...
        perspective = 0.5 / Math.tan(v3d.Math.degToRad(camera.fov * 0.5)) * canvasHeight;
        ...
        scene.traverse(function(object) {
            ...
            if (cache[object.id] === undefined) {
                ...
                cache[object.id] = {
                    normalMatrix: new v3d.Matrix3(),
                    inverseMatrix: new v3d.Matrix4()
                };
...
Object.assign(v3d.RaytracingRendererWorker.prototype, v3d.EventDispatcher.prototype);
