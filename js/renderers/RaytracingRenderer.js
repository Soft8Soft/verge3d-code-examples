...
v3d.RaytracingRenderer = function(parameters) {

    console.log('v3d.RaytracingRenderer', v3d.REVISION);
    ...
    this.setWorkers = function(w) {
        ...
        while (pool.length < workers) {
            ...
            worker.color = new v3d.Color().setHSL(Math.random(), 0.8, 0.8).getHexString();
            pool.push(worker);
...
Object.assign(v3d.RaytracingRenderer.prototype, v3d.EventDispatcher.prototype);
