...
v3d.SoftwareRenderer = function(parameters) {

    console.log('v3d.SoftwareRenderer', v3d.REVISION);
    ...
    var lineMode = false;
    var lookVector = new v3d.Vector3(0, 0, 1);
    var crossVector = new v3d.Vector3();
    ...
    var projector = new v3d.Projector();

    var spriteV1 = new v3d.Vector4();
    var spriteV2 = new v3d.Vector4();
    var spriteV3 = new v3d.Vector4();

    var spriteUV1 = new v3d.Vector2();
    var spriteUV2 = new v3d.Vector2();
    var spriteUV3 = new v3d.Vector2();
    ...
    this.render = function(scene, camera) {
        ...
        for (var e = 0, el = elements.length; e < el; e ++) {
            ...
            } else if (element instanceof v3d.RenderableSprite) {
    ...
    function getMaterialShader(material) {
        ...
        if (shaders[id] === undefined || material.needsUpdate === true) {
            ...
            if (material instanceof v3d.MeshBasicMaterial ||
                material instanceof v3d.MeshLambertMaterial ||
                material instanceof v3d.MeshPhongMaterial ||
                material instanceof v3d.SpriteMaterial) {
            ...
            } else if (material instanceof v3d.LineBasicMaterial) {
...
v3d.SoftwareRenderer.Texture = function() {
