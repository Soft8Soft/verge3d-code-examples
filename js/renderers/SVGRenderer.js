...
v3d.SVGObject.prototype = Object.create(v3d.Object3D.prototype);
v3d.SVGObject.prototype.constructor = v3d.SVGObject;

v3d.SVGRenderer = function() {
    ...
    this.render = function(scene, camera) {
        ...
        if (camera instanceof v3d.Camera === false) {

            console.error('v3d.SVGRenderer.render: camera is not an instance of v3d.Camera.');
            return;
        ...
        scene.traverseVisible(function(object) {
             ...
             if (object instanceof v3d.SVGObject) {
