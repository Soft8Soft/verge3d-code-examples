(function() {
    ...
    class Rhino3dmLoader extends v3d.Loader {
        ...
        _createMaterial(material) {
            ...
            const diffusecolor = new v3d.Color(_diffuseColor.r / 255.0, _diffuseColor.g / 255.0, _diffuseColor.b / 255.0);
            ...
            const mat = new v3d.MeshStandardMaterial({
                color: diffusecolor,
                name: material.name,
                side: 2,
            ...
            for (let i = 0; i < instanceDefinitions.length; i++) {
                ...
                for (let j = 0; j < instanceReferences.length; j ++) {
                    ...
                    if (iRef.geometry.parentIdefId === iDef.attributes.id) {
                        ...
                        const iRefObject = new v3d.Object3D();
            ...
            switch (obj.objectType) {
                ...
                case 'PointSet':
                    ...
                    if (geometry.attributes.hasOwnProperty('color')) {
                        ...
                        material = new v3d.PointsMaterial({
                            vertexColors: true,
                        ...
                        color = new v3d.Color(_color.r / 255.0, _color.g / 255.0, _color.b / 255.0);
                        material = new v3d.PointsMaterial({
                            color: color,
                            sizeAttenuation: false,
                            size: 2
                ...
                case 'Brep':
                    ...
                    const mesh = new v3d.Mesh(geometry, mat);
                ...
                case 'Curve':
                    ...
                    _color = attributes.drawColor;
                    color = new v3d.Color(_color.r / 255.0, _color.g / 255.0, _color.b / 255.0);
                    material = new v3d.LineBasicMaterial({
                        color: color
                    });
                    material = this._compareMaterials(material);
                    const lines = new v3d.Line(geometry, material);
                ...
                case 'Light':
                    ...
                    switch (geometry.lightStyle.name) {
                        ...
                        case 'LightStyle_WorldRectangular':
                            light = new v3d.RectAreaLight();
                            const width = Math.abs(geometry.width[2]);
                            const height = Math.abs(geometry.length[0]);
                            light.position.set(geometry.location[0] - height / 2, geometry.location[1], geometry.location[2] - width / 2);
                            light.height = height;
                            light.width = width;
                            light.lookAt(new v3d.Vector3(geometry.direction[0], geometry.direction[1], geometry.direction[2]));
                            break;
                ...
                if (this.workerPool.length < this.workerLimit) {
                    ...
                    worker.onmessage = e => {
                        ...
                        switch (message.type) {
                            ...
                            default:
                                console.error('v3d.Rhino3dmLoader: Unexpected message, "' + message.type + '"');
                    ...
                    if (_texture) {
                        ...
                        if (image) {
                            ...
                            self.postMessage({
                                ...
                                id: taskID,
                                data: {
                                    message: `v3d.3DMLoader: Image for ${textureType} texture not embedded in file.`,
                ...
                case rhino.ObjectType.Light:
                    ...
                    if (geometry.lightStyle.name === 'LightStyle_WorldLinear') {
                        ...
                        self.postMessage({
                            ...
                            id: taskID,
                            data: {
                                message: `v3d.3DMLoader: No conversion exists for ${objectType.constructor.name} ${geometry.lightStyle.name}`,
                                type: 'no conversion',
                                guid: _attributes.id
                            }
                        });
      ...
      */
                ...
                default:
                    self.postMessage({
                        ...
                        id: taskID,
                        data: {
                            message: `v3d.3DMLoader: Conversion not implemented for ${objectType.constructor.name}`,
            ...
            if (geometry) {
                ...
                self.postMessage({
                    ...
                    id: taskID,
                    data: {
                        message: `v3d.3DMLoader: ${objectType.constructor.name} has no associated mesh geometry.`,
                        type: 'missing mesh',
                        guid: _attributes.id
                    }
                });
        ...
        function curveToPoints(curve, pointLimit) {
            ...
            for (let j = 0; j < pointCount; j ++) {
                ...
                const prevTan = curve.tangentAt(ts.slice(- 1)[0]); // Duplicated from v3d.Vector3
    ...
    v3d.Rhino3dmLoader = Rhino3dmLoader;
