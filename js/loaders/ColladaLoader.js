(function() {
    ...
    class ColladaLoader extends v3d.Loader {
        ...
        parse(text, path) {
            ...
            function buildAnimationChannel(channel, inputSource, outputSource) {
                ...
                switch (transform) {
                    ...
                    case 'translate':
                        console.warn('v3d.ColladaLoader: Animation transform type "%s" not yet implemented.', transform);
                        break;
            ...
            function createKeyframeTracks(animation, tracks) {
                ...
                if (positionData.length > 0) tracks.push(new v3d.VectorKeyframeTrack(name + '.position', times, positionData));
                if (quaternionData.length > 0) tracks.push(new v3d.QuaternionKeyframeTrack(name + '.quaternion', times, quaternionData));
                if (scaleData.length > 0) tracks.push(new v3d.VectorKeyframeTrack(name + '.scale', times, scaleData));
                return tracks;
            ...
            function buildAnimationClip(data) {
                ...
                return new v3d.AnimationClip(name, duration, tracks);
            ...
            function parseController(xml) {
                ...
                for (let i = 0, l = xml.childNodes.length; i < l; i++) {
                    ...
                    switch (child.nodeName) {
                        ...
                        case 'morph':
                            data.id = parseId(child.getAttribute('source'));
                            console.warn('v3d.ColladaLoader: Morph target animation not supported yet.');
                            break;
            ...
            function buildSkin(data) {
                ...
                if (data.bindShapeMatrix) {
                    ...
                    build.bindMatrix = new v3d.Matrix4().fromArray(data.bindShapeMatrix).transpose();

                } else {

                    build.bindMatrix = new v3d.Matrix4().identity();
                ...
                for (i = 0, l = jointSource.array.length; i < l; i++) {
                    ...
                    const boneInverse = new v3d.Matrix4().fromArray(inverseSource.array, i * inverseSource.stride).transpose();
                    build.joints.push({
                        name: name,
            ...
            function getImage(id) {
                ...
                console.warn('v3d.ColladaLoader: Couldn\'t find image with ID:', id);
                return null;
            ...
            function buildMaterial(data) {
                ...
                function getTexture(textureObject) {
                    ...
                    if (sampler !== undefined) {
                        ...
                        console.warn('v3d.ColladaLoader: Undefined sampler. Access image directly (see #12530).');
                    ...
                    if (image !== null) {
                        ...
                        if (loader !== undefined) {
                            ...
                            if (extra !== undefined && extra.technique !== undefined && isEmpty(extra.technique) === false) {
                                ...
                                texture.wrapS = technique.wrapU ? v3d.RepeatWrapping : v3d.ClampToEdgeWrapping;
                                texture.wrapT = technique.wrapV ? v3d.RepeatWrapping : v3d.ClampToEdgeWrapping;
                            ...
                            console.warn('v3d.ColladaLoader: v3d.Loader for texture %s not found.', image);
                            return null;
                        ...
                        console.warn('v3d.ColladaLoader: Couldn\'t create texture with ID:', textureObject.id);
                        return null;
                ...
                if (transparent && transparency) {
                    ...
                    if (transparent.data.texture) {
                        ...
                        switch (transparent.opaque) {
                            ...
                            default:
                                console.warn('v3d.ColladaLoader: Invalid opaque type "%s" of transparent tag.', transparent.opaque);
                ...
                if (technique.extra !== undefined && technique.extra.technique !== undefined) {
                    ...
                    for (const k in techniques) {
                        ...
                        switch (k) {
                            ...
                            case 'double_sided':
                                material.side = v === 1 ? v3d.DoubleSide : v3d.FrontSide;
                                break;

                            case 'bump':
                                material.normalMap = getTexture(v.texture);
                                material.normalScale = new v3d.Vector2(1, 1);
                                break;
            ...
            function buildCamera(data) {
                ...
                switch (data.optics.technique) {
                    ...
                    case 'perspective':
                        camera = new v3d.PerspectiveCamera(data.optics.parameters.yfov, data.optics.parameters.aspect_ratio, data.optics.parameters.znear, data.optics.parameters.zfar);
                        break;
                    ...
                    case 'orthographic':
                        ...
                        xmag *= 0.5;
                        ymag *= 0.5;
                        camera = new v3d.OrthographicCamera(- xmag, xmag, ymag, - ymag, // left, right, top, bottom
            ...
            function getCamera(id) {
                ...
                console.warn('v3d.ColladaLoader: Couldn\'t find camera with ID:', id);
                return null;
                ...
                for (let i = 0, l = xml.childNodes.length; i < l; i++) {
                    ...
                    switch (child.nodeName) {
                        ...
                        case 'color':
                            ...
                            data.color = new v3d.Color().fromArray(array);
                            break;
            ...
            function getLight(id) {
                ...
                console.warn('v3d.ColladaLoader: Couldn\'t find light with ID:', id);
                return null;
            ...
            function parseGeometry(xml) {
                ...
                for (let i = 0; i < mesh.childNodes.length; i++) {
                    ...
                    switch (child.nodeName) {
                        ...
                        case 'polygons':
                            console.warn('v3d.ColladaLoader: Unsupported primitive type: ', child.nodeName);
                            break;
            ...
            function buildGeometryType(primitives, sources, vertices) {
                ...
                for (let p = 0; p < primitives.length; p ++) {
                    ...
                    switch (primitive.type) {
                        ...
                        default:
                            console.warn('v3d.ColladaLoader: Unknow primitive type:', primitive.type);
                            ...
                            case 'VERTEX':
                                for (const key in vertices) {
                                    ...
                                    switch (key) {
                                        ...
                                        default:
                                            console.warn('v3d.ColladaLoader: Semantic "%s" not handled in geometry build process.', key);
                ...
                kinematics = {
                    ...
                    getJointValue: function(jointIndex) {
                        ...
                        if (jointData) {
                            ...
                            console.warn('v3d.ColladaLoader: Joint ' + jointIndex + ' doesn\'t exist.');
                    ...
                    setJointValue: function(jointIndex, value) {
                        ...
                        if (jointData) {
                            ...
                            if (value > joint.limits.max || value < joint.limits.min) {
                                ...
                                console.warn('v3d.ColladaLoader: Joint ' + jointIndex + ' value ' + value + ' outside of limits (min: ' + joint.limits.min + ', max: ' + joint.limits.max + ').');

                            } else if (joint.static) {

                                console.warn('v3d.ColladaLoader: Joint ' + jointIndex + ' is static.');
                                ...
                                for (let i = 0; i < transforms.length; i++) {
                                    ...
                                    if (transform.sid && transform.sid.indexOf(jointIndex) !== - 1) {
                                        ...
                                        switch (joint.type) {
                                            ...
                                            default:
                                                console.warn('v3d.ColladaLoader: Unknown joint type: ' + joint.type);
                                                break;
                            ...
                            console.log('v3d.ColladaLoader: ' + jointIndex + ' does not exist.');
                ...
                for (let i = 0; i < xml.childNodes.length; i++) {
                    ...
                    switch (child.nodeName) {
                        ...
                        case 'matrix':
                            ...
                            const matrix = new v3d.Matrix4().fromArray(array).transpose();
                            transforms.push({
                        ...
                        case 'scale':
                            array = parseFloats(child.textContent);
                            vector = new v3d.Vector3().fromArray(array);
                            transforms.push({
                                sid: child.getAttribute('sid'),
                                type: child.nodeName,
                                obj: vector
                        ...
                        case 'rotate':
                            array = parseFloats(child.textContent);
                            vector = new v3d.Vector3().fromArray(array);
                            const angle = v3d.MathUtils.degToRad(array[3]);
                            transforms.push({
                                sid: child.getAttribute('sid'),
                                type: child.nodeName,
                                obj: vector,
            ...
            function parseNode(xml) {
                ...
                if (hasNode(data.id)) {
                    ...
                    console.warn('v3d.ColladaLoader: There is already a node with ID %s. Exclude current node from further processing.', data.id);
            ...
            function buildSkeleton(skeletons, joints) {
                ...
                for (i = 0; i < skeletons.length; i++) {
                    ...
                    if (hasNode(skeleton)) {
                        ...
                        console.error('v3d.ColladaLoader: Unable to find root bone of skeleton with ID:', skeleton);
                ...
                return new v3d.Skeleton(bones, boneInverses);
            ...
            function buildNode(data) {
                ...
                if (nodes.length === 0 && objects.length === 1) {
                    ...
                    object = type === 'JOINT' ? new v3d.Bone() : new v3d.Group();
            ...
            const fallbackMaterial = new v3d.MeshBasicMaterial({
                color: 0xff00ff
            });
            ...
            function resolveMaterialBinding(keys, instanceMaterials) {
                ...
                for (let i = 0, l = keys.length; i < l; i++) {
                    ...
                    if (id === undefined) {
                        ...
                        console.warn('v3d.ColladaLoader: Material with key %s not found. Apply fallback material.', keys[i]);
                ...
                for (const type in geometries) {
                    ...
                    if (materials.length === 0) {
                        ...
                        if (type === 'lines' || type === 'linestrips') {
                            ...
                            materials.push(new v3d.LineBasicMaterial());

                        } else {

                            materials.push(new v3d.MeshPhongMaterial());
                    ...
                    switch (type) {
                        ...
                        case 'lines':
                            object = new v3d.LineSegments(geometry.data, material);
                            break;

                        case 'linestrips':
                            object = new v3d.Line(geometry.data, material);
                            break;
                        ...
                        case 'polylist':
                            if (skinning) {
                                ...
                                object = new v3d.SkinnedMesh(geometry.data, material);
            ...
            function setupAnimations() {
                ...
                if (isEmpty(clips) === true) {
                    ...
                    if (isEmpty(library.animations) === false) {
                        ...
                        animations.push(new v3d.AnimationClip('default', - 1, tracks));
            ...
            if (v3d.TGALoader) {
                ...
                tgaLoader = new v3d.TGALoader(this.manager);
            ...
            if (asset.upAxis === 'Z_UP') {
                ...
                scene.quaternion.setFromEuler(new v3d.Euler(- Math.PI / 2, 0, 0));
    ...
    v3d.ColladaLoader = ColladaLoader;
