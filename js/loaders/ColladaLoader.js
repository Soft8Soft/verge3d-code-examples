    ...
    parse: function(text, path) {
        ...
        function buildMaterial(data) {
            ...
            function getTexture(textureObject) {
                ...
                console.error('v3d.ColladaLoader: Undefined sampler', textureObject.id);
        ...
        function buildGeometryData(primitive, source, offset, array) {
            ...
            if (primitive.vcount !== undefined) {
                ...
                if (maxcount > 0) {
                    ...
                    console.log('v3d.ColladaLoader: Geometry has faces with more than 4 vertices.');
        ...
        console.time('v3d.ColladaLoader');
        ...
        console.time('v3d.ColladaLoader: DOMParser');

        var xml = new DOMParser().parseFromString(text, 'application/xml');

        console.timeEnd('v3d.ColladaLoader: DOMParser');
        ...
        console.time('v3d.ColladaLoader: Parse');
        ...
        console.timeEnd('v3d.ColladaLoader: Parse');

        console.time('v3d.ColladaLoader: Build');
        ...
        console.timeEnd('v3d.ColladaLoader: Build');
        ...
        console.timeEnd('v3d.ColladaLoader');
