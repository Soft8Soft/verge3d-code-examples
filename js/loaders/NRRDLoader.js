...
v3d.NRRDLoader.prototype = Object.assign(Object.create(v3d.Loader.prototype), {

    constructor: v3d.NRRDLoader,
    ...
    parse: function(data) {
        ...
        function parseHeader(header) {
            ...
            for (_i = 0, _len = lines.length; _i < _len; _i++) {
                ...
                if (l.match(/NRRD\d+/)) {
                    ...
                    field = m[1].trim();
                    data = m[2].trim();
                    fn = v3d.NRRDLoader.prototype.fieldFunctions[field];
                    if (fn) {
        ...
        // spacing
        var spacingX = (new v3d.Vector3(headerObject.vectors[0][0], headerObject.vectors[0][1],
            headerObject.vectors[0][2])).length();
        var spacingY = (new v3d.Vector3(headerObject.vectors[1][0], headerObject.vectors[1][1],
            headerObject.vectors[1][2])).length();
        var spacingZ = (new v3d.Vector3(headerObject.vectors[2][0], headerObject.vectors[2][1],
