 ...
 */
    ...
    class MDDLoader extends v3d.Loader {
        ...
        parse(data) {
            ...
            const track = new v3d.NumberKeyframeTrack('.morphTargetInfluences', times, values);
            const clip = new v3d.AnimationClip('default', times[times.length - 1], [track]); // morph targets
            ...
            for (let i = 0; i < totalFrames; i++) {
                ...
                const attribute = new v3d.BufferAttribute(morphTarget, 3);
