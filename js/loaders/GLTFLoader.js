...
v3d.GLTFLoader = (function() {
    ...
    GLTFLoader.prototype = {
        ...
        load: function(url, onLoad, onProgress, onError) {
            ...
            var path = this.path && (typeof this.path === 'string') ? this.path : v3d.Loader.prototype.extractUrlBase(url);
            ...
            loader.load(url, function(data) {
                ...
                try {
                    ...
                    if (onError !== undefined) {
                        ...
                        onError(e.constructor === Error ? e : new Error('v3d.GLTFLoader: Unable to parse model.'));
        ...
        parse: function(data, path, onLoad, onError) {
            ...
            if (json.asset === undefined || json.asset.version[0] < 2) {
                ...
                onError(new Error('v3d.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.'));
                return;
    ...
    function GLTFLightsExtension(json) {
        ...
        for (var lightId in lights) {
            ...
            var color = new v3d.Color().fromArray(light.color);
            ...
            if (lightNode) {
                ...
                if (light.fallOffExponent !== undefined) {
                    ...
                    console.warn('v3d.GLTFLoader:: light.fallOffExponent not currently supported.');
    ...
    GLTFMaterialsCommonExtension.prototype.getMaterialType = function(material) {
        ...
        switch (khrMaterial.type) {
            ...
            case 'commonBlinn' :
            case 'commonPhong' :
                return v3d.MeshPhongMaterial;

            case 'commonLambert' :
                return v3d.MeshLambertMaterial;
    ...
    GLTFMaterialsCommonExtension.prototype.extendParams = function(materialParams, material, parser) {
        ...
        if (materialValues.diffuseFactor !== undefined) {
            ...
            materialParams.color = new v3d.Color().fromArray(materialValues.diffuseFactor);
        ...
        if (materialValues.specularFactor !== undefined) {
            ...
            materialParams.specular = new v3d.Color().fromArray(materialValues.specularFactor);
    ...
    function GLTFBinaryExtension(data) {
        ...
        if (this.header.magic !== BINARY_EXTENSION_HEADER_MAGIC) {
            ...
            throw new Error('v3d.GLTFLoader: Legacy binary file detected. Use GLTFLoader instead.');
    ...
    var INTERPOLATION = {
        CATMULLROMSPLINE: v3d.InterpolateSmooth,
        CUBICSPLINE: v3d.InterpolateSmooth,
    ...
    GLTFParser.prototype.loadBuffer = function(bufferIndex) {
        ...
        if (bufferDef.type && bufferDef.type !== 'arraybuffer') {
            ...
            throw new Error('v3d.GLTFLoader: %s buffer type is not supported.', bufferDef.type);
        ...
        return _each(json.accessors, function(accessor) {
            ...
            return parser.getDependency('bufferView', accessor.bufferView).then(function(bufferView) {
                ...
                if (byteStride && byteStride !== itemBytes) {
                    ...
                    var ib = new v3d.InterleavedBuffer(array, byteStride / elementBytes);
    ...
    GLTFParser.prototype.loadTexture = function(textureIndex) {
        ...
        return Promise.resolve(sourceURI).then(function(sourceURI) {
            ...
            var textureLoader = v3d.Loader.Handlers.get(sourceURI) || new v3d.TextureLoader();
            ...
            texture.format = textureDef.format !== undefined ? WEBGL_TEXTURE_FORMATS[textureDef.format] : v3d.RGBAFormat;

            if (textureDef.internalFormat !== undefined && texture.format !== WEBGL_TEXTURE_FORMATS[textureDef.internalFormat]) {

                console.warn('v3d.GLTFLoader: Three.js does not support texture internalFormat which is different from texture format. ' +
                                            'internalFormat will be forced to be the same value as format.');

            }

            texture.type = textureDef.type !== undefined ? WEBGL_TEXTURE_DATATYPES[textureDef.type] : v3d.UnsignedByteType;
     ...
     * @return {Promise<Array<v3d.Material>>}
     */
        ...
        return _each(json.materials, function(material) {
            ...
            if (material.emissiveFactor !== undefined) {
                ...
                if (materialType === v3d.MeshBasicMaterial) {
                    ...
                    materialParams.color = new v3d.Color().fromArray(material.emissiveFactor);

                } else {

                    materialParams.emissive = new v3d.Color().fromArray(material.emissiveFactor);
            ...
            return Promise.all(pending).then(function() {
                ...
                if (_material.map) _material.map.encoding = v3d.sRGBEncoding;
                if (_material.emissiveMap) _material.emissiveMap.encoding = v3d.sRGBEncoding;
    ...
    GLTFParser.prototype.loadCameras = function() {
        ...
        return _each(json.cameras, function(camera) {
            ...
            if (camera.type === 'perspective') {
                ...
                _camera = new v3d.PerspectiveCamera(v3d.Math.radToDeg(xfov), aspectRatio, params.znear || 1, params.zfar || 2e6);

            } else if (camera.type === 'orthographic') {

                _camera = new v3d.OrthographicCamera(params.xmag / - 2, params.xmag / 2, params.ymag / 2, params.ymag / - 2, params.znear, params.zfar);
                    ...
                    if (sampler) {
                        ...
                        if (node) {
                            ...
                            if (sampler.interpolation === 'CATMULLROMSPLINE') {
                                ...
                                console.warn('v3d.GLTFLoader: CATMULLROMSPLINE interpolation is not supported. Using CUBICSPLINE instead.');
                            ...
                            if (PATH_PROPERTIES[target.path] === PATH_PROPERTIES.weights) {
                                ...
                                // node should be v3d.Group here but
                ...
                return _each(__nodes, function(node, nodeIndex) {
                    ...
                    if (nodeDef.skin !== undefined) {
                        ...
                        for (var i = 0; i < node.children.length; i++) {
                            ...
                            var child = new v3d.SkinnedMesh(geometry, material);
                            ...
                            for (var j = 0, l = skinEntry.joints.length; j < l; j ++) {
                                ...
                                if (jointNode) {
                                    ...
                                    var mat = new v3d.Matrix4().fromArray(m, j * 16);
                                    boneInverses.push(mat);

                                } else {

                                    console.warn('v3d.GLTFLoader: Joint "%s" could not be found.', jointId);

                                }

                            }

                            child.bind(new v3d.Skeleton(bones, boneInverses), child.matrixWorld);
