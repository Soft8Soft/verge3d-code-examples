...
v3d.UTF8Loader = function() {};

/**
 * Load UTF8 encoded model
 * @param jsonUrl - URL from which to load json containing information about model
 * @param callback - Callback(v3d.Object3D) on successful loading of model
 * @param options - options on how to load model (see v3d.MTLLoader.MaterialCreator for basic options)
...
v3d.UTF8Loader.prototype.load = function(jsonUrl, callback, options) {
...
v3d.UTF8Loader.BufferGeometryCreator = function() {
};

v3d.UTF8Loader.BufferGeometryCreator.prototype.create = function(attribArray, indices) {
    ...
    geometry.addAttribute('uv', new v3d.BufferAttribute(uvs, 2));
...
v3d.UTF8Loader.prototype.decompressAttribsInner_ = function(str, inputStart, inputEnd,
...
v3d.UTF8Loader.prototype.decompressIndices_ = function(str, inputStart, numIndices, output, outputStart) {
...
v3d.UTF8Loader.prototype.decompressAABBs_ = function(str, inputStart, numBBoxen, decodeOffsets, decodeScales) {
...
v3d.UTF8Loader.prototype.decompressMesh = function(str, meshParams, decodeParams, name, idx, callback) {
...
v3d.UTF8Loader.prototype.copyAttrib = function(stride, attribsOutFixed, lastAttrib, index) {
...
v3d.UTF8Loader.prototype.decodeAttrib2 = function(str, stride, decodeOffsets, decodeScales, deltaStart,
...
v3d.UTF8Loader.prototype.accumulateNormal = function(i0, i1, i2, attribsOutFixed, crosses) {
...
v3d.UTF8Loader.prototype.decompressMesh2 = function(str, meshParams, decodeParams, name, idx, callback) {
...
v3d.UTF8Loader.prototype.downloadMesh = function(path, name, meshEntry, decodeParams, callback) {
...
v3d.UTF8Loader.prototype.downloadMeshes = function(path, meshUrlMap, decodeParams, callback) {
...
v3d.UTF8Loader.prototype.createMeshCallback = function(materialBaseUrl, loadModelInfo, allDoneCallback) {
    ...
    for (var url in meshUrlMap) {
        ...
        modelParts[url] = new v3d.Object3D();

    }

    var model = new v3d.Object3D();

    // Prepare materials first...

    var materialCreator = new v3d.MTLLoader.MaterialCreator(materialBaseUrl, loadModelInfo.options);
    ...
    var bufferGeometryCreator = new v3d.UTF8Loader.BufferGeometryCreator();
    ...
    var meshCallback = function(name, idx, attribArray, indexArray, bboxen, meshParams) {
        ...
        //model.add(new v3d.Mesh(geometry, material));
...
v3d.UTF8Loader.prototype.downloadModel = function(geometryBase, materialBase, model, callback) {
...
v3d.UTF8Loader.prototype.downloadModelJson = function(jsonUrl, callback, options) {
