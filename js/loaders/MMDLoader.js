 ...
 */
    ...
    /**
 * @param {v3d.LoadingManager} manager
 */

    class MMDLoader extends v3d.Loader {
   ...
   */
        ...
        /**
   * Loads Model file (.pmd or .pmx) as a v3d.SkinnedMesh.
   *
   ...
   */
        ...
        load(url, onLoad, onProgress, onError) {
            ...
            if (modelExtension !== 'pmd' && modelExtension !== 'pmx') {
                ...
                if (onError) onError(new Error('v3d.MMDLoader: Unknown model file extension .' + modelExtension + '.'));
                return;
        ...
        /**
   * Loads Motion file(s) (.vmd) as a v3d.AnimationClip.
   * If two or more files are specified, they'll be merged.
   *
   * @param {string|Array<string>} url - url(s) to animation(.vmd) file(s)
   * @param {SkinnedMesh|v3d.Camera} object - tracks will be fitting to this object
   * @param {function} onLoad
   * @param {function} onProgress
   * @param {function} onError
   */
   ...
   * a v3d.SkinnedMesh and a v3d.AnimationClip.
   * Tracks of v3d.AnimationClip are fitting to the model.
   *
   ...
   */
    ...
    const NON_ALPHA_CHANNEL_FORMATS = [v3d.RGB_S3TC_DXT1_Format, v3d.RGB_PVRTC_4BPPV1_Format, v3d.RGB_PVRTC_2BPPV1_Format, v3d.RGB_ETC1_Format, v3d.RGB_ETC2_Format]; // Builders. They build Three.js object from Object data parsed by MMDParser.
 ...
 */
   ...
   */
        ...
        build(data, resourcePath, onProgress, onError) {
            ...
            const skeleton = new v3d.Skeleton(initBones(mesh));
   ...
   */
        build(data) {
                ...
                for (let i = 0; i < data.metadata.boneCount; i++) {
                    ...
                    for (let j = 0, jl = ik.links.length; j < jl; j ++) {
                        ...
                        if (ik.links[j].angleLimitation === 1) {
                            ...
                            link.rotationMax = new v3d.Vector3().fromArray(rotationMax);
            ...
            for (let i = 0; i < data.metadata.morphCount; i++) {
                ...
                const attribute = new v3d.Float32BufferAttribute(data.metadata.vertexCount * 3, 3);
 ...
 */
    ...
    class MaterialBuilder {
        ...
        constructor(manager) {
            ...
            this.textureLoader = new v3d.TextureLoader(this.manager);
   ...
   */
        ...
        build(data, geometry
           ...
           */
                ...
                params.diffuse = new v3d.Color().fromArray(material.diffuse);
                params.opacity = material.diffuse[3];
                params.specular = new v3d.Color().fromArray(material.specular);
                ...
                params.blendSrc = v3d.SrcAlphaFactor;
                params.blendDst = v3d.OneMinusSrcAlphaFactor;
                params.blendSrcAlpha = v3d.SrcAlphaFactor;
                params.blendDstAlpha = v3d.DstAlphaFactor; // side
                ...
                if (data.metadata.format === 'pmx' && (material.flag & 0x1) === 1) {
                    ...
                    params.side = params.opacity === 1.0 ? v3d.FrontSide : v3d.DoubleSide;
                ...
                if (data.metadata.format === 'pmd') {
                    ...
                    if (material.fileName) {
                        ...
                        if (fileNames.length > 1) {
                            ...
                            params.combine = extension === '.sph' ? v3d.MultiplyOperation : v3d.AddOperation;
                    ...
                    if (material.envTextureIndex !== - 1 && (material.envFlag === 1 || material.envFlag == 2)) {
                        ...
                        params.matcapCombine = material.envFlag === 1 ? v3d.MultiplyOperation : v3d.AddOperation;
        ...
        _getTGALoader() {
            ...
            if (this.tgaLoader === null) {
                ...
                if (v3d.TGALoader === undefined) {

                    throw new Error('v3d.MMDLoader: Import v3d.TGALoader');

                }

                this.tgaLoader = new v3d.TGALoader(this.manager);
        ...
        _loadTexture(filePath, textures, params, onProgress, onError) {
            ...
            if (params.isDefaultToonTexture === true) {
                ...
                try {
                    ...
                    console.warn('v3d.MMDLoader: ' + filePath + ' seems like a ' + 'not right default texture path. Using toon00.bmp instead.');
                    index = 0;
   ...
   */
        build(vmd, mesh) {
            ...
            return new v3d.AnimationClip('', - 1, tracks);
   ...
   */
        ...
        buildSkeletalAnimation(vmd, mesh) {
            ...
            for (const key in motions) {
                ...
                tracks.push(this._createTrack(targetName + '.position', v3d.VectorKeyframeTrack, times, positions, pInterpolations));
                tracks.push(this._createTrack(targetName + '.quaternion', v3d.QuaternionKeyframeTrack, times, rotations, rInterpolations));
   ...
   */
        ...
        buildMorphAnimation(vmd, mesh) {
            ...
            for (const key in morphs) {
                ...
                tracks.push(new v3d.NumberKeyframeTrack('.morphTargetInfluences[' + morphTargetDictionary[key] + ']', times, values));
   ...
   */
        ...
        buildCameraAnimation(vmd) {
            ...
            const tracks = []; // I expect an object whose name 'target' exists under v3d.Camera

            tracks.push(this._createTrack('target.position', v3d.VectorKeyframeTrack, times, centers, cInterpolations));
            tracks.push(this._createTrack('.quaternion', v3d.QuaternionKeyframeTrack, times, quaternions, qInterpolations));
            tracks.push(this._createTrack('.position', v3d.VectorKeyframeTrack, times, positions, pInterpolations));
            tracks.push(this._createTrack('.fov', v3d.NumberKeyframeTrack, times, fovs, fInterpolations));
            return new v3d.AnimationClip('', - 1, tracks);
    ...
    class CubicBezierInterpolation extends v3d.Interpolant {
    ...
    class MMDToonMaterial extends v3d.ShaderMaterial {

        constructor(parameters) {

            super();
            this._matcapCombine = v3d.AddOperation;
            this.emissiveIntensity = 1.0;
            this.normalMapType = v3d.TangentSpaceNormalMap;
            this.combine = v3d.MultiplyOperation;
            this.wireframeLinecap = 'round';
            this.wireframeLinejoin = 'round';
            this.flatShading = false;
            this.lights = true;
            this.vertexShader = v3d.MMDToonShader.vertexShader;
            this.fragmentShader = v3d.MMDToonShader.fragmentShader;
            this.defines = Object.assign({}, v3d.MMDToonShader.defines);
            ...
            this.uniforms = v3d.UniformsUtils.clone(v3d.MMDToonShader.uniforms); // merged from MeshToon/Phong/MatcapMaterial
