...
v3d.MMDLoader = function(manager) {
...
v3d.MMDLoader.prototype = Object.create(v3d.Loader.prototype);
v3d.MMDLoader.prototype.constructor = v3d.MMDLoader;
 ...
 */
v3d.MMDLoader.prototype.defaultToonTextures = [
 ...
 */
v3d.MMDLoader.prototype.setTextureCrossOrigin = function(value) {

    this.textureCrossOrigin = value;

};

v3d.MMDLoader.prototype.load = function(modelUrl, vmdUrls, callback, onProgress, onError) {
...
v3d.MMDLoader.prototype.loadModel = function(url, callback, onProgress, onError) {
...
v3d.MMDLoader.prototype.createModel = function(buffer, modelExtension, texturePath, onProgress, onError) {

    return this.createMesh(this.parseModel(buffer, modelExtension), texturePath, onProgress, onError);

};

v3d.MMDLoader.prototype.loadVmd = function(url, callback, onProgress, onError) {
...
v3d.MMDLoader.prototype.loadVmds = function(urls, callback, onProgress, onError) {
...
v3d.MMDLoader.prototype.loadAudio = function(url, callback, onProgress, onError) {

    var listener = new v3d.AudioListener();
    var audio = new v3d.Audio(listener);
    var loader = new v3d.AudioLoader(this.manager);
...
v3d.MMDLoader.prototype.loadVpd = function(url, callback, onProgress, onError, params) {
...
v3d.MMDLoader.prototype.parseModel = function(buffer, modelExtension) {
...
v3d.MMDLoader.prototype.parsePmd = function(buffer) {

    return this.parser.parsePmd(buffer, true);

};

v3d.MMDLoader.prototype.parsePmx = function(buffer) {

    return this.parser.parsePmx(buffer, true);

};

v3d.MMDLoader.prototype.parseVmd = function(buffer) {

    return this.parser.parseVmd(buffer, true);

};

v3d.MMDLoader.prototype.parseVpd = function(text) {

    return this.parser.parseVpd(text, true);

};

v3d.MMDLoader.prototype.mergeVmds = function(vmds) {

    return this.parser.mergeVmds(vmds);

};

v3d.MMDLoader.prototype.pourVmdIntoModel = function(mesh, vmd, name) {

    this.createAnimation(mesh, vmd, name);

};

v3d.MMDLoader.prototype.pourVmdIntoCamera = function(camera, vmd, name) {

    var helper = new v3d.MMDLoader.DataCreationHelper();
    ...
    var initAnimation = function() {
        ...
        var createTrack = function(node, type, times, values, interpolations) {
            ...
            return new v3d.MMDLoader[type](node, times, values, interpolations);
        ...
        var clip = new v3d.AnimationClip(name === undefined ? v3d.Math.generateUUID() : name, - 1, tracks);

        if (camera.center === undefined) camera.center = new v3d.Vector3(0, 0, 0);
...
v3d.MMDLoader.prototype.extractExtension = function(url) {
...
v3d.MMDLoader.prototype.loadFile = function(url, onLoad, onProgress, onError, responseType, mimeType) {
...
v3d.MMDLoader.prototype.loadFileAsBuffer = function(url, onLoad, onProgress, onError) {

    this.loadFile(url, onLoad, onProgress, onError, 'arraybuffer');

};

v3d.MMDLoader.prototype.loadFileAsText = function(url, onLoad, onProgress, onError) {

    this.loadFile(url, onLoad, onProgress, onError, 'text');

};

v3d.MMDLoader.prototype.loadFileAsShiftJISText = function(url, onLoad, onProgress, onError) {

    this.loadFile(url, onLoad, onProgress, onError, 'text', 'text/plain; charset=shift_jis');

};

v3d.MMDLoader.prototype.createMesh = function(model, texturePath, onProgress, onError) {
            ...
            for (var i = 0; i < model.metadata.ikCount; i++) {
                ...
                for (var j = 0; j < ik.links.length; j ++) {
                    ...
                    if (model.bones[link.index].name.indexOf('ひざ') >= 0) {
                        ...
                        link.limitation = new v3d.Vector3(1.0, 0.0, 0.0);
    ...
    var initMorphs = function() {
        ...
        for (var i = 0; i < model.metadata.morphCount; i++) {
            ...
            var attribute = new v3d.Float32BufferAttribute(model.metadata.vertexCount * 3, 3);
    ...
    var initMaterials = function() {
        ...
        var textures = {};
        var textureLoader = new v3d.TextureLoader(scope.manager);
        var tgaLoader = new v3d.TGALoader(scope.manager);
        ...
        function loadTexture(filePath, params) {
            ...
            if (params.defaultTexturePath === true) {
                ...
                try {
                    ...
                    console.warn('v3d.MMDLoader: ' + filePath + ' seems like not right default texture path. Using toon00.bmp instead.');
            ...
            var texture = loader.load(fullPath, function(t) {
                ...
                t.flipY = false;
                t.wrapS = v3d.RepeatWrapping;
                t.wrapT = v3d.RepeatWrapping;
        ...
        function getTexture(name, textures) {
            ...
            if (textures[name] === undefined) {
                ...
                console.warn('v3d.MMDLoader: Undefined texture', name);
        ...
        for (var i = 0; i < model.metadata.materialCount; i++) {
             ...
             */
            params.color = new v3d.Color(m.diffuse[0], m.diffuse[1], m.diffuse[2]);
            params.opacity = m.diffuse[3];
            params.specular = new v3d.Color(m.specular[0], m.specular[1], m.specular[2]);
            params.shininess = m.shininess;

            if (params.opacity === 1.0) {

                params.side = v3d.FrontSide;
                params.transparent = false;

            } else {

                params.side = v3d.DoubleSide;
                    ...
                    for (var j = 0; j < fileNames.length; j ++) {
                        ...
                        if (n.indexOf('.sph') >= 0 || n.indexOf('.spa') >= 0) {
                            ...
                            if (n.indexOf('.sph') >= 0) {
                                ...
                                params.envMapType = v3d.MultiplyOperation;

                            } else {

                                params.envMapType = v3d.AddOperation;
            ...
            params.emissive = new v3d.Color(m.ambient[0] * coef, m.ambient[1] * coef, m.ambient[2] * coef);
        ...
        for (var i = 0; i < materialParams.length; i++) {
            ...
            var m = new v3d.MeshToonMaterial();
            ...
            m.lights = true;
            m.side = (model.metadata.format === 'pmx' && (p2.flag & 0x1) === 1) ? v3d.DoubleSide : p.side;
            m.transparent = p.transparent;
            m.fog = true;

            m.blending = v3d.CustomBlending;
            m.blendSrc = v3d.SrcAlphaFactor;
            m.blendDst = v3d.OneMinusSrcAlphaFactor;
            m.blendSrcAlpha = v3d.SrcAlphaFactor;
            m.blendDstAlpha = v3d.DstAlphaFactor;
            ...
            if (model.metadata.format === 'pmd') {
                ...
                m.outlineParameters = {
                    ...
                    color: new v3d.Color(0.0, 0.0, 0.0),
                    alpha: 1.0
                };
                ...
                m.outlineParameters = {
                    ...
                    color: new v3d.Color(p2.edgeColor[0], p2.edgeColor[1], p2.edgeColor[2]),
    ...
    var initGeometry = function() {
        ...
        geometry.addAttribute('skinIndex', new v3d.Float32BufferAttribute(buffer.skinIndices, 4));
        geometry.addAttribute('skinWeight', new v3d.Float32BufferAttribute(buffer.skinWeights, 4));
    ...
    var mesh = new v3d.SkinnedMesh(geometry, materials);
...
v3d.MMDLoader.prototype.createAnimation = function(mesh, vmd, name) {
    ...
    var initMotionAnimations = function() {
        ...
        for (var i = 0; i < orderedMotions.length; i++) {
            ...
            tracks.push(new v3d.MMDLoader.VectorKeyframeTrackEx(boneName + '.position', times, positions, pInterpolations));
            tracks.push(new v3d.MMDLoader.QuaternionKeyframeTrackEx(boneName + '.quaternion', times, rotations, rInterpolations));
    ...
    var initMorphAnimations = function() {
        ...
        for (var i = 0; i < orderedMorphs.length; i++) {
            ...
            tracks.push(new v3d.NumberKeyframeTrack('.morphTargetInfluences[' + i + ']', times, values));

        }

        var clip = new v3d.AnimationClip(name === undefined ? v3d.Math.generateUUID() : name + 'Morph', - 1, tracks);
...
v3d.MMDLoader.DataCreationHelper = function() {

};

v3d.MMDLoader.DataCreationHelper.prototype = {

    constructor: v3d.MMDLoader.DataCreationHelper,
 ...
 */
v3d.MMDLoader.VectorKeyframeTrackEx = function(name, times, values, interpolationParameterArray) {

    this.interpolationParameters = new Float32Array(interpolationParameterArray);

    v3d.VectorKeyframeTrack.call(this, name, times, values);

};

v3d.MMDLoader.VectorKeyframeTrackEx.prototype = Object.create(v3d.VectorKeyframeTrack.prototype);
v3d.MMDLoader.VectorKeyframeTrackEx.prototype.constructor = v3d.MMDLoader.VectorKeyframeTrackEx;
v3d.MMDLoader.VectorKeyframeTrackEx.prototype.TimeBufferType = Float64Array;

v3d.MMDLoader.VectorKeyframeTrackEx.prototype.InterpolantFactoryMethodCubicBezier = function(result) {

    return new v3d.MMDLoader.CubicBezierInterpolation(this.times, this.values, this.getValueSize(), result, this.interpolationParameters);

};

v3d.MMDLoader.VectorKeyframeTrackEx.prototype.setInterpolation = function(interpolation) {

    this.createInterpolant = this.InterpolantFactoryMethodCubicBezier;

};

v3d.MMDLoader.QuaternionKeyframeTrackEx = function(name, times, values, interpolationParameterArray) {

    this.interpolationParameters = new Float32Array(interpolationParameterArray);

    v3d.QuaternionKeyframeTrack.call(this, name, times, values);

};

v3d.MMDLoader.QuaternionKeyframeTrackEx.prototype = Object.create(v3d.QuaternionKeyframeTrack.prototype);
v3d.MMDLoader.QuaternionKeyframeTrackEx.prototype.constructor = v3d.MMDLoader.QuaternionKeyframeTrackEx;
v3d.MMDLoader.QuaternionKeyframeTrackEx.prototype.TimeBufferType = Float64Array;

v3d.MMDLoader.QuaternionKeyframeTrackEx.prototype.InterpolantFactoryMethodCubicBezier = function(result) {

    return new v3d.MMDLoader.CubicBezierInterpolation(this.times, this.values, this.getValueSize(), result, this.interpolationParameters);

};

v3d.MMDLoader.QuaternionKeyframeTrackEx.prototype.setInterpolation = function(interpolation) {

    this.createInterpolant = this.InterpolantFactoryMethodCubicBezier;

};

v3d.MMDLoader.NumberKeyframeTrackEx = function(name, times, values, interpolationParameterArray) {

    this.interpolationParameters = new Float32Array(interpolationParameterArray);

    v3d.NumberKeyframeTrack.call(this, name, times, values);

};

v3d.MMDLoader.NumberKeyframeTrackEx.prototype = Object.create(v3d.NumberKeyframeTrack.prototype);
v3d.MMDLoader.NumberKeyframeTrackEx.prototype.constructor = v3d.MMDLoader.NumberKeyframeTrackEx;
v3d.MMDLoader.NumberKeyframeTrackEx.prototype.TimeBufferType = Float64Array;

v3d.MMDLoader.NumberKeyframeTrackEx.prototype.InterpolantFactoryMethodCubicBezier = function(result) {

    return new v3d.MMDLoader.CubicBezierInterpolation(this.times, this.values, this.getValueSize(), result, this.interpolationParameters);

};

v3d.MMDLoader.NumberKeyframeTrackEx.prototype.setInterpolation = function(interpolation) {

    this.createInterpolant = this.InterpolantFactoryMethodCubicBezier;

};

v3d.MMDLoader.CubicBezierInterpolation = function(parameterPositions, sampleValues, sampleSize, resultBuffer, params) {

    v3d.Interpolant.call(this, parameterPositions, sampleValues, sampleSize, resultBuffer);

    this.params = params;

};

v3d.MMDLoader.CubicBezierInterpolation.prototype = Object.create(v3d.LinearInterpolant.prototype);
v3d.MMDLoader.CubicBezierInterpolation.prototype.constructor = v3d.MMDLoader.CubicBezierInterpolation;

v3d.MMDLoader.CubicBezierInterpolation.prototype.interpolate_ = function(i1, t0, t, t1) {
    ...
    if (stride === 4) { // Quaternion
        ...
        v3d.Quaternion.slerpFlat(result, 0, values, offset0, values, offset1, ratio);
...
v3d.MMDLoader.CubicBezierInterpolation.prototype._calculate = function(x1, x2, y1, y2, x) {
...
v3d.MMDAudioManager = function(audio, listener, p) {
...
v3d.MMDAudioManager.prototype = {

    constructor: v3d.MMDAudioManager,
...
v3d.MMDGrantSolver = function(mesh) {

    this.mesh = mesh;

};

v3d.MMDGrantSolver.prototype = {

    constructor: v3d.MMDGrantSolver,
...
v3d.MMDHelper.prototype = {

    constructor: v3d.MMDHelper,

    add: function(mesh) {

        if (! (mesh instanceof v3d.SkinnedMesh)) {

            throw new Error('v3d.MMDHelper.add() accepts only v3d.SkinnedMesh instance.');
    ...
    setAudio: function(audio, listener, params) {
        ...
        this.audioManager = new v3d.MMDAudioManager(audio, listener, params);
    ...
    setPhysics: function(mesh, params) {
        ...
        var physics = new v3d.MMDPhysics(mesh, params);
    ...
    setAnimation: function(mesh) {
        ...
        if (mesh.geometry.animations !== undefined) {
            ...
            mesh.mixer = new v3d.AnimationMixer(mesh);
            ...
            if (foundAnimation) {
                ...
                mesh.ikSolver = new v3d.CCDIKSolver(mesh);

                if (mesh.geometry.grants !== undefined) {

                    mesh.grantSolver = new v3d.MMDGrantSolver(mesh);
    ...
    setCameraAnimation: function(camera) {
        ...
        if (camera.animations !== undefined) {
            ...
            camera.mixer = new v3d.AnimationMixer(camera);
    ...
    poseAsVpd: function(mesh, vpd, params) {
        ...
        var thV = new v3d.Vector3();
        var thQ = new v3d.Quaternion();
        ...
        if (params.preventIk !== true) {
            ...
            var solver = new v3d.CCDIKSolver(mesh);
        ...
        if (params.preventGrant !== true && mesh.geometry.grants !== undefined) {
            ...
            var solver = new v3d.MMDGrantSolver(mesh);
            solver.update();
     ...
     *       v3d.PropertyMixer.apply() seems to save values into buffer cache
