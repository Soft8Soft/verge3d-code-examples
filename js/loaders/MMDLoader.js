...
v3d.MMDLoader = (function() {
    ...
    MMDLoader.prototype = {
        ...
        load: function(url, onLoad, onProgress, onError) {
            ...
            var texturePath = v3d.LoaderUtils.extractUrlBase(url);
         ...
         * @param {v3d.SkinnedMesh|v3d.Camera} object - tracks will be fitting to this object
         * @param {function} onLoad
         * @param {function} onProgress
         * @param {function} onError
         */
    ...
    GeometryBuilder.prototype = {
        ...
        build: function(data) {
            ...
            for (var i = 0; i < data.metadata.morphCount; i++) {
                ...
                var attribute = new v3d.Float32BufferAttribute(data.metadata.vertexCount * 3, 3);
    ...
    MaterialBuilder.prototype = {
        ...
        /**
         * @param {Object} data - parsed PMD/PMX data
         * @param {v3d.BufferGeometry} geometry - some properties are dependend on geometry
         * @param {function} onProgress
         * @param {function} onError
        ...
        build: function(data, geometry, onProgress, onError) {
            ...
            for (var i = 0; i < data.metadata.materialCount; i++) {
                 ...
                 */
                params.color = new v3d.Color().fromArray(material.diffuse);
                ...
                params.blendDstAlpha = v3d.DstAlphaFactor;
                ...
                materials.push(new v3d.MeshToonMaterial(params));
        ...
        _loadTexture: function(filePath, textures, params, onProgress, onError) {
            ...
            if (params.isDefaultToonTexture === true) {
                ...
                try {
                    ...
                    console.warn('v3d.MMDLoader: ' + filePath + ' seems like a '
    ...
    AnimationBuilder.prototype = {
         ...
         * @param {v3d.SkinnedMesh} mesh - tracks will be fitting to mesh
         * @return {v3d.AnimationClip}
         */
        ...
        buildCameraAnimation: function(vmd) {
            ...
            // I expect an object whose name 'target' exists under v3d.Camera
    ...
    CubicBezierInterpolation.prototype = Object.assign(Object.create(v3d.Interpolant.prototype), {
