 ...
 */
    ...
    class PRWMLoader extends v3d.Loader {
        ...
        parse(arrayBuffer) {
            ...
            const data = decodePrwm(arrayBuffer),
                ...
                bufferGeometry = new v3d.BufferGeometry();
            ...
            if (data.indices !== null) {
                ...
                bufferGeometry.setIndex(new v3d.BufferAttribute(data.indices, 1));
