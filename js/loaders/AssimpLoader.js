...
v3d.AssimpLoader.prototype = {
    ...
    parse: function(buffer, path) {
        ...
        Virtulous.KeyFrame = function(time, matrix) {
            ...
            this.quaternion = new v3d.Quaternion();
            this.scale = new v3d.Vector3(1, 1, 1);
        ...
        Virtulous.KeyFrame.tempAniPos = new v3d.Vector3();
        Virtulous.KeyFrame.tempAniQuat = new v3d.Quaternion();
        Virtulous.KeyFrame.tempAniScale = new v3d.Vector3(1, 1, 1);
        Virtulous.KeyFrame.tempAniMatrix = new v3d.Matrix4();
            ...
            this.hookupSkeletons = function(scene, threeScene) {
                ...
                for (var i = 0; i < this.mBones.length; i++) {
                    ...
                    if (bone) {
                        ...
                        offsetMatrix.push(this.mBones[i].mOffsetMatrix.tov3d());
                ...
                var skeleton = new v3d.Skeleton(allBones, offsetMatrix);

                this.threeNode.bind(skeleton, new v3d.Matrix4());
                this.threeNode.material.skinning = true;

            };

            this.tov3d = function(scene) {

                if (this.threeNode) return this.threeNode;
                var geometry = new v3d.BufferGeometry();
                var mat;
                if (scene.mMaterials[this.mMaterialIndex])
                    mat = scene.mMaterials[this.mMaterialIndex].tov3d(scene);
                else
                    mat = new v3d.MeshLambertMaterial();
                geometry.setIndex(new v3d.BufferAttribute(new Uint32Array(this.mIndexArray), 1));
                geometry.addAttribute('position', new v3d.BufferAttribute(this.mVertexBuffer, 3));
                if (this.mNormalBuffer && this.mNormalBuffer.length > 0)
                    geometry.addAttribute('normal', new v3d.BufferAttribute(this.mNormalBuffer, 3));
                if (this.mColorBuffer && this.mColorBuffer.length > 0)
                    geometry.addAttribute('color', new v3d.BufferAttribute(this.mColorBuffer, 4));
                if (this.mTexCoordsBuffers[0] && this.mTexCoordsBuffers[0].length > 0)
                    geometry.addAttribute('uv', new v3d.BufferAttribute(new Float32Array(this.mTexCoordsBuffers[0]), 2));
                if (this.mTexCoordsBuffers[1] && this.mTexCoordsBuffers[1].length > 0)
                    geometry.addAttribute('uv1', new v3d.BufferAttribute(new Float32Array(this.mTexCoordsBuffers[1]), 2));
                if (this.mTangentBuffer && this.mTangentBuffer.length > 0)
                    geometry.addAttribute('tangents', new v3d.BufferAttribute(this.mTangentBuffer, 3));
                if (this.mBitangentBuffer && this.mBitangentBuffer.length > 0)
                    geometry.addAttribute('bitangents', new v3d.BufferAttribute(this.mBitangentBuffer, 3));
                if (this.mBones.length > 0) {
                    ...
                    geometry.addAttribute('skinWeight', new v3d.BufferAttribute(new Float32Array(_weights), BONESPERVERT));
                    geometry.addAttribute('skinIndex', new v3d.BufferAttribute(new Float32Array(_bones), BONESPERVERT));
        ...
        function aiVector3D() {
            ...
            this.tov3d = function() {
                ...
                return new v3d.Vector3(this.x, this.y, this.z);
        ...
        function aiVector2D() {
            ...
            this.tov3d = function() {
                ...
                return new v3d.Vector2(this.x, this.y);
        ...
        function aiVector4D() {
            ...
            this.tov3d = function() {
                ...
                return new v3d.Vector4(this.w, this.x, this.y, this.z);
        ...
        function aiColor4D() {
            ...
            this.tov3d = function() {
                ...
                return new v3d.Color(this.r, this.g, this.b, this.a);
        ...
        function aiColor3D() {
            ...
            this.tov3d = function() {
                ...
                return new v3d.Color(this.r, this.g, this.b, 1);
        ...
        function aiQuaternion() {
            ...
            this.tov3d = function() {
                ...
                return new v3d.Quaternion(this.x, this.y, this.z, this.w);
        ...
        function aiNode() {
            ...
            this.tov3d = function(scene) {
                ...
                if (this.threeNode) return this.threeNode;
                var o = new v3d.Object3D();
                o.name = this.mName;
                o.matrix = this.mTransformation.tov3d();

                for (var i = 0; i < this.mChildren.length; i++) {

                    o.add(this.mChildren[i].tov3d(scene));

                }

                for (var i = 0; i < this.mMeshes.length; i++) {

                    o.add(scene.mMeshes[this.mMeshes[i]].tov3d(scene));
        ...
        function sampleTrack(keys, time, lne, lerp) {
            ...
            if (keys.length == 1) return keys[0].mValue.tov3d();
        ...
        function aiNodeAnim() {
            ...
            this.tov3d = function(o, tps) {
                ...
                track.target = o.findNode(this.mNodeName).tov3d();
        ...
        function aiAnimation() {
            ...
            this.tov3d = function(root) {
                ...
                for (var i in this.mChannels) {
                    ...
                    var tracks = this.mChannels[i].tov3d(root);
        ...
        function aiScene() {
            ...
            this.tov3d = function() {
                ...
                var o = this.mRootNode.tov3d(this);
                ...
                if (this.mAnimations.length > 0) {
                    ...
                    var a = this.mAnimations[0].tov3d(this);
