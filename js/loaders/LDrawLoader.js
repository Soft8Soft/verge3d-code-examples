...
v3d.LDrawLoader = (function() {
    ...
    var tempVec0 = new v3d.Vector3();
    var tempVec1 = new v3d.Vector3();
    ...
    function createObject(elements, elementSize, isConditionalSegments) {
        ...
        // Creates a v3d.LineSegments (elementSize = 2) or a v3d.Mesh (elementSize = 3)
        ...
        bufferGeometry.setAttribute('position', new v3d.Float32BufferAttribute(positions, 3));
        ...
        if (elementSize === 2) {
            ...
            object3d = new v3d.LineSegments(bufferGeometry, materials);

        } else if (elementSize === 3) {

            object3d = new v3d.Mesh(bufferGeometry, materials);
        ...
        if (isConditionalSegments) {
            ...
            bufferGeometry.setAttribute('control0', new v3d.BufferAttribute(controlArray0, 3, false));
            bufferGeometry.setAttribute('control1', new v3d.BufferAttribute(controlArray1, 3, false));
            bufferGeometry.setAttribute('direction', new v3d.BufferAttribute(directionArray, 3, false));
    ...
    function LDrawLoader(manager) {
        ...
        // Array of v3d.Material
        this.materials = [];

        // Not using v3d.Cache here because it returns the previous HTML error response instead of calling onError()
    ...
    LDrawLoader.prototype = Object.assign(Object.create(v3d.Loader.prototype), {
        ...
        parse: function(text, path, onLoad) {
            ...
            // Async parse.  This function calls onParse with the parsed v3d.Object3D as parameter
        ...
        parseColourMetaDirective: function(lineParser) {
            ...
            // Parses a colour definition and returns a v3d.Material or null if error
            ...
            switch (finishType) {
                ...
                case LDrawLoader.FINISH_TYPE_DEFAULT:
                    ...
                    material = new v3d.MeshStandardMaterial({ color: colour, roughness: 0.3, envMapIntensity: 0.3, metalness: 0 });
                    break;

                case LDrawLoader.FINISH_TYPE_PEARLESCENT:

                    // Try to imitate pearlescency by setting the specular to the complementary of the color, and low shininess
                    var specular = new v3d.Color(colour);
                    var hsl = specular.getHSL({ h: 0, s: 0, l: 0 });
                    hsl.h = (hsl.h + 0.5) % 1;
                    hsl.l = Math.min(1, hsl.l + (1 - hsl.l) * 0.7);
                    specular.setHSL(hsl.h, hsl.s, hsl.l);

                    material = new v3d.MeshPhongMaterial({ color: colour, specular: specular, shininess: 10, reflectivity: 0.3 });
                    break;

                case LDrawLoader.FINISH_TYPE_CHROME:

                    // Mirror finish surface
                    material = new v3d.MeshStandardMaterial({ color: colour, roughness: 0, metalness: 1 });
                    break;

                case LDrawLoader.FINISH_TYPE_RUBBER:

                    // Rubber finish
                    material = new v3d.MeshStandardMaterial({ color: colour, roughness: 0.9, metalness: 0 });
                    canHaveEnvMap = false;
                    break;
                ...
                case LDrawLoader.FINISH_TYPE_MATTE_METALLIC:
                    ...
                    material = new v3d.MeshStandardMaterial({ color: colour, roughness: 0.8, metalness: 0.4 });
                    break;

                case LDrawLoader.FINISH_TYPE_METAL:

                    // Average metal finish
                    material = new v3d.MeshStandardMaterial({ color: colour, roughness: 0.2, metalness: 0.85 });
                    break;
            ...
            if (!edgeMaterial) {
                ...
                edgeMaterial = new v3d.LineBasicMaterial({
                    color: edgeColour,
        ...
        objectParse: function(text) {
            ...
            function parseColourCode(lineParser, forEdge) {
                ...
                // Parses next colour code and returns a v3d.Material
            ...
            function parseVector(lp) {
                ...
                var v = new v3d.Vector3(parseFloat(lp.getToken()), parseFloat(lp.getToken()), parseFloat(lp.getToken()));
            ...
            for (lineIndex = 0; lineIndex < numLines; lineIndex ++) {
                ...
                switch (lineType) {
                                    ...
                                    while (! lp.isAtTheEnd()) {
                                        ...
                                        switch (token) {
                                            ...
                                            default:
                                                ...
                                                console.warn('v3d.LDrawLoader: BFC directive "' + token + '" is unknown.');
                    ...
                    case '1':
                        ...
                        var matrix = new v3d.Matrix4().set(
                            m0, m1, m2, posX,
                            m3, m4, m5, posY,
                            m6, m7, m8, posZ,
                            0, 0, 0, 1
        ...
        processObject: function(text, onProcessed, subobject, url) {
            ...
            // Parse the object (returns a v3d.Group)
