...
v3d.LDrawLoader = (function() {
    ...
    function createObject(elements, elementSize) {
        ...
        bufferGeometry.addAttribute('position', new v3d.Float32BufferAttribute(vertices, 3));
        ...
        parseColourMetaDirective: function(lineParser) {
            ...
            switch (finishType) {
                ...
                case LDrawLoader.FINISH_TYPE_PEARLESCENT:
                    ...
                    material = new v3d.MeshPhongMaterial({ color: colour, specular: specular, shininess: shininess, reflectivity: 0.3 });
                    break;
                ...
                case LDrawLoader.FINISH_TYPE_RUBBER:
                    ...
                    material = new v3d.MeshLambertMaterial({ color: colour });
                    canHaveEnvMap = false;
                    break;
            ...
            if (!edgeMaterial) {
                ...
                edgeMaterial = new v3d.LineBasicMaterial({ color: edgeColour });
        ...
        parse: function(text) {
            ...
            if (this.separateObjects) {
                ...
                if (this.currentGroupObject === null) {
                    ...
                    this.currentGroupObject = new v3d.Group();
