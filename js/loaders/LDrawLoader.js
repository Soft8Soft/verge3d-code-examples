(function() {
    ...
    class LDrawConditionalLineMaterial extends v3d.ShaderMaterial {
    ...
    class ConditionalLineSegments extends v3d.LineSegments {
    ...
    function generateFaceNormals(faces) {
        ...
        for (let i = 0, l = faces.length; i < l; i++) {
            ...
            face.faceNormal = new v3d.Vector3().crossVectors(_tempVec0, _tempVec1).normalize();

        }

    }

    const _ray = new v3d.Ray();
    ...
    function smoothNormals(faces, lineSegments, checkSubSegments = false) {
        ...
        for (let i = 0, l = lineSegments.length; i < l; i++) {
            ...
            if (checkSubSegments) {
                ...
                const ray = toNormalizedRay(v0, v1, new v3d.Ray());
    ...
    class LineParser {
        ...
        getVector() {
            ...
            return new v3d.Vector3(parseFloat(this.getToken()), parseFloat(this.getToken()), parseFloat(this.getToken()));
    ...
    class LDrawParsedCache {
        ...
        async fetchData(fileName) {
            ...
            while (locationState !== FILE_LOCATION_NOT_FOUND) {
                ...
                const fileLoader = new v3d.FileLoader(loader.manager);
    ...
    function createObject(elements, elementSize, isConditionalSegments = false, totalElements = null) {
        ...
        for (let iElem = 0, nElem = elements.length; iElem < nElem; iElem ++) {
            ...
            if (elementSize === 3) {
                ...
                if (!elem.faceNormal) {
                    ...
                    elem.faceNormal = new v3d.Vector3().crossVectors(_tempVec0, _tempVec1).normalize();
        ...
        bufferGeometry.setAttribute('position', new v3d.BufferAttribute(positions, 3));

        if (normals !== null) {

            bufferGeometry.setAttribute('normal', new v3d.BufferAttribute(normals, 3));
        ...
        if (elementSize === 2) {
            ...
            if (isConditionalSegments) {
                ...
                object3d = new v3d.LineSegments(bufferGeometry, materials.length === 1 ? materials[0] : materials);

            }

        } else if (elementSize === 3) {

            object3d = new v3d.Mesh(bufferGeometry, materials.length === 1 ? materials[0] : materials);
    ...
    class LDrawLoader extends v3d.Loader {
        ...
        constructor(manager) {
            ...
            super(manager); // Array of v3d.Material
        ...
        parseColorMetaDirective(lineParser) {
            ...
            // Parses a color definition and returns a v3d.Material
