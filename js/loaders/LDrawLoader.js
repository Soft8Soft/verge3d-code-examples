...
`
    ...
    const _tempVec0 = new v3d.Vector3();

    const _tempVec1 = new v3d.Vector3();
    ...
    class LDrawLoader extends v3d.Loader {
        ...
        constructor(manager) {
            ...
            this.parseScopesStack = null; // Array of v3d.Material

            this.materials = []; // Not using v3d.Cache here because it returns the previous HTML error response instead of calling onError()
        ...
        load(url, onLoad, onProgress, onError) {
            ...
            const scope = this;
            const fileLoader = new v3d.FileLoader(this.manager);
        ...
        parseColourMetaDirective(lineParser) {
            ...
            switch (finishType) {
                ...
                case FINISH_TYPE_PEARLESCENT:
                    ...
                    const specular = new v3d.Color(colour);
            ...
            if (!edgeMaterial) {
                ...
                edgeMaterial.userData.conditionalEdgeMaterial = new v3d.ShaderMaterial({
                    ...
                    uniforms: v3d.UniformsUtils.merge([v3d.UniformsLib.fog, {
                        diffuse: {
        ...
        objectParse(text) {
            ...
            function parseVector(lp) {
                ...
                const v = new v3d.Vector3(parseFloat(lp.getToken()), parseFloat(lp.getToken()), parseFloat(lp.getToken()));
            ...
            for (let lineIndex = 0; lineIndex < numLines; lineIndex ++) {
                ...
                switch (lineType) {
                    ...
                    case '1':
                        ...
                        const matrix = new v3d.Matrix4().set(m0, m1, m2, posX, m3, m4, m5, posY, m6, m7, m8, posZ, 0, 0, 0, 1);
                    ...
                    case '3':
                        ...
                        faceNormal = new v3d.Vector3().crossVectors(_tempVec0, _tempVec1).normalize();
                        triangles.push({
                            material: material,
                            colourCode: material.userData.code,
                            v0: v0,
        ...
        computeConstructionSteps(model) {
            ...
            // Sets userdata.constructionStep number in v3d.Group objects and userData.numConstructionSteps number in the root v3d.Group object.
            let stepNumber = 0;
            model.traverse(c => {
        ...
        processObject(text, onProcessed, subobject, url) {
            ...
            function loadSubobject(subobject) {
                ...
                const fileLoader = new v3d.FileLoader(scope.manager);
