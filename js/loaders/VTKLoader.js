...
v3d.VTKLoader.prototype = Object.assign(Object.create(v3d.Loader.prototype), {

    constructor: v3d.VTKLoader,
    ...
    parse: function(data) {
        ...
        function parseASCII(data) {
            ...
            if (colors.length !== indices.length) {
                ...
                if (colors.length === (numTriangles * 3)) {
                    ...
                    geometry.setAttribute('color', new v3d.Float32BufferAttribute(newColors, 3));
        ...
        function parseBinary(data) {
            ...
            geometry.setAttribute('position', new v3d.BufferAttribute(points, 3));
