...
if (v3d.LoaderSupport === undefined) { v3d.LoaderSupport = {} }

/**
 * Validation functions.
 * @class
 */
v3d.LoaderSupport.Validator = {
    /**
 ...
 * @class
 */
v3d.LoaderSupport.Callbacks = function() {
...
v3d.LoaderSupport.Callbacks.prototype = {

    constructor: v3d.LoaderSupport.Callbacks,
    ...
    setCallbackOnProgress: function(callbackOnProgress) {
        this.onProgress = v3d.LoaderSupport.Validator.verifyInput(callbackOnProgress, this.onProgress);
    },
    ...
    setCallbackOnReportError: function(callbackOnReportError) {
        this.onReportError = v3d.LoaderSupport.Validator.verifyInput(callbackOnReportError, this.onReportError);
    },

    /**
     * Register callback function that is called every time a mesh was loaded.
     * Use {@link v3d.LoaderSupport.LoadedMeshUserOverride} for alteration instructions (geometry, material or disregard mesh).
     *
    ...
    setCallbackOnMeshAlter: function(callbackOnMeshAlter) {
        this.onMeshAlter = v3d.LoaderSupport.Validator.verifyInput(callbackOnMeshAlter, this.onMeshAlter);
    },
    ...
    setCallbackOnLoad: function(callbackOnLoad) {
        this.onLoad = v3d.LoaderSupport.Validator.verifyInput(callbackOnLoad, this.onLoad);
    },
    ...
    setCallbackOnLoadMaterials: function(callbackOnLoadMaterials) {
        this.onLoadMaterials = v3d.LoaderSupport.Validator.verifyInput(callbackOnLoadMaterials, this.onLoadMaterials);
    }
 ...
 */
v3d.LoaderSupport.LoadedMeshUserOverride = function(disregardMesh, alteredMesh) {
    this.disregardMesh = disregardMesh === true;
    this.alteredMesh = alteredMesh === true;
    this.meshes = [];
};

v3d.LoaderSupport.LoadedMeshUserOverride.prototype = {

    constructor: v3d.LoaderSupport.LoadedMeshUserOverride,
...
/**
 * A resource description used by {@link v3d.LoaderSupport.PrepData} and others.
 * @class
 *
 * @param {string} url URL to the file
 * @param {string} extension The file extension (type)
 */
v3d.LoaderSupport.ResourceDescriptor = function(url, extension) {
    ...
    if (urlParts.length >= 2) {
        ...
        this.path = v3d.LoaderSupport.Validator.verifyInput(urlParts.slice(0, urlParts.length - 1).join('/') + '/', this.path);
        this.name = urlParts[urlParts.length - 1];
        this.url = url;

    }
    this.name = v3d.LoaderSupport.Validator.verifyInput(this.name, 'Unnamed_Resource');
    this.extension = v3d.LoaderSupport.Validator.verifyInput(extension, 'default');
    this.extension = this.extension.trim();
    this.content = null;
};

v3d.LoaderSupport.ResourceDescriptor.prototype = {

    constructor: v3d.LoaderSupport.ResourceDescriptor,
    ...
    setContent: function(content) {
        this.content = v3d.LoaderSupport.Validator.verifyInput(content, null);
    },
    ...
    setResourcePath: function(resourcePath) {
        this.resourcePath = v3d.LoaderSupport.Validator.verifyInput(resourcePath, this.resourcePath);
    }
};
 ...
 * @class
 */
v3d.LoaderSupport.PrepData = function(modelName) {
    this.logging = {
        enabled: true,
        debug: false
    };
    this.modelName = v3d.LoaderSupport.Validator.verifyInput(modelName, '');
    this.resources = [];
    this.callbacks = new v3d.LoaderSupport.Callbacks();
};

v3d.LoaderSupport.PrepData.prototype = {

    constructor: v3d.LoaderSupport.PrepData,
    ...
    /**
     * Returns all callbacks as {@link v3d.LoaderSupport.Callbacks}
     *
     * @returns {v3d.LoaderSupport.Callbacks}
     */
     ...
     *
     * @param {v3d.LoaderSupport.ResourceDescriptor} Adds a {@link v3d.LoaderSupport.ResourceDescriptor}
     */
     ...
     *
     * @returns {@link v3d.LoaderSupport.PrepData}
     */
    clone: function() {
        var clone = new v3d.LoaderSupport.PrepData(this.modelName);
    ...
    /**
     * Identify files or content of interest from an Array of {@link v3d.LoaderSupport.ResourceDescriptor}.
     *
     * @param {v3d.LoaderSupport.ResourceDescriptor[]} resources Array of {@link v3d.LoaderSupport.ResourceDescriptor}
     * @param Object fileDesc Object describing which resources are of interest (ext, type (string or UInt8Array) and ignore (boolean))
     * @returns {{}} Object with each "ext" and the corresponding {@link v3d.LoaderSupport.ResourceDescriptor}
     */
    checkResourceDescriptorFiles: function(resources, fileDesc) {
        ...
        for (var index in resources) {
            ...
            found = false;
            if (!v3d.LoaderSupport.Validator.isValid(resource.name)) continue;
            if (v3d.LoaderSupport.Validator.isValid(resource.content)) {
...
/**
 * Builds one or many v3d.Mesh from one raw set of Arraybuffers, materialGroup descriptions and further parameters.
 * Supports vertex, vertexColor, normal, uv and index buffers.
 * @class
 */
v3d.LoaderSupport.MeshBuilder = function() {
    console.info('Using v3d.LoaderSupport.MeshBuilder version: ' + v3d.LoaderSupport.MeshBuilder.LOADER_MESH_BUILDER_VERSION);
    this.validator = v3d.LoaderSupport.Validator;
...
v3d.LoaderSupport.MeshBuilder.LOADER_MESH_BUILDER_VERSION = '1.3.0';

v3d.LoaderSupport.MeshBuilder.prototype = {

    constructor: v3d.LoaderSupport.MeshBuilder,
     ...
     */
    init: function() {
        var defaultMaterial = new v3d.MeshStandardMaterial({ color: 0xDCF1FF });
        defaultMaterial.name = 'defaultMaterial';

        var defaultVertexColorMaterial = new v3d.MeshStandardMaterial({ color: 0xDCF1FF });
        defaultVertexColorMaterial.name = 'defaultVertexColorMaterial';
        defaultVertexColorMaterial.vertexColors = v3d.VertexColors;

        var defaultLineMaterial = new v3d.LineBasicMaterial();
        defaultLineMaterial.name = 'defaultLineMaterial';

        var defaultPointMaterial = new v3d.PointsMaterial({ size: 1 });
    ...
    /**
     * Set materials loaded by any supplier of an Array of {@link v3d.Material}.
     *
     * @param {v3d.Material[]} materials Array of {@link v3d.Material}
     */
     ...
     * @returns {v3d.Mesh[]} mesh Array of {@link v3d.Mesh} or null in case of material update
     */
     ...
     * @returns {v3d.Mesh[]} mesh Array of {@link v3d.Mesh}
     */
    buildMeshes: function(meshPayload) {
        var meshName = meshPayload.params.meshName;

        var bufferGeometry = new v3d.BufferGeometry();
        bufferGeometry.addAttribute('position', new v3d.BufferAttribute(new Float32Array(meshPayload.buffers.vertices), 3));
        if (this.validator.isValid(meshPayload.buffers.indices)) {

            bufferGeometry.setIndex(new v3d.BufferAttribute(new Uint32Array(meshPayload.buffers.indices), 1));

        }
        var haveVertexColors = this.validator.isValid(meshPayload.buffers.colors);
        if (haveVertexColors) {

            bufferGeometry.addAttribute('color', new v3d.BufferAttribute(new Float32Array(meshPayload.buffers.colors), 3));

        }
        if (this.validator.isValid(meshPayload.buffers.normals)) {

            bufferGeometry.addAttribute('normal', new v3d.BufferAttribute(new Float32Array(meshPayload.buffers.normals), 3));
        ...
        if (this.validator.isValid(meshPayload.buffers.uvs)) {
            ...
            bufferGeometry.addAttribute('uv', new v3d.BufferAttribute(new Float32Array(meshPayload.buffers.uvs), 2));
        ...
        if (useOrgMesh) {
            ...
            if (geometryType === 0) {
                ...
                mesh = new v3d.Mesh(bufferGeometry, material);

            } else if (geometryType === 1) {

                mesh = new v3d.LineSegments(bufferGeometry, material);

            } else {

                mesh = new v3d.Points(bufferGeometry, material);
     ...
     *
     * @returns {Object} Map of {@link v3d.Material}
     */
 ...
 * @class
 */
v3d.LoaderSupport.WorkerSupport = function() {
    console.info('Using v3d.LoaderSupport.WorkerSupport version: ' + v3d.LoaderSupport.WorkerSupport.WORKER_SUPPORT_VERSION);
    this.logging = {
        enabled: true,
        debug: false
    };
    ...
    this.loaderWorker = typeof window !== "undefined" ? new v3d.LoaderSupport.WorkerSupport.LoaderWorker() : new v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker();
};

v3d.LoaderSupport.WorkerSupport.WORKER_SUPPORT_VERSION = '2.3.0';

v3d.LoaderSupport.WorkerSupport.prototype = {

    constructor: v3d.LoaderSupport.WorkerSupport,
     ...
     * @param {v3d.LoaderSupport.WorkerRunnerRefImpl} runnerImpl The default worker parser wrapper implementation (communication and execution). An extended class could be passed here.
     */
    validate: function(functionCodeBuilder, parserName, libLocations, libPath, runnerImpl) {
        if (v3d.LoaderSupport.Validator.isValid(this.loaderWorker.worker)) return;
        ...
        if (v3d.LoaderSupport.Validator.isValid(runnerImpl)) {
        ...
        // Browser implementation
            ...
            runnerImpl = v3d.LoaderSupport.WorkerRunnerRefImpl;
            if (this.logging.enabled) console.info('WorkerSupport: Using DEFAULT "v3d.LoaderSupport.WorkerRunnerRefImpl" as Runner class for worker.');

        // NodeJS implementation
        } else {

            runnerImpl = v3d.LoaderSupport.NodeWorkerRunnerRefImpl;
            if (this.logging.enabled) console.info('WorkerSupport: Using DEFAULT "v3d.LoaderSupport.NodeWorkerRunnerRefImpl" as Runner class for worker.');

        }
        var userWorkerCode = functionCodeBuilder(v3d.LoaderSupport.WorkerSupport.CodeSerializer);
        userWorkerCode += 'var Parser = '+ parserName +  ';\n\n';
        userWorkerCode += v3d.LoaderSupport.WorkerSupport.CodeSerializer.serializeClass(runnerImpl.runnerName, runnerImpl);
        userWorkerCode += 'new ' + runnerImpl.runnerName + '();\n\n';

        var scope = this;
        if (v3d.LoaderSupport.Validator.isValid(libLocations) && libLocations.length > 0) {
     ...
     *
     * @param {Function} meshBuilder The mesh builder function. Default is {@link v3d.LoaderSupport.MeshBuilder}.
...
v3d.LoaderSupport.WorkerSupport.LoaderWorker = function() {
    this._reset();
};

v3d.LoaderSupport.WorkerSupport.LoaderWorker.prototype = {

    constructor: v3d.LoaderSupport.WorkerSupport.LoaderWorker,
    ...
    setCallbacks: function(meshBuilder, onLoad) {
        this.callbacks.meshBuilder = v3d.LoaderSupport.Validator.verifyInput(meshBuilder, this.callbacks.meshBuilder);
        this.callbacks.onLoad = v3d.LoaderSupport.Validator.verifyInput(onLoad, this.callbacks.onLoad);
    },

    run: function(payload) {
        if (v3d.LoaderSupport.Validator.isValid(this.queuedMessage)) {
        ...
        if (!v3d.LoaderSupport.Validator.isValid(this.callbacks.meshBuilder)) throw 'Unable to run as no "MeshBuilder" callback is set.';
        if (!v3d.LoaderSupport.Validator.isValid(this.callbacks.onLoad)) throw 'Unable to run as no "onLoad" callback is set.';
        if (payload.cmd !== 'run') payload.cmd = 'run';
        if (v3d.LoaderSupport.Validator.isValid(payload.logging)) {
    ...
    _postMessage: function() {
        if (v3d.LoaderSupport.Validator.isValid(this.queuedMessage) && v3d.LoaderSupport.Validator.isValid(this.worker)) {
    ...
    setTerminateRequested: function(terminateRequested) {
        ...
        if (this.terminateRequested && v3d.LoaderSupport.Validator.isValid(this.worker) && ! v3d.LoaderSupport.Validator.isValid(this.queuedMessage) && this.started) {
...
v3d.LoaderSupport.WorkerSupport.CodeSerializer = {
 ...
 * @class
 */
v3d.LoaderSupport.WorkerRunnerRefImpl = function() {
...
v3d.LoaderSupport.WorkerRunnerRefImpl.runnerName = 'v3d.LoaderSupport.WorkerRunnerRefImpl';

v3d.LoaderSupport.WorkerRunnerRefImpl.prototype = {

    constructor: v3d.LoaderSupport.WorkerRunnerRefImpl,
 ...
 * @class
 * @extends v3d.LoaderSupport.WorkerRunnerRefImpl
 */
v3d.LoaderSupport.NodeWorkerRunnerRefImpl = function() {
    this.runnerName = 'v3d.LoaderSupport.NodeWorkerRunnerRefImpl';
...
v3d.LoaderSupport.NodeWorkerRunnerRefImpl.prototype = Object.create(v3d.LoaderSupport.WorkerRunnerRefImpl.prototype);
v3d.LoaderSupport.NodeWorkerRunnerRefImpl.prototype.constructor = v3d.LoaderSupport.NodeWorkerRunnerRefImpl;
v3d.LoaderSupport.NodeWorkerRunnerRefImpl.runnerName = 'v3d.LoaderSupport.NodeWorkerRunnerRefImpl';

v3d.LoaderSupport.NodeWorkerRunnerRefImpl.prototype = {
 ...
 */
v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker = function(){
    v3d.LoaderSupport.WorkerSupport.LoaderWorker.call(this);
};

v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker.prototype = Object.create(v3d.LoaderSupport.WorkerSupport.LoaderWorker.prototype);
v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker.prototype.constructor = v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker;

/**
 * @inheritdoc
  */
v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker.checkSupport = function() {
    try {
        // Work around webpack builds failing with NodeJS requires
        var _require = eval('require');
 ...
 * @inheritdoc
 */
v3d.LoaderSupport.WorkerSupport.NodeLoaderWorker.prototype.initWorker = function(code, runnerImplName) {
    var supportError = this.checkSupport();
    if(supportError) {
 ...
 */
v3d.LoaderSupport.WorkerDirector = function(classDef) {
    console.info('Using v3d.LoaderSupport.WorkerDirector version: ' + v3d.LoaderSupport.WorkerDirector.LOADER_WORKER_DIRECTOR_VERSION);
    this.logging = {
        enabled: true,
        debug: false
    };

    this.maxQueueSize = v3d.LoaderSupport.WorkerDirector.MAX_QUEUE_SIZE ;
    this.maxWebWorkers = v3d.LoaderSupport.WorkerDirector.MAX_WEB_WORKER;
    this.crossOrigin = null;

    if (!v3d.LoaderSupport.Validator.isValid(classDef)) throw 'Provided invalid classDef: ' + classDef;
...
v3d.LoaderSupport.WorkerDirector.LOADER_WORKER_DIRECTOR_VERSION = '2.3.0';
v3d.LoaderSupport.WorkerDirector.MAX_WEB_WORKER = 16;
v3d.LoaderSupport.WorkerDirector.MAX_QUEUE_SIZE = 2048;

v3d.LoaderSupport.WorkerDirector.prototype = {

    constructor: v3d.LoaderSupport.WorkerDirector,
    /**
     * Enable or disable logging in general (except warn and error), plus enable or disable debug logging.
     *
     * @param {boolean} enabled True or false.
     ...
     *
     * @param {v3d.OBJLoader2.WWOBJLoader2.PrepDataCallbacks} globalCallbacks  Register global callbacks used by all web workers
     * @param {number} maxQueueSize Set the maximum size of the instruction queue (1-1024)
     * @param {number} maxWebWorkers Set the maximum amount of workers (1-16)
     */
    prepareWorkers: function(globalCallbacks, maxQueueSize, maxWebWorkers) {
        if (v3d.LoaderSupport.Validator.isValid(globalCallbacks)) this.workerDescription.globalCallbacks = globalCallbacks;
        this.maxQueueSize = Math.min(maxQueueSize, v3d.LoaderSupport.WorkerDirector.MAX_QUEUE_SIZE);
        this.maxWebWorkers = Math.min(maxWebWorkers, v3d.LoaderSupport.WorkerDirector.MAX_WEB_WORKER);
        ...
        for (var instanceNo = 0; instanceNo < this.maxWebWorkers; instanceNo++) {
            ...
            var workerSupport = new v3d.LoaderSupport.WorkerSupport();
     ...
     *
     * @param {v3d.LoaderSupport.PrepData} prepData
     */
    ...
    _kickWorkerRun: function(prepData, supportDesc) {
        ...
        var validator = v3d.LoaderSupport.Validator;
        var scope = this;
        ...
        var updatedCallbacks = new v3d.LoaderSupport.Callbacks();
    ...
    _buildLoader: function(instanceNo) {
        ...
        classDef.call(loader, v3d.DefaultLoadingManager);
        ...
        if (!loader.hasOwnProperty('callbacks') || ! v3d.LoaderSupport.Validator.isValid(loader.callbacks)) {

            console.warn(classDef.name + ' has an invalid property "callbacks". Will change to "v3d.LoaderSupport.Callbacks"');
            loader.callbacks = new v3d.LoaderSupport.Callbacks();
    ...
    _deregister: function(supportDesc) {
        if (v3d.LoaderSupport.Validator.isValid(supportDesc)) {
            ...
            if (v3d.LoaderSupport.Validator.isValid(loaderCallbacks.onProgress)) loaderCallbacks.onProgress({ detail: { text: '' } });
    ...
    tearDown: function(callbackOnFinishedProcessing) {
        ...
        this.callbackOnFinishedProcessing = v3d.LoaderSupport.Validator.verifyInput(callbackOnFinishedProcessing, null);
