 ...
 */
v3d.LoaderSupport.ConsoleLogger = (function() {
     ...
     * @memberOf v3d.LoaderSupport.ConsoleLogger
     *
...
v3d.LoaderSupport.Callbacks = (function() {
     ...
     * @memberOf v3d.LoaderSupport.Callbacks
     *
 ...
 * @class
 */
v3d.LoaderSupport.Builder = (function() {
    ...
    Builder.prototype._createDefaultMaterials = function() {
        ...
        var vertexColorMaterial = new v3d.MeshStandardMaterial({ color: 0xDCF1FF });
        vertexColorMaterial.name = 'vertexColorMaterial';
        vertexColorMaterial.vertexColors = v3d.VertexColors;
     ...
     * @memberOf v3d.LoaderSupport.Builder
     *
    ...
    Builder.prototype.buildMeshes = function(payload) {
        ...
        bufferGeometry.addAttribute('position', new v3d.BufferAttribute(new Float32Array(payload.buffers.vertices), 3));
        if (Validator.isValid(payload.buffers.indices)) {

            bufferGeometry.setIndex(new v3d.BufferAttribute(new Uint32Array(payload.buffers.indices), 1));

        }
        var haveVertexColors = Validator.isValid(payload.buffers.colors);
        if (haveVertexColors) {

            bufferGeometry.addAttribute('color', new v3d.BufferAttribute(new Float32Array(payload.buffers.colors), 3));

        }
        if (Validator.isValid(payload.buffers.normals)) {

            bufferGeometry.addAttribute('normal', new v3d.BufferAttribute(new Float32Array(payload.buffers.normals), 3));
        ...
        if (Validator.isValid(payload.buffers.uvs)) {
            ...
            bufferGeometry.addAttribute('uv', new v3d.BufferAttribute(new Float32Array(payload.buffers.uvs), 2));
            ...
            if (haveVertexColors) {
                ...
                if (material.hasOwnProperty('vertexColors')) {
                    ...
                    if (! Validator.isValid(materialClone)) {
                        ...
                        materialClone.vertexColors = v3d.VertexColors;
 ...
 * @class
 *
 * @param {v3d.LoaderSupport.ConsoleLogger} logger logger to be used
 ...
 */
v3d.LoaderSupport.Commons = (function() {

    var Validator = v3d.LoaderSupport.Validator;
    var ConsoleLogger = v3d.LoaderSupport.ConsoleLogger;

    function Commons(logger, manager) {
        this.logger = Validator.verifyInput(logger, new ConsoleLogger());
        this.manager = Validator.verifyInput(manager, v3d.DefaultLoadingManager);
        ...
        this.builder = new v3d.LoaderSupport.Builder();
        this.callbacks = new v3d.LoaderSupport.Callbacks();
    };
     ...
     *
     * @returns {v3d.LoaderSupport.ConsoleLogger}
     */
     ...
     * @memberOf v3d.LoaderSupport.Commons
     *
 ...
 */
v3d.LoaderSupport.LoadedMeshUserOverride = (function() {
     ...
     *
     * @memberOf v3d.OBJLoader2.LoadedMeshUserOverride
     *
     * @param {v3d.Mesh} mesh
     */
 ...
 */
v3d.LoaderSupport.ResourceDescriptor = (function() {
     ...
     * @memberOf v3d.LoaderSupport.ResourceDescriptor
     *
 ...
 * @class
 */
v3d.LoaderSupport.PrepData = (function() {
    ...
    /**
     * Set the node where the loaded objects will be attached directly.
     * @memberOf v3d.LoaderSupport.PrepData
     *
     * @param {v3d.Object3D} streamMeshesTo Object already attached to scenegraph where new meshes will be attached to
     */
     ...
     * @memberOf v3d.LoaderSupport.PrepData
     *
     * @param {v3d.LoaderSupport.ResourceDescriptor}
     */
...
v3d.LoaderSupport.WorkerRunnerRefImpl = (function() {
     ...
     * @memberOf v3d.LoaderSupport.WorkerRunnerRefImpl
     *
...
v3d.LoaderSupport.WorkerSupport = (function() {
    ...
    function WorkerSupport(logger) {
        this.logger = Validator.verifyInput(logger, new v3d.LoaderSupport.ConsoleLogger());
        this.logger.logInfo('Using v3d.LoaderSupport.WorkerSupport version: ' + WORKER_SUPPORT_VERSION);
     ...
     * @memberOf v3d.LoaderSupport.WorkerSupport
     *
    ...
    WorkerSupport.prototype.validate = function(functionCodeBuilder, forceWorkerReload, runnerImpl) {
        ...
        if (! Validator.isValid(this.worker)) {
            ...
            if (Validator.isValid(runnerImpl)) {
                ...
                this.logger.logInfo('WorkerSupport: Using DEFAULT "v3d.LoaderSupport.WorkerRunnerRefImpl" as Runncer class for worker.');
                workerRunner = v3d.LoaderSupport.WorkerRunnerRefImpl;
     ...
     * @memberOf v3d.LoaderSupport.WorkerSupport
     *
     * @param {Function} builder The builder function. Default is {@link v3d.LoaderSupport.Builder}.
 ...
 * @param {v3d.LoaderSupport.ConsoleLogger} logger logger to be used
 */
v3d.LoaderSupport.WorkerDirector = (function() {
    ...
    function WorkerDirector(classDef, logger) {
        this.logger = Validator.verifyInput(logger, new v3d.LoaderSupport.ConsoleLogger());
        this.logger.logInfo('Using v3d.LoaderSupport.WorkerDirector version: ' + LOADER_WORKER_DIRECTOR_VERSION);
     ...
     * @memberOf v3d.LoaderSupport.WorkerDirector
     *
     * @returns {number}
     */
        ...
        if (start < this.maxWebWorkers) {
            ...
            for (i = start; i < this.maxWebWorkers; i++) {
                ...
                this.workerDescription.workerSupports[i] = {
                    workerSupport: new v3d.LoaderSupport.WorkerSupport(this.logger),
                    loader: null
                };
    ...
    WorkerDirector.prototype._buildLoader = function(instanceNo) {
        ...
        } else if (! classDef.workerSupport instanceof v3d.LoaderSupport.WorkerSupport) {

            throw classDef.name + '.workerSupport is not of type "v3d.LoaderSupport.WorkerSupport".';
