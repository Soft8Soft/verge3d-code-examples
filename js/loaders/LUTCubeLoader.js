(function() {
    ...
    class LUTCubeLoader extends v3d.Loader {
        ...
        parse(str) {
            ...
            let title = null;
            let size = null;
            const domainMin = new v3d.Vector3(0, 0, 0);
            const domainMax = new v3d.Vector3(1, 1, 1);
            ...
            const texture3D = new v3d.DataTexture3D();
            texture3D.image.data = data;
            texture3D.image.width = size;
            texture3D.image.height = size;
            texture3D.image.depth = size;
            texture3D.format = v3d.RGBFormat;
            texture3D.type = v3d.UnsignedByteType;
            texture3D.magFilter = v3d.LinearFilter;
            texture3D.minFilter = v3d.LinearFilter;
            texture3D.wrapS = v3d.ClampToEdgeWrapping;
            texture3D.wrapT = v3d.ClampToEdgeWrapping;
            texture3D.wrapR = v3d.ClampToEdgeWrapping;
    ...
    v3d.LUTCubeLoader = LUTCubeLoader;
