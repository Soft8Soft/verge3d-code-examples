...
v3d.DRACOLoader = function(dracoPath, dracoDecoderType, manager) {
    this.timeLoaded = 0;
    this.manager = (manager !== undefined) ? manager :
        v3d.DefaultLoadingManager;
    this.materials = null;
    this.verbosity = 0;
    ...
    if (typeof DracoDecoderModule === 'undefined') {
      v3d.DRACOLoader.loadDracoDecoder(this);
    }
};
...
v3d.DRACOLoader.prototype = {
    ...
    decodeDracoFile: function(rawBuffer, callback) {
      var scope = this;
      v3d.DRACOLoader.getDecoder(this,
    ...
    convertDracoGeometryTo3JS: function(dracoDecoder, decoder, geometryType,
        ...
        geometry.addAttribute('position',
            new v3d.Float32BufferAttribute(geometryBuffer.vertices, 3));
        ...
        geometry.addAttribute('color',
            new v3d.Float32BufferAttribute(geometryBuffer.colors,
                                             numColorCoordinateComponents));
        if (normalAttId != -1) {
          geometry.addAttribute('normal',
              new v3d.Float32BufferAttribute(geometryBuffer.normals, 3));
        }
        if (texCoordAttId != -1) {
          geometry.addAttribute('uv',
              new v3d.Float32BufferAttribute(geometryBuffer.uvs, 2));
        }
...
v3d.DRACOLoader.loadJavaScriptFile = function(path, onLoadFunc,
    dracoDecoder) {
...
v3d.DRACOLoader.loadWebAssemblyDecoder = function(dracoDecoder) {
...
v3d.DRACOLoader.loadDracoDecoder = function(dracoDecoder) {
  if (typeof WebAssembly !== 'object' ||
      dracoDecoder.dracoDecoderType.type === 'js') {
    // No WebAssembly support
    v3d.DRACOLoader.loadJavaScriptFile(dracoDecoder.dracoSrcPath +
        'draco_decoder.js', null, dracoDecoder);
  } else {
    v3d.DRACOLoader.loadJavaScriptFile(dracoDecoder.dracoSrcPath +
        'draco_wasm_wrapper.js',
        function(dracoDecoder) {
          v3d.DRACOLoader.loadWebAssemblyDecoder(dracoDecoder);
        }, dracoDecoder);
  }
}
 ...
 */
v3d.DRACOLoader.getDecoder = (function() {
    var decoder;
        ...
        if (typeof decoder !== 'undefined') {
          ...
          if (typeof DracoDecoderModule === 'undefined') {
            ...
            if (dracoDecoder.timeLoaded > 0) {
              ...
              if (waitMs > 5000) {
                throw new Error(
                    'v3d.DRACOLoader: DracoDecoderModule not found.');
              }
            }
          } else {
          ...
          setTimeout(function() {
            v3d.DRACOLoader.getDecoder(dracoDecoder,
                onDracoDecoderModuleLoadedCallback);
          }, 10);
        }
    };
