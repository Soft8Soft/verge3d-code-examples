...
(function(global, factory) {
    ...
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
        typeof define === 'function' && define.amd ? define(factory) :
            (global.v3d = global.v3d || {}, global.v3d.XLoader = factory());
    ...
    var XLoader = function() {
        ...
        function XLoader(manager) {
            ...
            this.debug = false;
            this.manager = manager !== undefined ? manager : new v3d.DefaultLoadingManager();
            this.texloader = new v3d.TextureLoader(this.manager);
            this.url = "";
        ...
        createClass(XLoader, [{
            ...
            value: function ensureString(buf) {
                ...
                if (typeof buf !== "string") {
                    ...
                    return v3d.LoaderUtils.decodeText(new Uint8Array(buf));
            ...
            value: function _parseBinary(data) {
                ...
                return this._parseASCII(v3d.LoaderUtils.decodeText(new Uint8Array(data)));
            ...
            value: function _parseASCII() {
                ...
                if (this.resourcePath !== undefined) {
                    ...
                    path = v3d.LoaderUtils.extractUrlBase(this.url);
            ...
            value: function _setFrameTransformMatrix() {
                ...
                this._currentFrame.FrameTransformMatrix = new v3d.Matrix4();
            ...
            value: function _buildGeometry() {
                ...
                bufferGeometry.addAttribute('position', new v3d.Float32BufferAttribute(position, 3));
                bufferGeometry.addAttribute('normal', new v3d.Float32BufferAttribute(normals, 3));
                bufferGeometry.addAttribute('uv', new v3d.Float32BufferAttribute(uvs, 2));
                bufferGeometry.addAttribute('skinIndex', new v3d.Uint16BufferAttribute(skinIndices, 4));
                bufferGeometry.addAttribute('skinWeight', new v3d.Float32BufferAttribute(skinWeights, 4));
            ...
            value: function _setMaterial() {
                ...
                var _nowMat = new v3d.MeshPhongMaterial({
                    color: Math.random() * 0xffffff
                });
                _nowMat.side = v3d.FrontSide;
                    ...
                    if (this._currentObject.children.length > 0) {
                        ...
                        switch (localObject.type) {
                            ...
                            case "NormalMapFilename":
                                ...
                                _nowMat.normalScale = new v3d.Vector2(2, 2);
                                break;
            ...
            value: function _setSkinWeights() {
                ...
                line = this._currentObject.data.substr(endRead, find - endRead);
                var data3 = this._readLine(line.trim()).split(",");
                boneInf.OffsetMatrix = new v3d.Matrix4();
            ...
            value: function _makePutBoneList(_RootName, _bones) {
                ...
                for (var frame in this.HieStack) {
                    ...
                    if (this.HieStack[frame].name === _RootName || putting) {
                        ...
                        b.pos = new v3d.Vector3().setFromMatrixPosition(b.FrameTransformMatrix).toArray();
                        b.rotq = new v3d.Quaternion().setFromRotationMatrix(b.FrameTransformMatrix).toArray();
                        b.scl = new v3d.Vector3().setFromMatrixScale(b.FrameTransformMatrix).toArray();
                ...
                if (this._currentGeo.BoneInfs.length > 0) {
                    ...
                    for (var bi = 0; bi < this._currentGeo.BoneInfs.length; bi++) {
                        ...
                        for (var bb = 0; bb < putBones.length; bb ++) {
                            ...
                            if (putBones[bb].name === this._currentGeo.BoneInfs[bi].boneName) {
                                ...
                                boneIndex = bb;
                                putBones[bb].OffsetMatrix = new v3d.Matrix4();
                    ...
                    for (var _bi = 0; _bi < putBones.length; _bi++) {
                        ...
                        if (putBones[_bi].OffsetMatrix) {
                            ...
                            offsetList.push(new v3d.Matrix4());
                    ...
                    mesh = new v3d.SkinnedMesh(bufferGeometry, this._currentGeo.Materials.length === 1 ? this._currentGeo.Materials[0] : this._currentGeo.Materials);
                    ...
                    mesh = new v3d.Mesh(_bufferGeometry, this._currentGeo.Materials.length === 1 ? this._currentGeo.Materials[0] : this._currentGeo.Materials);

                }
                mesh.name = this._currentGeo.name;
                var worldBaseMx = new v3d.Matrix4();
            ...
            value: function _initSkeleton(mesh, boneList, boneInverses) {
                ...
                var skeleton = new v3d.Skeleton(bones, boneInverses);
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (nowKeyType != 4) {
                        ...
                        switch (nowKeyType) {
                            ...
                            case 0:
                                keyInfo.rot = new v3d.Quaternion(parseFloat(frameValue[1]), parseFloat(frameValue[2]), parseFloat(frameValue[3]), parseFloat(frameValue[0]) * - 1);
                                break;
                            case 1:
                                keyInfo.scl = new v3d.Vector3(parseFloat(frameValue[0]), parseFloat(frameValue[1]), parseFloat(frameValue[2]));
                                break;
                            case 2:
                                keyInfo.pos = new v3d.Vector3(parseFloat(frameValue[0]), parseFloat(frameValue[1]), parseFloat(frameValue[2]));
                                break;
                        ...
                        keyInfo.matrix = new v3d.Matrix4();
            ...
            value: function assignAnimation(_model, _animation, _isBind) {
                ...
                model.geometry.animations.push(v3d.AnimationClip.parseAnimation(put, model.skeleton.bones));
                if (!model.animationMixer) {

                    model.animationMixer = new v3d.AnimationMixer(model);
