(function() {
    ...
    class PCDLoader extends v3d.Loader {
        ...
        parse(data, url) {
            ...
            const textData = v3d.LoaderUtils.decodeText(new Uint8Array(data)); // parse header (always ascii format)
