...
v3d.NodeMaterialLoader = function(manager, library) {
...
Object.assign(v3d.NodeMaterialLoader.prototype, {
    ...
    declare: function(json) {
        ...
        for (uuid in json.nodes) {
            ...
            object = new v3d[node.nodeType + "Node"]();
