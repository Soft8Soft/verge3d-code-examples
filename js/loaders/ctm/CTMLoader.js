...
v3d.CTMLoader.prototype.loadParts = function(url, callback, parameters) {
...
v3d.CTMLoader.prototype.load = function(url, callback, parameters) {
...
v3d.CTMLoader.prototype.createModel = function(file, callback) {
    ...
    var Model = function() {
        ...
        this.addAttribute('position', new v3d.BufferAttribute(positions, 3));
        ...
        if (colors !== undefined) {
            ...
            this.addAttribute('color', new v3d.BufferAttribute(colors, 4));

        }

    };

    Model.prototype = Object.create(v3d.BufferGeometry.prototype);
