...
v3d.TDSLoader = function(manager) {
...
v3d.TDSLoader.prototype = {

    constructor: v3d.TDSLoader,
            ...
            if (next === POINT_ARRAY) {
                ...
                if (useBufferGeometry)    {
                    ...
                    for (var i = 0; i < points; i++)        {
                        ...
                        geometry.vertices.push(new v3d.Vector3(this.readFloat(data), this.readFloat(data), this.readFloat(data)));
                ...
                if (useBufferGeometry)    {
                    ...
                    geometry.addAttribute('uv', new v3d.BufferAttribute(new Float32Array(uvs), 2));
                    ...
                    for (var i = 0; i < texels; i++)        {
                        ...
                        uvs.push(new v3d.Vector2(this.readFloat(data), this.readFloat(data)));
    ...
    readFaceArray: function(data, mesh) {
        ...
        for (var i = 0; i < faces; ++ i) {
            ...
            mesh.geometry.faces.push(new v3d.Face3(this.readWord(data), this.readWord(data), this.readWord(data)));
