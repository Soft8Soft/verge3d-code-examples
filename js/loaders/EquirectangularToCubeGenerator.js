...
v3d.EquirectangularToCubeGenerator = function(sourceTexture, options) {
    ...
    this.camera = new v3d.PerspectiveCamera(90, 1, 0.1, 10);
    this.boxMesh = new v3d.Mesh(new v3d.BoxBufferGeometry(1, 1, 1), this.getShader());
    this.boxMesh.material.side = v3d.BackSide;
...
v3d.EquirectangularToCubeGenerator.prototype = {

    constructor: v3d.EquirectangularToCubeGenerator,
