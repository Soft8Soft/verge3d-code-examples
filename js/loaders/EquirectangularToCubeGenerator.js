...
v3d.CubemapGenerator = function(renderer) {

    this.renderer = renderer;

};

v3d.CubemapGenerator.prototype.fromEquirectangular = function(texture, options) {
    ...
    var mesh = new v3d.Mesh(new v3d.BoxBufferGeometry(5, 5, 5), material);
    ...
    var camera = new v3d.CubeCamera(1, 10, resolution, params);
...
v3d.EquirectangularToCubeGenerator = (function() {

    var camera = new v3d.PerspectiveCamera(90, 1, 0.1, 10);
    var scene = new v3d.Scene();
    var boxMesh = new v3d.Mesh(new v3d.BoxBufferGeometry(1, 1, 1), getShader());
    boxMesh.material.side = v3d.BackSide;
    scene.add(boxMesh);
    ...
    var EquirectangularToCubeGenerator = function(sourceTexture, options) {
        ...
        this.renderTarget = new v3d.WebGLRenderTargetCube(this.resolution, this.resolution, params);
