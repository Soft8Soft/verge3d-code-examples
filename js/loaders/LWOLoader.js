...
v3d.LWOLoader = (function() {
    ...
    MaterialParser.prototype = {
        ...
        parseMaterial(materialData, name, textures) {
            ...
            return new v3d['Mesh' + type + 'Material'](params);
        ...
        parseStandardAttributes(params, attributes, maps) {
            ...
            if (attributes.Luminous && attributes.Luminous.value !== 0 && attributes['Luminous Color']) {
                ...
                params.emissive = new v3d.Color().fromArray(emissiveColor);
        ...
        parsePhongAttributes(params, attributes, maps) {
            ...
            if (attributes.Luminosity && ! maps.emissiveMap) params.emissive = new v3d.Color().setScalar(attributes.Luminosity.value);

            if (attributes.Glossiness !== undefined) params.shininess = 5 + Math.pow(attributes.Glossiness.value * 7, 6);

            // parse specular if there is no roughness - we will interpret the material as 'Phong' in this case
            if (!attributes.Roughness && attributes.Specular && ! maps.specularMap) params.specular = new v3d.Color().setScalar(attributes.Specular.value * 1.5);
    ...
    GeometryParser.prototype = {
        ...
        parse(geoData, layer) {
            ...
            geometry.addAttribute('position', new v3d.Float32BufferAttribute(geoData.points, 3));
        ...
        parseUVs(geometry, layer) {
            ...
            geometry.addAttribute('uv', new v3d.Float32BufferAttribute(remappedUVs, 2));
