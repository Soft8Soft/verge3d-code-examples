...
function printBuffer(buffer, from, to) {
    ...
    console.log(v3d.LoaderUtils.decodeText(new Uint8Array(buffer, from, to)));

}

var lwoTree;

v3d.LWOLoader = function(manager, parameters) {
...
v3d.LWOLoader.prototype = Object.assign(Object.create(v3d.Loader.prototype), {

    constructor: v3d.LWOLoader,
...
LWOTreeParser.prototype = {
    ...
    parseMesh(geometry, layer) {
        ...
        if (layer.geometry.type === 'points') mesh = new v3d.Points(geometry, materials);
        else if (layer.geometry.type === 'lines') mesh = new v3d.LineSegments(geometry, materials);
        else mesh = new v3d.Mesh(geometry, materials);
...
MaterialParser.prototype = {
    ...
    getSide(attributes) {
        ...
        switch (attributes.side) {
            ...
            case 1:
                return v3d.BackSide;
            case 2: return v3d.FrontSide;
            case 3: return v3d.DoubleSide;
    ...
    parseStandardAttributes(params, attributes, maps) {
        ...
        if (attributes.Luminous) {
            ...
            if (attributes['Luminous Color'] && ! maps.emissive) {
                ...
                params.emissive = new v3d.Color().fromArray(attributes['Luminous Color'].value);
    ...
    parseEnvMap(connections, maps, attributes) {
        ...
        if (connections.envMap) {
            ...
            if (attributes.transparent && attributes.opacity < 0.999) {
                ...
                envMap.mapping = v3d.EquirectangularRefractionMapping;
    ...
    getWrappingType(num) {
        ...
        switch (num) {
            ...
            case 1: return v3d.RepeatWrapping;
            case 2: return v3d.MirroredRepeatWrapping;
            case 3: return v3d.ClampToEdgeWrapping;
