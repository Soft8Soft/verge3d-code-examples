...
v3d.HDRCubeTextureLoader.prototype.load = function(type, urls, onLoad, onProgress, onError) {
    ...
    texture.type = type;
    texture.encoding = (type === v3d.UnsignedByteType) ? v3d.RGBEEncoding : v3d.LinearEncoding;
    texture.format = (type === v3d.UnsignedByteType) ? v3d.RGBAFormat : v3d.RGBFormat;
    texture.minFilter = (texture.encoding === v3d.RGBEEncoding) ? v3d.NearestFilter : v3d.LinearFilter;
    texture.magFilter = (texture.encoding === v3d.RGBEEncoding) ? v3d.NearestFilter : v3d.LinearFilter;
    texture.generateMipmaps = (texture.encoding !== v3d.RGBEEncoding);
    ...
    function loadHDRData(i, onLoad, onProgress, onError) {
        ...
        loader.load(urls[i], function(buffer) {
            ...
            } else if (type === v3d.HalfFloatType) {
