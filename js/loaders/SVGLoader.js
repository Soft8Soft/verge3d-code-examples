(function() {
    ...
    class SVGLoader extends v3d.Loader {
        ...
        parse(text) {
            ...
            function parsePathNode(node) {
                ...
                const point = new v3d.Vector2();
                const control = new v3d.Vector2();
                const firstPoint = new v3d.Vector2();
                    ...
                    switch (type) {
                        ...
                        case 'z':
                            ...
                            if (path.currentPath.curves.length > 0) {
                                ...
                                // Reset point to beginning of v3d.Path
    ...
    */
            ...
            function parseNodeTransform(node) {
                ...
                const transform = new v3d.Matrix3();
            ...
            const tempTransform0 = new v3d.Matrix3();
            const tempTransform1 = new v3d.Matrix3();
            const tempTransform2 = new v3d.Matrix3();
            const tempTransform3 = new v3d.Matrix3();
            const tempV2 = new v3d.Vector2();
            const tempV3 = new v3d.Vector3();
            const currentTransform = new v3d.Matrix3();
        ...
        static createShapes(shapePath) {
                ...
                for (let index = 1; index < path1.length; index ++) {
                    ...
                    for (let index2 = 1; index2 < path2.length; index2 ++) {
                        ...
                        if (intersection !== null && intersectionsRaw.find(i => i.t <= intersection.t + Number.EPSILON && i.t >= intersection.t - Number.EPSILON) === undefined) {
                            ...
                            intersections.push(new v3d.Vector2(intersection.x, intersection.y));
            ...
            function isHoleTo(simplePath, allPaths, scanlineMinX, scanlineMaxX, _fillRule) {
                ...
                const centerBoundingBox = new v3d.Vector2();
                simplePath.boundingBox.getCenter(centerBoundingBox);
                const scanline = [new v3d.Vector2(scanlineMinX, centerBoundingBox.y), new v3d.Vector2(scanlineMaxX, centerBoundingBox.y)];
            ...
            let simplePaths = shapePath.subPaths.map(p => {
                ...
                return {
                    points: points,
                    isCW: v3d.ShapeUtils.isClockWise(points),
                    identifier: identifier ++,
                    boundingBox: new v3d.Box2(new v3d.Vector2(minX, minY), new v3d.Vector2(maxX, maxY))
                };
            ...
            simplePaths.forEach(p => {
                ...
                if (!amIAHole.isHole) {
                    ...
                    const shape = new v3d.Shape(p.points);
                    const holes = isAHole.filter(h => h.isHole && h.for === p.identifier);
                    holes.forEach(h => {

                        const path = simplePaths[h.identifier];
                        shape.holes.push(new v3d.Path(path.points));
        ...
        static getStrokeStyle(width, color, lineJoin, lineCap, miterLimit) {
            ...
            // Param color: As returned by v3d.Color.getStyle()
        ...
        static pointsToStroke(points, style, arcDivisions, minDistance) {
            ...
            // Returns v3d.BufferGeometry with stroke triangles (In plane z = 0). UV coordinates are generated ('u' along path. 'v' across it, from left to right)
            const vertices = [];
            const normals = [];
            const uvs = [];
        ...
        static pointsToStrokeWithBuffers(points, style, arcDivisions, minDistance, vertices, normals, uvs, vertexOffset) {
            ...
            const tempV2_1 = new v3d.Vector2();
            const tempV2_2 = new v3d.Vector2();
            const tempV2_3 = new v3d.Vector2();
            const tempV2_4 = new v3d.Vector2();
            const tempV2_5 = new v3d.Vector2();
            const tempV2_6 = new v3d.Vector2();
            const tempV2_7 = new v3d.Vector2();
            const lastPointL = new v3d.Vector2();
            const lastPointR = new v3d.Vector2();
            const point0L = new v3d.Vector2();
            const point0R = new v3d.Vector2();
            const currentPointL = new v3d.Vector2();
            const currentPointR = new v3d.Vector2();
            const nextPointL = new v3d.Vector2();
            const nextPointR = new v3d.Vector2();
            const innerPoint = new v3d.Vector2();
            const outerPoint = new v3d.Vector2();
