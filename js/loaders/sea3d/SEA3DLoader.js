...
if (v3d.Float32BufferAttribute === undefined) {

    v3d.Float32BufferAttribute = v3d.Float32Attribute;

}

v3d.SEA3D.useMultiMaterial = v3d.MultiMaterial.prototype.isMultiMaterial;

//
//    Config
//

v3d.SEA3D.MTXBUF = new v3d.Matrix4();
v3d.SEA3D.VECBUF = new v3d.Vector3();
v3d.SEA3D.QUABUF = new v3d.Quaternion();

v3d.SEA3D.BACKGROUND_COLOR = 0x333333;
v3d.SEA3D.HELPER_COLOR = 0x9AB9E5;
v3d.SEA3D.RTT_SIZE = 512;

v3d.SEA3D.identityMatrixScale = function() {

    var scl = new v3d.Vector3();
...
v3d.SEA3D.prototype = Object.assign(Object.create(v3d.EventDispatcher.prototype), {

    constructor: v3d.SEA3D,
...
Object.defineProperties(v3d.SEA3D.prototype, {
...
v3d.SEA3D.Domain = function(id, objects, container) {
    ...
    this.events = new v3d.EventDispatcher();

};

v3d.SEA3D.Domain.global = {};

v3d.SEA3D.Domain.prototype = Object.assign(Object.create(v3d.EventDispatcher.prototype), {

    constructor: v3d.SEA3D.Domain,
    ...
    runJSM: function(target, script) {
        ...
        var include = {
            ...
            source: new v3d.SEA3D.ScriptDomain(this, target instanceof v3d.SEA3D.Domain)
        };

        Object.freeze(include.source);

        v3d.SEA3D.ScriptHandler.add(include.source);
    ...
    dispose: function() {
        ...
        var i = v3d.SEA3D.EXTENSIONS_DOMAIN.length;

        while (i --) {

            var domain = v3d.SEA3D.EXTENSIONS_DOMAIN[i];
...
v3d.SEA3D.DomainManager = function(autoDisposeRootDomain) {
...
Object.assign(v3d.SEA3D.DomainManager.prototype, {
...
v3d.SEA3D.ScriptDomain = function(domain, root) {

    domain = domain || new v3d.SEA3D.Domain();
    domain.add(this);

    var events = new v3d.EventDispatcher();
...
v3d.SEA3D.ScriptManager = function() {
...
v3d.SEA3D.ScriptHandler = new v3d.SEA3D.ScriptManager();

v3d.SEA3D.ScriptHandler.dispatchUpdate = function(delta) {
...
v3d.SEA3D.AnimationClip = function(name, duration, tracks, repeat) {

    v3d.AnimationClip.call(this, name, duration, tracks);

    this.repeat = repeat !== undefined ? repeat : true;

};

v3d.SEA3D.AnimationClip.fromClip = function(clip, repeat) {

    return new v3d.SEA3D.AnimationClip(clip.name, clip.duration, clip.tracks, repeat);

};

v3d.SEA3D.AnimationClip.prototype = Object.assign(Object.create(v3d.AnimationClip.prototype), {

    constructor: v3d.SEA3D.AnimationClip
...
v3d.SEA3D.Animation = function(clip, timeScale) {
...
v3d.SEA3D.Animation.COMPLETE = "animationComplete";

v3d.SEA3D.Animation.prototype = Object.assign(Object.create(v3d.EventDispatcher.prototype), {

    constructor: v3d.SEA3D.Animation,

    onComplete: function(scope) {

        this.dispatchEvent({ type: v3d.SEA3D.Animation.COMPLETE, target: this });
...
Object.defineProperties(v3d.SEA3D.Animation.prototype, {
...
v3d.SEA3D.Animator = function(clips, mixer) {

    this.updateAnimations(clips, mixer);

    this.clone = function(scope) {

        return new this.constructor(this.clips, new v3d.AnimationMixer(scope)).copyFrom(this);

    }.bind(this);

};

Object.assign(v3d.SEA3D.Animator.prototype, {
    ...
    updateAnimations: function(clips, mixer) {
        ...
        if (this.mixer) v3d.SEA3D.AnimationHandler.remove(this);
    ...
    addAnimation: function(animation) {
        ...
        if (animation instanceof v3d.AnimationClip) {

            this.clips.push(animation);

            animation = new v3d.SEA3D.Animation(animation);
    ...
    pause: function() {
        ...
        if (this.playing && this.currentAnimation) {
            ...
            v3d.SEA3D.AnimationHandler.remove(this);
    ...
    resume: function() {
        ...
        if (!this.playing && this.currentAnimation) {
            ...
            v3d.SEA3D.AnimationHandler.add(this);
    ...
    play: function(name, crossfade, offset, weight) {
        ...
        if (animation == this.currentAnimation) {
            ...
            this.currentAnimationAction = this.mixer.clipAction(animation.clip).setLoop(animation.repeat ? v3d.LoopRepeat : v3d.LoopOnce, Infinity).reset();
    ...
    stop: function() {
        ...
        if (this.playing) v3d.SEA3D.AnimationHandler.remove(this);
    ...
    playw: function(name, weight) {
        ...
        if (!this.playing && ! this.paused) v3d.SEA3D.AnimationHandler.add(this);
        ...
        clip.setLoop(animation.repeat ? v3d.LoopRepeat : v3d.LoopOnce, Infinity).reset();
...
v3d.SEA3D.Object3DAnimator = function(clips, object3d) {

    this.object3d = object3d;

    v3d.SEA3D.Animator.call(this, clips, new v3d.AnimationMixer(object3d));
...
v3d.SEA3D.Object3DAnimator.prototype = Object.assign(Object.create(v3d.SEA3D.Animator.prototype), {

    constructor: v3d.SEA3D.Object3DAnimator,
    ...
    stop: function() {
        ...
        if (this.currentAnimation) {
            ...
            if (animate && this instanceof v3d.SEA3D.Object3DAnimator) {
        ...
        v3d.SEA3D.Animator.prototype.stop.call(this);

    },

    setRelative: function(val) {

        v3d.SEA3D.Animator.prototype.setRelative.call(this, val);

        this.object3d.setAnimator(this.relative);

        this.updateAnimations(this.clips, new v3d.AnimationMixer(this.relative ? this.object3d.animate : this.object3d));
...
v3d.SEA3D.CameraAnimator = function(clips, object3d) {

    v3d.SEA3D.Object3DAnimator.call(this, clips, object3d);

};

v3d.SEA3D.CameraAnimator.prototype = Object.assign(Object.create(v3d.SEA3D.Object3DAnimator.prototype), {

    constructor: v3d.SEA3D.CameraAnimator
...
v3d.SEA3D.SoundAnimator = function(clips, object3d) {

    v3d.SEA3D.Object3DAnimator.call(this, clips, object3d);

};

v3d.SEA3D.SoundAnimator.prototype = Object.assign(Object.create(v3d.SEA3D.Object3DAnimator.prototype), {

    constructor: v3d.SEA3D.SoundAnimator
...
v3d.SEA3D.LightAnimator = function(clips, object3d) {

    v3d.SEA3D.Object3DAnimator.call(this, clips, object3d);

};

v3d.SEA3D.LightAnimator.prototype = Object.assign(Object.create(v3d.SEA3D.Object3DAnimator.prototype), {

    constructor: v3d.SEA3D.LightAnimator
...
v3d.SEA3D.Object3D = function() {

    v3d.Object3D.call(this);

};

v3d.SEA3D.Object3D.prototype = Object.assign(Object.create(v3d.Object3D.prototype), {

    constructor: v3d.SEA3D.Object3D,
    ...
    setAnimator: function(val) {
        ...
        if (val) {
            ...
            this.animate = new v3d.Object3D();

            this.updateMatrixWorld = v3d.SEA3D.Object3D.prototype.updateAnimateMatrix;

        } else {

            delete this.animate;

            this.updateMatrixWorld = v3d.Object3D.prototype.updateMatrixWorld;
...
v3d.SEA3D.Dummy = function(width, height, depth) {

    this.width = width != undefined ? width : 100;
    this.height = height != undefined ? height : 100;
    this.depth = depth != undefined ? depth : 100;

    var geo = new v3d.BoxBufferGeometry(this.width, this.height, this.depth, 1, 1, 1);

    geo.computeBoundingBox();
    geo.computeBoundingSphere();

    v3d.Mesh.call(this, geo, v3d.SEA3D.Dummy.MATERIAL);

};

v3d.SEA3D.Dummy.MATERIAL = new v3d.MeshBasicMaterial({ wireframe: true, color: v3d.SEA3D.HELPER_COLOR });

v3d.SEA3D.Dummy.prototype = Object.assign(Object.create(v3d.Mesh.prototype), v3d.SEA3D.Object3D.prototype, {

    constructor: v3d.SEA3D.Dummy,
...
v3d.SEA3D.Mesh = function(geometry, material) {

    v3d.Mesh.call(this, geometry, material);

};

v3d.SEA3D.Mesh.prototype = Object.assign(Object.create(v3d.Mesh.prototype), v3d.SEA3D.Object3D.prototype, {

    constructor: v3d.SEA3D.Mesh,
...
v3d.SEA3D.SkinnedMesh.prototype = Object.assign(Object.create(v3d.SkinnedMesh.prototype), v3d.SEA3D.Mesh.prototype, v3d.SEA3D.Animator.prototype, {
    ...
    copy: function(source) {
        ...
        v3d.SkinnedMesh.prototype.copy.call(this, source);
...
v3d.SEA3D.VertexAnimationMesh = function(geometry, material) {
...
v3d.SEA3D.VertexAnimationMesh.prototype = Object.assign(Object.create(v3d.Mesh.prototype), v3d.SEA3D.Mesh.prototype, v3d.SEA3D.Animator.prototype, {

    constructor: v3d.SEA3D.VertexAnimationMesh,
...
v3d.SEA3D.Camera = function(fov, aspect, near, far) {

    v3d.PerspectiveCamera.call(this, fov, aspect, near, far);

};

v3d.SEA3D.Camera.prototype = Object.assign(Object.create(v3d.PerspectiveCamera.prototype), v3d.SEA3D.Object3D.prototype, {

    constructor: v3d.SEA3D.Camera,

    copy: function(source) {

        v3d.PerspectiveCamera.prototype.copy.call(this, source);
...
v3d.SEA3D.OrthographicCamera = function(left, right, top, bottom, near, far) {

    v3d.OrthographicCamera.call(this, left, right, top, bottom, near, far);

};

v3d.SEA3D.OrthographicCamera.prototype = Object.assign(Object.create(v3d.OrthographicCamera.prototype), v3d.SEA3D.Object3D.prototype, {

    constructor: v3d.SEA3D.OrthographicCamera,

    copy: function(source) {

        v3d.OrthographicCamera.prototype.copy.call(this, source);
...
v3d.SEA3D.PointLight = function(hex, intensity, distance, decay) {

    v3d.PointLight.call(this, hex, intensity, distance, decay);

};

v3d.SEA3D.PointLight.prototype = Object.assign(Object.create(v3d.PointLight.prototype), v3d.SEA3D.Object3D.prototype, {

    constructor: v3d.SEA3D.PointLight,

    copy: function(source) {

        v3d.PointLight.prototype.copy.call(this, source);
...
v3d.SEA3D.PointSound = function(listener, sound) {

    v3d.PositionalAudio.call(this, listener);

    this.setSound(sound);

};

v3d.SEA3D.PointSound.prototype = Object.assign(Object.create(v3d.PositionalAudio.prototype), v3d.SEA3D.Object3D.prototype, {

    constructor: v3d.SEA3D.PointSound,
    ...
    copy: function(source) {
        ...
        v3d.PositionalAudio.prototype.copy.call(this, source);
...
v3d.SEA3D.Sound = function(src) {

    this.uuid = v3d.Math.generateUUID();

    this.src = src;

    new v3d.AudioLoader().load(src, function(buffer) {
...
v3d.SEA3D.Sound.prototype = Object.assign(Object.create(v3d.EventDispatcher.prototype), {

    constructor: v3d.SEA3D.Sound
...
v3d.SEA3D.Domain.prototype.getMesh = v3d.SEA3D.prototype.getMesh = function(name) {

    return this.objects["m3d/" + name];

};

v3d.SEA3D.Domain.prototype.getDummy = v3d.SEA3D.prototype.getDummy = function(name) {

    return this.objects["dmy/" + name];

};

v3d.SEA3D.Domain.prototype.getLine = v3d.SEA3D.prototype.getLine = function(name) {

    return this.objects["line/" + name];

};

v3d.SEA3D.Domain.prototype.getSound3D = v3d.SEA3D.prototype.getSound3D = function(name) {

    return this.objects["sn3d/" + name];

};

v3d.SEA3D.Domain.prototype.getMaterial = v3d.SEA3D.prototype.getMaterial = function(name) {

    return this.objects["mat/" + name];

};

v3d.SEA3D.Domain.prototype.getLight = v3d.SEA3D.prototype.getLight = function(name) {

    return this.objects["lht/" + name];

};

v3d.SEA3D.Domain.prototype.getGLSL = v3d.SEA3D.prototype.getGLSL = function(name) {

    return this.objects["glsl/" + name];

};

v3d.SEA3D.Domain.prototype.getCamera = v3d.SEA3D.prototype.getCamera = function(name) {

    return this.objects["cam/" + name];

};

v3d.SEA3D.Domain.prototype.getTexture = v3d.SEA3D.prototype.getTexture = function(name) {

    return this.objects["tex/" + name];

};

v3d.SEA3D.Domain.prototype.getCubeMap = v3d.SEA3D.prototype.getCubeMap = function(name) {

    return this.objects["cmap/" + name];

};

v3d.SEA3D.Domain.prototype.getJointObject = v3d.SEA3D.prototype.getJointObject = function(name) {

    return this.objects["jnt/" + name];

};

v3d.SEA3D.Domain.prototype.getContainer3D = v3d.SEA3D.prototype.getContainer3D = function(name) {

    return this.objects["c3d/" + name];

};

v3d.SEA3D.Domain.prototype.getSprite = v3d.SEA3D.prototype.getSprite = function(name) {

    return this.objects["m2d/" + name];

};

v3d.SEA3D.Domain.prototype.getProperties = v3d.SEA3D.prototype.getProperties = function(name) {
...
v3d.SEA3D.prototype.isPowerOfTwo = function(num) {

    return num ? ((num & - num) == num) : false;

};

v3d.SEA3D.prototype.nearestPowerOfTwo = function(num) {

    return Math.pow(2, Math.round(Math.log(num) / Math.LN2));

};

v3d.SEA3D.prototype.updateTransform = function(obj3d, sea) {

    var mtx = v3d.SEA3D.MTXBUF, vec = v3d.SEA3D.VECBUF;
    ...
    obj3d.quaternion.setFromRotationMatrix(v3d.SEA3D.identityMatrixScale(mtx));
...
v3d.SEA3D.prototype.toVector3 = function(data) {

    return new v3d.Vector3(data.x, data.y, data.z);

};

v3d.SEA3D.prototype.toFaces = function(faces) {
...
v3d.SEA3D.prototype.updateScene = function() {
...
v3d.SEA3D.prototype.addSceneObject = function(sea, obj3d) {
...
v3d.SEA3D.prototype.createObjectURL = function(raw, mime) {

    return (window.URL || window.webkitURL).createObjectURL(new Blob([raw], { type: mime }));

};

v3d.SEA3D.prototype.parsePath = function(url) {
...
v3d.SEA3D.prototype.addDefaultAnimation = function(sea, animatorClass) {
...
v3d.SEA3D.prototype.readGeometryBuffer = function(sea) {

    var geo = sea.tag || new v3d.BufferGeometry();
    ...
    if (sea.indexes) geo.setIndex(new v3d.BufferAttribute(sea.indexes, 1));

    geo.addAttribute('position', new v3d.BufferAttribute(sea.vertex, 3));

    if (sea.uv) {

        geo.addAttribute('uv', new v3d.BufferAttribute(sea.uv[0], 2));
        if (sea.uv.length > 1) geo.addAttribute('uv2', new v3d.BufferAttribute(sea.uv[1], 2));

    }

    if (sea.normal) geo.addAttribute('normal', new v3d.BufferAttribute(sea.normal, 3));
    else geo.computeVertexNormals();

    if (sea.tangent4) geo.addAttribute('tangent', new v3d.BufferAttribute(sea.tangent4, 4));

    if (sea.color) geo.addAttribute('color', new v3d.BufferAttribute(sea.color[0], sea.numColor));

    if (sea.joint) {

        geo.addAttribute('skinIndex', new v3d.Float32BufferAttribute(sea.joint, sea.jointPerVertex));
        geo.addAttribute('skinWeight', new v3d.Float32BufferAttribute(sea.weight, sea.jointPerVertex));
...
v3d.SEA3D.prototype.readDummy = function(sea) {

    var dummy = new v3d.SEA3D.Dummy(sea.width, sea.height, sea.depth);
    dummy.name = sea.name;
    ...
    this.addDefaultAnimation(sea, v3d.SEA3D.Object3DAnimator);
...
v3d.SEA3D.prototype.readLine = function(sea) {
    ...
    geo.addAttribute('position', new v3d.Float32BufferAttribute(sea.vertex, 3));

    var line = new v3d.Line(geo, new v3d.LineBasicMaterial({ color: v3d.SEA3D.HELPER_COLOR, linewidth: 3 }));
    line.name = sea.name;
...
v3d.SEA3D.prototype.readContainer3D = function(sea) {

    var container = new v3d.SEA3D.Object3D();
...
v3d.SEA3D.prototype.readSprite = function(sea) {
    ...
    if (sea.material) {
        ...
        if (!sea.material.tag.sprite) {
            ...
            mat = sea.material.tag.sprite = new v3d.SpriteMaterial();
...
v3d.SEA3D.prototype.readMesh = function(sea) {
    ...
    if (sea.material) {
        ...
        if (sea.material.length > 1) {
            ...
            for (i = 0; i < sea.material.length; i++) {
                ...
                mats[i].vertexColors = sea.geometry.color ? v3d.VertexColors : v3d.NoColors;

            }

            mat = v3d.SEA3D.useMultiMaterial ? new v3d.MultiMaterial(mats) : mats;
            ...
            mat.vertexColors = sea.geometry.color ? v3d.VertexColors : v3d.NoColors;
    ...
    if (skeleton) {
        ...
        mesh = new v3d.SEA3D.SkinnedMesh(geo, mat, this.config.useVertexTexture);
        ...
        mesh = new v3d.SEA3D.VertexAnimationMesh(geo, mat);
        ...
        mesh = new v3d.SEA3D.Mesh(geo, mat);

    }

    if (uvwAnimationClips) {

        mesh.uvwAnimator = new v3d.SEA3D.Animator(uvwAnimationClips, new v3d.AnimationMixer(mat.map));
    ...
    if (morphAnimation) {
        ...
        mesh.morphAnimator = new v3d.SEA3D.Animator(morphAnimation, new v3d.AnimationMixer(mesh));
...
v3d.SEA3D.prototype.readSoundPoint = function(sea) {

    if (!this.audioListener) {

         this.audioListener = new v3d.AudioListener();
    ...
    var sound3d = new v3d.SEA3D.PointSound(this.audioListener);
    ...
    this.addDefaultAnimation(sea, v3d.SEA3D.SoundAnimator);
...
v3d.SEA3D.prototype.readCubeRender = function(sea) {

    var cube = new v3d.CubeCamera(0.1, 5000, v3d.SEA3D.RTT_SIZE);
...
v3d.SEA3D.prototype.readTexture = function(sea) {

    var image = new Image(),
        texture = new v3d.Texture();
...
v3d.SEA3D.prototype.readCubeMap = function(sea) {

    var faces = this.toFaces(sea.faces), texture = new v3d.CubeTexture([]);
...
v3d.SEA3D.prototype.readTextureUpdate = function(sea) {
...
v3d.SEA3D.prototype.readSound = function(sea) {

    var sound = new v3d.SEA3D.Sound(this.createObjectURL(sea.data.buffer, "audio/" + sea.type));
    sound.name = sea.name;
...
v3d.SEA3D.prototype.readScriptURL = function(sea) {
...
v3d.SEA3D.prototype.readTextureURL = function(sea) {

    var texture = new v3d.TextureLoader().load(this.parsePath(sea.url));
...
v3d.SEA3D.prototype.readCubeMapURL = function(sea) {
    ...
    if (format == "hdr") {
        ...
        var usePMREM = v3d.PMREMGenerator != null;

        this.file.resume = ! usePMREM;

        texture = new v3d.HDRCubeTextureLoader().load(v3d.UnsignedByteType, faces, function(texture) {
        ...
        texture = new v3d.CubeTextureLoader().load(faces);
...
v3d.SEA3D.prototype.getJSMList = function(target, scripts) {
...
v3d.SEA3D.prototype.readJavaScriptMethod = function(sea) {
...
v3d.SEA3D.prototype.readGLSL = function(sea) {
...
v3d.SEA3D.prototype.materialTechnique =
(function() {
    ...
    techniques.onComplete = function(mat, sea) {
        ...
        if (sea.alpha < 1 || mat.blending > v3d.NormalBlending) {
    ...
    function(mat, tech, sea) {
        ...
        mat.map.wrapS = mat.map.wrapT = sea.repeat ? v3d.RepeatWrapping : v3d.ClampToEdgeWrapping;
    ...
    function(mat, tech) {
        ...
        mat.envMap.mapping = v3d.CubeReflectionMapping;
        mat.combine = v3d.MixOperation;
    ...
    function(mat, tech) {
        ...
        mat.envMap = tech.texture.tag;
        mat.envMap.mapping = v3d.SphericalReflectionMapping;
        mat.combine = v3d.MixOperation;
    ...
    function(mat, tech) {
        ...
        mat.envMap = tech.texture.tag;
        mat.envMap.mapping = v3d.CubeRefractionMapping;
    ...
    function(mat, tech, sea) {
        ...
        mat.alphaMap.wrapS = mat.alphaMap.wrapT = sea.repeat ? v3d.RepeatWrapping : v3d.ClampToEdgeWrapping;
...
v3d.SEA3D.prototype.setBlending = function(mat, blendMode) {
    ...
    switch (blendMode) {
        ...
        case "add":
            ...
            mat.blending = v3d.AdditiveBlending;

            break;

        case "subtract":

            mat.blending = v3d.SubtractiveBlending;

            break;

        case "multiply":

            mat.blending = v3d.MultiplyBlending;

            break;

        case "screen":

            mat.blending = v3d.CustomBlending;
            mat.blendSrc = v3d.OneFactor;
            mat.blendDst = v3d.OneMinusSrcColorFactor;
            mat.blendEquation = v3d.AddEquation;
...
v3d.SEA3D.prototype.readMaterial = function(sea) {
    ...
    mat.side = sea.doubleSided ? v3d.DoubleSide : v3d.FrontSide;
...
v3d.SEA3D.prototype.readPointLight = function(sea) {

    var light = new v3d.SEA3D.PointLight(sea.color, sea.multiplier * this.config.multiplier);
    light.name = sea.name;
    ...
    this.addDefaultAnimation(sea, v3d.SEA3D.LightAnimator);
...
v3d.SEA3D.prototype.readHemisphereLight = function(sea) {

    var light = new v3d.HemisphereLight(sea.color, sea.secondColor, sea.multiplier * this.config.multiplier);
...
v3d.SEA3D.prototype.readAmbientLight = function(sea) {

    var light = new v3d.AmbientLight(sea.color, sea.multiplier * this.config.multiplier);
    light.name = sea.name;
...
v3d.SEA3D.prototype.readDirectionalLight = function(sea) {

    var light = new v3d.DirectionalLight(sea.color, sea.multiplier * this.config.multiplier);
    light.name = sea.name;
...
v3d.SEA3D.prototype.readCamera = function(sea) {

    var camera = new v3d.SEA3D.Camera(sea.fov);
    ...
    this.addDefaultAnimation(sea, v3d.SEA3D.CameraAnimator);
...
v3d.SEA3D.prototype.readOrthographicCamera = function(sea) {
    ...
    var camera = new v3d.SEA3D.OrthographicCamera(- width, width, height, - height);
    camera.name = sea.name;
...
v3d.SEA3D.prototype.getSkeletonFromBones = function(bonesData) {
    ...
    return new v3d.Skeleton(bones);

};

v3d.SEA3D.prototype.readSkeletonLocal = function(sea) {
...
v3d.SEA3D.prototype.readJointObject = function(sea) {
...
v3d.SEA3D.prototype.readMorph = function(sea) {
    ...
    for (var i = 0; i < sea.node.length; i++) {
        ...
        attribs.position[i] = new v3d.Float32BufferAttribute(node.vertex, 3);
        attribs.position[i].name = node.name;

        if (node.normal) {

            attribs.normal = attribs.normal || [];
            attribs.normal[i] = new v3d.Float32BufferAttribute(node.normal, 3);
...
v3d.SEA3D.prototype.readAnimation = function(sea) {
    ...
    for (var i = 0; i < sea.sequence.length; i++) {
        ...
        for (var j = 0; j < sea.dataList.length; j ++) {
            ...
            var anm = sea.dataList[j],
                ...
                intrpl = seq.intrpl ? v3d.InterpolateLinear : false,
                name = null;
            ...
            switch (anm.type) {
                ...
                case SEA3D.Stream.DECIMAL:
                    ...
                    tracks.push(new v3d.NumberKeyframeTrack(name, times, values, intrpl));
                ...
                case SEA3D.Stream.VECTOR3D:
                    ...
                    tracks.push(new v3d.VectorKeyframeTrack(name, times, values, intrpl));
                ...
                case SEA3D.Stream.VECTOR4D:
                    ...
                    tracks.push(new v3d.QuaternionKeyframeTrack(name, times, values, intrpl));
                ...
                case SEA3D.Stream.UINT24:
                    ...
                    tracks.push(new v3d.VectorKeyframeTrack(name, times, values, intrpl));//ColorKeyframeTrack
        ...
        animations.push(new v3d.SEA3D.AnimationClip(seq.name, - 1, tracks, seq.repeat));
...
v3d.SEA3D.prototype.readSkeletonAnimation = function(sea, skl) {
    ...
    for (var i = 0; i < sea.sequence.length; i++) {
        ...
        animations.push(v3d.SEA3D.AnimationClip.fromClip(v3d.AnimationClip.parseAnimation(animation, skl.tag), seq.repeat));
...
v3d.SEA3D.prototype.readVertexAnimation = function(sea) {
    ...
    for (i = 0, l = sea.frame.length; i < l; i++) {
        ...
        attribs.position[i] = new v3d.Float32BufferAttribute(frame.vertex, 3);

        if (frame.normal) {

            attribs.normal = attribs.normal || [];
            attribs.normal[i] = new v3d.Float32BufferAttribute(frame.normal, 3);
    ...
    for (i = 0; i < sea.sequence.length; i++) {
        ...
        animations.push(v3d.SEA3D.AnimationClip.fromClip(v3d.AnimationClip.CreateFromMorphTargetSequence(seq.name, seqTargets, sea.frameRate), seq.repeat));
...
v3d.SEA3D.prototype.getModifier = function(req) {
...
v3d.SEA3D.prototype.applyEnvironment = function(envMap) {

    for (var j = 0, l = this.materials.length; j < l; ++ j) {

        var mat = this.materials[j];

        if (mat instanceof v3d.MeshStandardMaterial) {
...
v3d.SEA3D.prototype.readActions = function(sea) {
    ...
    for (var i = 0; i < sea.actions.length; i++) {
        ...
        switch (act.kind) {
            ...
            case SEA3D.Actions.ENVIRONMENT_COLOR:
                ...
                this.background.color = new v3d.Color(act.color);
...
v3d.SEA3D.prototype.updatePropertiesAssets = function(sea, props) {
...
v3d.SEA3D.prototype.readProperties = function(sea) {
...
v3d.SEA3D.prototype.readFileInfo = function(sea) {
...
v3d.SEA3D.prototype.onProgress = function(e) {

    e.status = e.type;
    e.progress = e.loaded / e.total;
    e.type = v3d.SEA3D.Event.PROGRESS;

    this.dispatchEvent(e);

};

v3d.SEA3D.prototype.onLoadProgress = function(e) {

    e.type = v3d.SEA3D.Event.LOAD_PROGRESS;
    this.dispatchEvent(e);
...
v3d.SEA3D.prototype.onDownloadProgress = function(e) {

    e.type = v3d.SEA3D.Event.DOWNLOAD_PROGRESS;
    this.dispatchEvent(e);
...
v3d.SEA3D.prototype.onComplete = function(e) {

    e.type = v3d.SEA3D.Event.COMPLETE;
    this.dispatchEvent(e);

};

v3d.SEA3D.prototype.onCompleteObject = function(e) {

    e.type = v3d.SEA3D.Event.OBJECT_COMPLETE;
    this.dispatchEvent(e);

};

v3d.SEA3D.prototype.onParseProgress = function(e) {

    e.type = v3d.SEA3D.Event.PARSE_PROGRESS;
    this.dispatchEvent(e);

};

v3d.SEA3D.prototype.onParseComplete = function(e) {

    e.type = v3d.SEA3D.Event.PARSE_COMPLETE;
    this.dispatchEvent(e);

};

v3d.SEA3D.prototype.onError = function(e) {

    e.type = v3d.SEA3D.Event.ERROR;
    this.dispatchEvent(e);
...
v3d.SEA3D.prototype.createDomain = function() {

    return this.domain = new v3d.SEA3D.Domain(
        this.config.id,
        this.objects = {},
...
v3d.SEA3D.prototype.clone = function(config, onParseComplete, onParseProgress) {

    if (!this.file.isDone()) throw new Error("Previous parse is not completed.");

    this.config.container = config && config.container !== undefined ? config.container : new v3d.Object3D();
...
v3d.SEA3D.prototype.loadConfig = function(config) {
...
v3d.SEA3D.prototype.parse = function(onParseComplete, onParseProgress) {
    ...
    var i = v3d.SEA3D.EXTENSIONS_LOADER.length;

    while (i --) {

        var loader = v3d.SEA3D.EXTENSIONS_LOADER[i];
...
v3d.SEA3D.prototype.onHead = function(args) {
...
v3d.SEA3D.EXTENSIONS_LOADER = [];
v3d.SEA3D.EXTENSIONS_DOMAIN = [];

v3d.SEA3D.prototype.setTypeRead = function() {
...
v3d.SEA3D.prototype.load = function(data) {
