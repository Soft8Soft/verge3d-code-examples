...
Object.assign(v3d.SEA3D.Domain.prototype, {
...
v3d.SEA3D.Dummy = function(width, height, depth) {
    ...
    var geo = new v3d.BoxGeometry(this.width, this.height, this.depth, 1, 1, 1);
...
v3d.SEA3D.PointSound = function(listener) {
...
v3d.SEA3D.prototype.bufferToTexture = function(raw) {

    return this.createObjectURL(raw, "image");

};

v3d.SEA3D.prototype.bufferToSound = function(raw) {
...
v3d.SEA3D.prototype.readGeometryBuffer = function(sea) {
    ...
    geo.setIndex(new v3d.BufferAttribute(sea.indexes, 1));
...
//            mat = new v3d.MultiMaterial(mats);
            mat = mats;
    ...
    if (skeleton) {
        ...
        mesh = new v3d.SEA3D.VertexAnimationMesh(geo, mat, vertexAnimation.frameRate);
...
v3d.SEA3D.prototype.readSoundPoint = function(sea) {
    ...
    new v3d.AudioLoader().load(sea.sound.tag, function(buffer) {
...
v3d.SEA3D.prototype.readMaterial = function(sea) {
    ...
    mat.side = sea.bothSides ? v3d.DoubleSide : v3d.FrontSide;
...
v3d.SEA3D.prototype.readMorpher = function(sea) {
...
v3d.SEA3D.prototype.getAnimationType = function(req) {
