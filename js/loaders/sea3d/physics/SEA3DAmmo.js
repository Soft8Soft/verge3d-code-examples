...
SEA3D.AMMO = {
    ...
    init: function(gravity, worldScale, broadphase) {
        ...
        console.log("v3d.AMMO " + this.VERSION);
    ...
    getTransformFromMatrix: function(mtx) {
        ...
        var scl = v3d.SEA3D.VECBUF.setFromMatrixScale(mtx);
        mtx.scale(scl.set(1 / scl.x, 1 / scl.y, 1 / scl.z));

        var quat = new v3d.Quaternion().setFromRotationMatrix(mtx);
