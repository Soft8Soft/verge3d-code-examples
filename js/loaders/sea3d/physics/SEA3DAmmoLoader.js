...
v3d.SEA3D.prototype.toAmmoVec3 = function(v) {
...
v3d.SEA3D.prototype.readSphere = function(sea) {
...
v3d.SEA3D.prototype.readBox = function(sea) {
...
v3d.SEA3D.prototype.readCone = function(sea) {
...
v3d.SEA3D.prototype.readCylinder = function(sea) {
...
v3d.SEA3D.prototype.readCapsule = function(sea) {
...
v3d.SEA3D.prototype.readConvexGeometry = function(sea) {
...
v3d.SEA3D.prototype.readTriangleGeometry = function(sea) {
...
v3d.SEA3D.prototype.readCompound = function(sea) {
    ...
    for (var i = 0; i < sea.compounds.length; i++) {
        ...
        v3d.SEA3D.MTXBUF.elements = compound.transform;

        var transform = SEA3D.AMMO.getTransformFromMatrix(v3d.SEA3D.MTXBUF);
...
v3d.SEA3D.prototype.readRigidBodyBase = function(sea) {
    ...
    if (sea.target) {
        ...
        v3d.SEA3D.MTXBUF.fromArray(sea.transform);

        transform = SEA3D.AMMO.getTransformFromMatrix(v3d.SEA3D.MTXBUF);
...
v3d.SEA3D.prototype.readRigidBody = function(sea) {
...
v3d.SEA3D.prototype.readCarController = function(sea) {
...
v3d.SEA3D.prototype.readP2PConstraint = function(sea) {
...
v3d.SEA3D.prototype.readHingeConstraint = function(sea) {
...
v3d.SEA3D.prototype.readConeTwistConstraint = function(sea) {
...
v3d.SEA3D.Domain.prototype.enabledPhysics = function(enabled) {
...
v3d.SEA3D.Domain.prototype.applyContainerTransform = function() {
...
v3d.SEA3D.Domain.prototype.applyTransform = function(matrix) {
...
v3d.SEA3D.Domain.prototype.getShape = v3d.SEA3D.prototype.getShape = function(name) {

    return this.objects["shpe/" + name];

};

v3d.SEA3D.Domain.prototype.getRigidBody = v3d.SEA3D.prototype.getRigidBody = function(name) {

    return this.objects["rb/" + name];

};

v3d.SEA3D.Domain.prototype.getConstraint = v3d.SEA3D.prototype.getConstraint = function(name) {

    return this.objects["ctnt/" + name];

};

v3d.SEA3D.EXTENSIONS_LOADER.push({
...
v3d.SEA3D.EXTENSIONS_DOMAIN.push({
