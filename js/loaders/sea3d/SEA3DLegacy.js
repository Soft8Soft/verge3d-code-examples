...
Object.assign(v3d.SEA3D.prototype, {

    _onHead: v3d.SEA3D.prototype.onHead,
    _updateTransform: v3d.SEA3D.prototype.updateTransform,
    _readMorph: v3d.SEA3D.prototype.readMorph,
    _readVertexAnimation: v3d.SEA3D.prototype.readVertexAnimation,
    _readGeometryBuffer: v3d.SEA3D.prototype.readGeometryBuffer,
    _readLine: v3d.SEA3D.prototype.readLine,
    _getModifier: v3d.SEA3D.prototype.getModifier,
    _readAnimation: v3d.SEA3D.prototype.readAnimation
...
v3d.SEA3D.prototype.isLegacy = function(sea) {
...
v3d.SEA3D.prototype.flipVec3 = function(v) {
...
v3d.SEA3D.prototype.addVector = function(v, t) {
...
v3d.SEA3D.prototype.expandJoints = function(sea) {
...
v3d.SEA3D.prototype.compressJoints = function(sea) {
...
v3d.SEA3D.prototype.flipIndexes = function(v) {
...
v3d.SEA3D.prototype.flipBoneMatrix = function() {

    var zero = new v3d.Vector3();

    return function(mtx) {

        var pos = v3d.SEA3D.VECBUF.setFromMatrixPosition(mtx);
        pos.z = - pos.z;

        mtx.setPosition(zero);
        mtx.multiplyMatrices(v3d.SEA3D.MTXBUF.makeRotationZ(v3d.Math.degToRad(180)), mtx);
        mtx.setPosition(pos);
...
v3d.SEA3D.prototype.flipScaleMatrix = function() {

    var pos = new v3d.Vector3();
    var qua = new v3d.Quaternion();
    var slc = new v3d.Vector3();
    ...
    return function(local, rotate, parent, parentRotate) {
        ...
        if (rotate) {
            ...
            local.multiplyMatrices(local, v3d.SEA3D.MTXBUF.makeRotationZ(v3d.Math.degToRad(180)));
...
v3d.SEA3D.prototype.flipDefaultAnimation = function() {

    var buf1 = new v3d.Matrix4();
    var buf2 = new v3d.Matrix4();

    var pos = new v3d.Vector3();
    var qua = new v3d.Quaternion();
    var slc = new v3d.Vector3();

    var to_pos = new v3d.Vector3();
    var to_qua = new v3d.Quaternion();
    var to_slc = new v3d.Vector3();
    ...
    if (this.isLegacy(sea) && ! sea.done) {
        ...
        switch (sea.type) {
            ...
            case SEA3D.UVWAnimation.prototype.type:
                ...
                if (req.scope instanceof v3d.Object3D) {
...
v3d.SEA3D.prototype.updateTransform = function() {

    var buf1 = new v3d.Matrix4();
    var identity = new v3d.Matrix4();
    ...
    return function(obj3d, sea) {
        ...
        if (this.isLegacy(sea)) {
            ...
            this.flipScaleMatrix(
                ...
                obj3d.parent instanceof v3d.Bone
            );
            ...
            buf1.scale(v3d.SEA3D.VECBUF.set(1 / obj3d.scale.x, 1 / obj3d.scale.y, 1 / obj3d.scale.z));
...
v3d.SEA3D.prototype.readSkeleton = function() {

    var mtx_tmp_inv = new v3d.Matrix4(),
        mtx_local = new v3d.Matrix4(),
        mtx_parent = new v3d.Matrix4(),
        pos = new v3d.Vector3(),
        qua = new v3d.Quaternion();
...
v3d.SEA3D.prototype.readSkeletonAnimationLegacy = function() {

    var mtx_tmp_inv = new v3d.Matrix4(),
        mtx_local = new v3d.Matrix4(),
        mtx_global = new v3d.Matrix4(),
        mtx_parent = new v3d.Matrix4();
        ...
        for (var i = 0; i < sea.sequence.length; i++) {
            ...
            for (var j = 0; j < numJoints; j ++) {
                ...
                for (var frame = start; frame < end; frame ++) {
                    ...
                    mtx_local.makeRotationFromQuaternion(v3d.SEA3D.QUABUF.set(raw[idx + 3], raw[idx + 4], raw[idx + 5], raw[idx + 6]));
                    mtx_local.setPosition(v3d.SEA3D.VECBUF.set(raw[idx], raw[idx + 1], raw[idx + 2]));
                    ...
                    var posQ = v3d.SEA3D.VECBUF.setFromMatrixPosition(mtx_local);
                    var newQ = v3d.SEA3D.QUABUF.setFromRotationMatrix(mtx_local);
...
v3d.SEA3D.prototype.readMorphLegacy = function(sea, geo) {
...
v3d.SEA3D.prototype.readLines = function(sea) {
...
v3d.SEA3D.EXTENSIONS_LOADER.push({ setTypeRead: function() {
