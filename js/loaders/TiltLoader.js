(function() {
    ...
    class TiltLoader extends v3d.Loader {
        ...
        parse(buffer) {
            ...
            const group = new v3d.Group(); // https://docs.google.com/document/d/11ZsHozYn9FnWG7y3s3WAyKIACfbfwb4PbaS8cZ_xjvo/edit#
    ...
    */
    ...
    class StrokeGeometry extends v3d.BufferGeometry {
        ...
        constructor(strokes) {
            ...
            const prevPosition = new v3d.Vector3();
            ...
            const vector4 = new v3d.Vector3(); // size = size / 2;
            ...
            this.setAttribute('color', new v3d.BufferAttribute(new Float32Array(colors), 4));
            this.setAttribute('uv', new v3d.BufferAttribute(new Float32Array(uvs), 2));
    ...
    function getShaders() {
        ...
        if (shaders === null) {
            ...
            const loader = new v3d.TextureLoader().setPath('./textures/tiltbrush/');
            shaders = {
                'Light': {
                    uniforms: {
                        mainTex: {
    ...
    function getMaterial(GUID) {
        ...
        switch (name) {
            ...
            case 'Light':
                return new v3d.RawShaderMaterial(getShaders().Light);
