(function() {
    ...
    class MD2Loader extends v3d.Loader {
        ...
        parse(buffer) {
            ...
            const geometry = new v3d.BufferGeometry(); // uvs
            ...
            const translation = new v3d.Vector3();
            ...
            geometry.setAttribute('uv', new v3d.Float32BufferAttribute(uvs, 2)); // animation
            ...
            for (let i = 0, l = frames.length; i < l; i++) {
                ...
                if (frame.normals.length > 0) {
                    ...
                    const normalAttribute = new v3d.Float32BufferAttribute(normals, 3);
