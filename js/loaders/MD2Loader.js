    ...
    parse: (function() {
        ...
        return function(buffer) {
            ...
            for (var i = 0, l = header.num_st; i < l; i++) {
                ...
                uvs.push(new v3d.Vector2(u / header.skinwidth, 1 - (v / header.skinheight)));
            ...
            for (var i = 0, l = header.num_tris; i < l; i++) {
                ...
                geometry.faces.push(new v3d.Face3(a, b, c));
            ...
            var translation = new v3d.Vector3();
            ...
            for (var i = 0, l = header.num_frames; i < l; i++) {
                ...
                for (var j = 0; j < header.num_vertices; j ++) {
                    ...
                    var normal = new v3d.Vector3(n[0], n[2], n[1]);
            ...
            geometry.animations = v3d.AnimationClip.CreateClipsFromMorphTargetSequences(geometry.morphTargets, 10);
