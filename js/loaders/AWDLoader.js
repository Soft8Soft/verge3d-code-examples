...
(function() {
    ...
    v3d.AWDLoader.prototype = {

        constructor: v3d.AWDLoader,
        ...
        parseMeshInstance: function(len) {
            ...
            if (meshLen > 1) {
                ...
                mesh = new v3d.Object3D();
                for (i = 0; i < meshLen; i++) {

                    var sm = new v3d.Mesh(geometries[i]);
                    meshes.push(sm);
                    mesh.add(sm);
                ...
                mesh = new v3d.Mesh(geometries[0]);
                meshes.push(mesh);
        ...
        loadTexture: function(url) {
            ...
            var tex = new v3d.Texture();

            var loader = new v3d.ImageLoader(this.manager);
            ...
            while (subs_parsed < num_subs) {
                ...
                while (this._ptr < sm_end) {
                    ...
                    if (str_type === 1) {
                        ...
                        attrib = new v3d.BufferAttribute(buffer, 3);
                        ...
                        attrib = new v3d.BufferAttribute(buffer, 1);
                        ...
                        attrib = new v3d.BufferAttribute(buffer, 2);
