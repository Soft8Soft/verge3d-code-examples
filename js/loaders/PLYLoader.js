(function() {
    ...
    /**
 * Description: A v3d loader for PLY ASCII files (known as the Polygon
 ...
 */
    ...
    class PLYLoader extends v3d.Loader {
        ...
        parse(data) {
            ...
            function postProcess(buffer) {
                ...
                let geometry = new v3d.BufferGeometry(); // mandatory buffer data
                ...
                geometry.setAttribute('position', new v3d.Float32BufferAttribute(buffer.vertices, 3)); // optional buffer data
            ...
            if (data instanceof ArrayBuffer) {
                ...
                const text = v3d.LoaderUtils.decodeText(new Uint8Array(data));
