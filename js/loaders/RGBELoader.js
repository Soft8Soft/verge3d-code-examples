(function() {
    ...
    class RGBELoader extends v3d.DataTextureLoader {
                ...
                rgbe_error = function(rgbe_error_code, msg) {
                    ...
                    switch (rgbe_error_code) {
                        ...
                        case rgbe_read_error:
                            console.error('v3d.RGBELoader Read Error: ' + (msg || ''));
                            break;

                        case rgbe_write_error:
                            console.error('v3d.RGBELoader Write Error: ' + (msg || ''));
                            break;

                        case rgbe_format_error:
                            console.error('v3d.RGBELoader Bad File Format: ' + (msg || ''));
                            break;

                        default:
                        case rgbe_memory_error:
                            console.error('v3d.RGBELoader: Error: ' + (msg || ''));
