 ...
 * - Texture 2D
 * - Texture 2D Groups
 * - v3d.Color Groups (Vertex Colors)
 * - Metallic Display Properties (PBR)
 */

    class ThreeMFLoader extends v3d.Loader {
        ...
        parse(data) {
            ...
            function loadDocument(data) {
                ...
                try {
                    ...
                    if (e instanceof ReferenceError) {
                        ...
                        console.error('v3d.3MFLoader: fflate missing and file is compressed.');
                        return null;
                ...
                const relsFileText = v3d.LoaderUtils.decodeText(relsView);
            ...
            function parseColorGroupNode(colorGroupNode) {
                ...
                const colors = [];
                const colorObject = new v3d.Color();
            ...
            function buildTexture(texture2dgroup, objects, modelData, textureData) {
                ...
                if (texture2d) {
                    ...
                    texture.encoding = v3d.sRGBEncoding; // texture parameters
            ...
            function buildTexturedMesh(texture2dgroup, triangleProperties, meshData, objects, modelData, textureData, objectData) {
                ...
                geometry.setAttribute('position', new v3d.Float32BufferAttribute(positionData, 3));
                geometry.setAttribute('uv', new v3d.Float32BufferAttribute(uvData, 2)); // material
            ...
            function buildVertexColorMesh(colorgroup, triangleProperties, meshData, objects, modelData, objectData) {
                ...
                geometry.setAttribute('position', new v3d.Float32BufferAttribute(positionData, 3));
                geometry.setAttribute('color', new v3d.Float32BufferAttribute(colorData, 3)); // material
    ...
    v3d.ThreeMFLoader = ThreeMFLoader;
