...
v3d.ThreeMFLoader = function(manager) {
...
v3d.ThreeMFLoader.prototype = Object.assign(Object.create(v3d.Loader.prototype), {

    constructor: v3d.ThreeMFLoader,
    ...
    parse: function(data) {
        ...
        function loadDocument(data) {
            ...
            try {
                ...
                if (e instanceof ReferenceError) {
                    ...
                    console.error('v3d.3MFLoader: jszip missing and file is compressed.');
                    return null;
            ...
            for (var i = 0; i < modelPartNames.length; i++) {
                ...
                if (xmlData.documentElement.nodeName.toLowerCase() !== 'model') {
                    ...
                    console.error('v3d.3MFLoader: Error loading 3MF - no 3MF document found: ', modelPart);
        ...
        function buildTexture(texture2dgroup, objects, modelData, textureData) {
            ...
            if (texture2d) {
                ...
                switch (texture2d.tilestyleu) {
                    ...
                    case 'mirror':
                        texture.wrapS = v3d.MirroredRepeatWrapping;
                        break;
                ...
                switch (texture2d.tilestylev) {
                    ...
                    case 'mirror':
                        texture.wrapT = v3d.MirroredRepeatWrapping;
                        break;
        ...
        function buildBasematerialsMeshes(basematerials, triangleProperties, modelData, meshData, textureData, objectData) {
            ...
            for (var i = 0, l = keys.length; i < l; i++) {
                ...
                geometry.setAttribute('position', new v3d.Float32BufferAttribute(positionData, 3));
        ...
        function buildTexturedMesh(texture2dgroup, triangleProperties, modelData, meshData, textureData, objectData) {
            ...
            geometry.setAttribute('position', new v3d.Float32BufferAttribute(positionData, 3));
            geometry.setAttribute('uv', new v3d.Float32BufferAttribute(uvData, 2));

            // material

            var texture = getBuild(texture2dgroup, objects, modelData, textureData, objectData, buildTexture);

            var material = new v3d.MeshPhongMaterial({ map: texture, flatShading: true });
        ...
        function buildVertexColorMesh(colorgroup, triangleProperties, modelData, meshData) {
            ...
            geometry.setAttribute('position', new v3d.Float32BufferAttribute(positionData, 3));
            geometry.setAttribute('color', new v3d.Float32BufferAttribute(colorData, 3));

            // material

            var material = new v3d.MeshPhongMaterial({ vertexColors: v3d.VertexColors, flatShading: true });
        ...
        function buildDefaultMesh(meshData) {
            ...
            var material = new v3d.MeshPhongMaterial({ color: 0xaaaaff, flatShading: true });
        ...
        function buildMeshes(resourceMap, modelData, meshData, textureData, objectData) {
            ...
            for (var i = 0, il = keys.length; i < il; i++) {
                ...
                switch (resourceType) {
                    ...
                    default:
                        console.error('v3d.3MFLoader: Unsupported resource type.');
        ...
        function buildBasematerial(materialData, objects, modelData) {
            ...
            if (displaypropertiesid !== null && pbmetallicdisplayproperties[displaypropertiesid] !== undefined) {
                ...
                material = new v3d.MeshStandardMaterial({ flatShading: true, roughness: metallicData.roughness, metalness: metallicData.metallicness });

            } else {

                // otherwise use PhongMaterial

                material = new v3d.MeshPhongMaterial({ flatShading: true });
