...
v3d.ThreeMFLoader.prototype = {
    ...
    parse: function(data) {
        ...
        function loadDocument(data) {
            ...
            try {
                ...
                if (e instanceof ReferenceError) {
                    ...
                    console.error('v3d.ThreeMFLoader: jszip missing and file is compressed.');
                    return null;
            ...
            for (var i = 0; i < modelPartNames.length; i++) {
                ...
                if (xmlData.documentElement.nodeName.toLowerCase() !== 'model') {
                    ...
                    console.error('v3d.ThreeMFLoader: Error loading 3MF - no 3MF document found: ', modelPart);
        ...
        function buildMesh(meshData, data3mf) {
            ...
            geometry.addAttribute('position', new v3d.BufferAttribute(meshData['vertices'], 3));

            if (meshData['colors']) {

                geometry.addAttribute('color', new v3d.BufferAttribute(meshData['colors'], 3));
            ...
            if (meshData['colors'] && 0 < meshData['colors'].length) {
                ...
                materialOpts['vertexColors'] = v3d.VertexColors;
            ...
            var material = new v3d.MeshPhongMaterial(materialOpts);
