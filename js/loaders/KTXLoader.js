...
v3d.KTXLoader = function(manager) {

    v3d.CompressedTextureLoader.call(this, manager);

    this._parser = v3d.KTXLoader.parse;

};

v3d.KTXLoader.prototype = Object.create(v3d.CompressedTextureLoader.prototype);
v3d.KTXLoader.prototype.constructor = v3d.KTXLoader;

v3d.KTXLoader.parse = function(buffer, loadMipmaps) {
