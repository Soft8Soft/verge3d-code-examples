v3d.VRMLLoader = (function() {
    ...
    VRMLLoader.prototype = Object.assign(Object.create(v3d.Loader.prototype), {
        ...
        parse: function(data, path) {
            ...
            function buildGroupingNode(node) {
                ...
                for (var i = 0, l = fields.length; i < l; i++) {
                    ...
                    switch (fieldName) {
                        ...
                        case 'rotation':
                            var axis = new v3d.Vector3(fieldValues[0], fieldValues[1], fieldValues[2]);
            ...
            function buildBackgroundNode(node) {
                ...
                if (skyColor) {
                    ...
                    var skyGeometry = new v3d.SphereBufferGeometry(radius, 32, 16);
                    var skyMaterial = new v3d.MeshBasicMaterial({ fog: false, side: v3d.BackSide, depthWrite: false, depthTest: false });
                    ...
                    var sky = new v3d.Mesh(skyGeometry, skyMaterial);
                    group.add(sky);
                ...
                if (groundColor) {
                    ...
                    if (groundColor.length > 0) {
                        ...
                        var groundGeometry = new v3d.SphereBufferGeometry(radius, 32, 16, 0, 2 * Math.PI, 0.5 * Math.PI, 1.5 * Math.PI);
                        var groundMaterial = new v3d.MeshBasicMaterial({ fog: false, side: v3d.BackSide, vertexColors: true, depthWrite: false, depthTest: false });
            ...
            function buildShapeNode(node) {
                ...
                var material = new v3d.MeshBasicMaterial({ color: 0x000000 });
                var geometry;
                ...
                if (geometry && geometry.attributes.position) {
                    ...
                    if (type === 'points') { // points
                        ...
                        var pointsMaterial = new v3d.PointsMaterial({ color: 0xffffff });
                        ...
                        var lineMaterial = new v3d.LineBasicMaterial({ color: 0xffffff });
                    ...
                    switch (fieldName) {
                        ...
                        case 'material':
                            if (fieldValues[0] !== null) {
                                ...
                                material = new v3d.MeshBasicMaterial({ color: 0x000000 });
            ...
            function buildPixelTextureNode(node) {
                ...
                var texture;
                var wrapS = v3d.RepeatWrapping;
                var wrapT = v3d.RepeatWrapping;
            ...
            function buildIndexedFaceSetNode(node) {
                ...
                positionAttribute = toNonIndexedAttribute(triangulatedCoordIndex, new v3d.Float32BufferAttribute(coord, 3));
            ...
            function buildIndexedLineSetNode(node) {
                ...
                var positionAttribute = toNonIndexedAttribute(expandedLineIndex, new v3d.Float32BufferAttribute(coord, 3));
                geometry.setAttribute('position', positionAttribute);
            ...
            function buildBoxNode(node) {
                ...
                var size = new v3d.Vector3(2, 2, 2);
                ...
                var geometry = new v3d.BoxBufferGeometry(size.x, size.y, size.z);
            ...
            function buildConeNode(node) {
                ...
                var geometry = new v3d.ConeBufferGeometry(radius, height, 16, 1, openEnded);
            ...
            function buildCylinderNode(node) {
                ...
                var geometry = new v3d.CylinderBufferGeometry(radius, radius, height, 16, 1);
            ...
            function buildSphereNode(node) {
                ...
                var geometry = new v3d.SphereBufferGeometry(radius, 16, 16);
            ...
            function buildElevationGridNode(node) {
                ...
                var positionAttribute = toNonIndexedAttribute(indices, new v3d.Float32BufferAttribute(vertices, 3));
                var uvAttribute = toNonIndexedAttribute(indices, new v3d.Float32BufferAttribute(uvs, 2));
                var colorAttribute;
                var normalAttribute;
            ...
            function buildExtrusionNode(node) {
                ...
                var vertices = [];
                var spineVector = new v3d.Vector3();
                var scaling = new v3d.Vector3();
                ...
                if (beginCap === true || endCap === true) {
                    ...
                    var faces = v3d.ShapeUtils.triangulateShape(contour, []);
                    var capIndices = [];
            ...
            var vA = new v3d.Vector3();
            var vB = new v3d.Vector3();
            var vC = new v3d.Vector3();

            var uvA = new v3d.Vector2();
            var uvB = new v3d.Vector2();
            var uvC = new v3d.Vector2();
            ...
            function paintFaces(geometry, radius, angles, colors, topDown) {
                ...
                var colorAttribute = new v3d.BufferAttribute(new Float32Array(geometry.attributes.position.count * 3), 3);
