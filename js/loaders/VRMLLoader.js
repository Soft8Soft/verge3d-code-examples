            ...
            function buildBackgroundNode(node) {
                ...
                if (skyColor) {
                    ...
                    if (skyColor.length > 3) {
                        ...
                        skyMaterial.vertexColors = v3d.VertexColors;
                ...
                if (groundColor) {
                    ...
                    if (groundColor.length > 0) {
                        ...
                        var groundMaterial = new v3d.MeshBasicMaterial({ fog: false, side: v3d.BackSide, vertexColors: v3d.VertexColors, depthWrite: false, depthTest: false });
                ...
                if (geometry && geometry.attributes.position) {
                    ...
                    if (type === 'points') { // points
                        ...
                        if (geometry.attributes.color !== undefined) {
                            ...
                            pointsMaterial.vertexColors = v3d.VertexColors;
                        ...
                        if (geometry.attributes.color !== undefined) {
                            ...
                            lineMaterial.vertexColors = v3d.VertexColors;
