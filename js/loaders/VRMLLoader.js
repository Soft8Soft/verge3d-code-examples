...
v3d.VRMLLoader = function(manager) {

    this.manager = (manager !== undefined) ? manager : v3d.DefaultLoadingManager;

};

v3d.VRMLLoader.prototype = {

    constructor: v3d.VRMLLoader,
    ...
    parse: function(data, path) {
        ...
        function parseV2(lines, scene) {
                    ...
                    switch (fieldName) {
                        ...
                        case 'color':
                            ...
                            if (parts.length !== 4) {
                                ...
                                console.warn('v3d.VRMLLoader: Invalid color format detected for %s.', fieldName);
                                break;
                        ...
                        case 'size':
                            if (parts.length !== 4) {
                                ...
                                console.warn('v3d.VRMLLoader: Invalid vector format detected for %s.', fieldName);
                                break;
                        ...
                        case 'creaseAngle':
                            if (parts.length !== 2) {
                                ...
                                console.warn('v3d.VRMLLoader: Invalid single float value specification detected for %s.', fieldName);
                                break;
                        ...
                        case 'rotation':
                            if (parts.length !== 5) {
                                ...
                                console.warn('v3d.VRMLLoader: Invalid quaternion format detected for %s.', fieldName);
                                break;
                        ...
                        case 'convex':
                            if (parts.length !== 2) {
                                ...
                                console.warn('v3d.VRMLLoader: Invalid format detected for %s.', fieldName);
                                break;
            ...
            function parseNode(data, parent) {
                ...
                if (typeof data === 'string') {
                    ...
                    if (/USE/.exec(data)) {
                        ...
                        if (undefined == defines[defineKey]) {
                            ...
                            console.warn('v3d.VRMLLoader: %s is not defined.', defineKey);
                            ...
                            if (/appearance/.exec(data) && defineKey) {
                                ...
                                if (defines[defineKey].solid !== undefined && defines[defineKey].solid === false) {
                                    ...
                                    parent.material.side = v3d.DoubleSide;
                ...
                if (data.nodeType === 'AmbientLight') {
                    ...
                    object = new v3d.AmbientLight(l_color, l_intensity);
                    ...
                    object = new v3d.PointLight(l_color, l_intensity, l_distance);
                    object.visible = l_visible;
                    ...
                    object = new v3d.SpotLight(l_color, l_intensity, l_distance, l_angle, l_penumbra);
                    object.visible = l_visible;
                    ...
                    if (data.rotation !== undefined) {
                        ...
                        object.quaternion.setFromAxisAngle(new v3d.Vector3(r.x, r.y, r.z), r.w);
                    ...
                    var skyGeometry = new v3d.SphereBufferGeometry(radius, segments, segments);
                    var skyMaterial = new v3d.MeshBasicMaterial({ fog: false, side: v3d.BackSide });
                    ...
                    scene.add(new v3d.Mesh(skyGeometry, skyMaterial));
                    ...
                    if (data.groundColor !== undefined) {
                        ...
                        var groundGeometry = new v3d.SphereBufferGeometry(radius, segments, segments, 0, 2 * Math.PI, 0.5 * Math.PI, 1.5 * Math.PI);
                        var groundMaterial = new v3d.MeshBasicMaterial({ fog: false, side: v3d.BackSide, vertexColors: v3d.VertexColors });

                        paintFaces(groundGeometry, radius, data.groundAngle, data.groundColor, false);

                        scene.add(new v3d.Mesh(groundGeometry, groundMaterial));
                    ...
                    if (data.nodeType === 'Box') {
                        ...
                        parent.geometry = new v3d.BoxBufferGeometry(s.x, s.y, s.z);

                    } else if (data.nodeType === 'Cylinder') {

                        parent.geometry = new v3d.CylinderBufferGeometry(data.radius, data.radius, data.height);

                    } else if (data.nodeType === 'Cone') {

                        parent.geometry = new v3d.CylinderBufferGeometry(data.topRadius, data.bottomRadius, data.height);

                    } else if (data.nodeType === 'Sphere') {

                        parent.geometry = new v3d.SphereBufferGeometry(data.radius);
                        ...
                        if (colors.length > 0) {
                            ...
                            parent.material.vertexColors = v3d.VertexColors;
        ...
        if (/V1.0/.exec(header)) {
            ...
            console.warn('v3d.VRMLLoader: V1.0 not supported yet.');
