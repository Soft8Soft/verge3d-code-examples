 ...
 */
v3d.OBJLoader2 = (function() {

    var OBJLOADER2_VERSION = '2.0.0';
    var Commons = v3d.LoaderSupport.Commons;
    var Validator = v3d.LoaderSupport.Validator;
    var ConsoleLogger = v3d.LoaderSupport.ConsoleLogger;

    OBJLoader2.prototype = Object.create(v3d.LoaderSupport.Commons.prototype);
    OBJLoader2.prototype.constructor = OBJLoader2;

    function OBJLoader2(logger, manager) {
        v3d.LoaderSupport.Commons.call(this, logger, manager);
        this.logger.logInfo('Using v3d.OBJLoader2 version: ' + OBJLOADER2_VERSION);

        this.materialPerSmoothingGroup = false;
        this.fileLoader = Validator.verifyInput(this.fileLoader, new v3d.FileLoader(this.manager));
    ...
    OBJLoader2.prototype._applyPrepData = function(prepData) {
        v3d.LoaderSupport.Commons.prototype._applyPrepData.call(this, prepData);
    ...
    OBJLoader2.prototype.parseAsync = function(content, onLoad) {
        ...
        this.workerSupport = Validator.verifyInput(this.workerSupport, new v3d.LoaderSupport.WorkerSupport(this.logger));
    ...
    /**
     * Constants used by v3d.OBJLoader2
     */
    var Consts = {
        CODE_LF: 10,
        CODE_CR: 13,
     ...
     * It is defined publicly for inclusion in web worker based OBJ loader ({@link v3d.OBJLoader2.WWOBJLoader2})
     */
     ...
     * @memberOf v3d.OBJLoader2
     *
     * @param {v3d.LoaderSupport.ResourceDescriptor} resource
     * @param {function} callbackOnLoad
     * @param {string} [crossOrigin] CORS value
     */
    OBJLoader2.prototype._loadMtl = function(resource, callbackOnLoad, crossOrigin) {
        ...
        var mtlLoader = new v3d.MTLLoader();
