...
*/
    ...
    class LightningStorm extends v3d.Object3D {
        ...
        constructor(stormParams = {}) {
            ...
            this.lightningMaterial = stormParams.lightningMaterial !== undefined ? stormParams.lightningMaterial : new v3d.MeshBasicMaterial({
                color: 0xB0FFFF
            });
            ...
            if (stormParams.onRayPosition !== undefined) {
                ...
                this.onRayPosition = function(source, dest) {
                    ...
                    const height = v3d.MathUtils.lerp(stormParams.minHeight, stormParams.maxHeight, Math.random());
            ...
            for (let i = 0; i < this.stormParams.maxLightnings; i++) {
                ...
                const lightning = new v3d.LightningStrike(v3d.LightningStrike.copyParameters({}, this.lightningParameters));
                const mesh = new v3d.Mesh(lightning, this.lightningMaterial);
        ...
        update(time) {
            ...
            if (time >= this.nextLightningTime) {
                ...
                if (lightningMesh) {
                    ...
                    const lightningParams1 = v3d.LightningStrike.copyParameters(lightningMesh.geometry.rayParameters, this.lightningParameters);
    ...
    v3d.LightningStorm = LightningStorm;
