(function() {
    ...
    class Lensflare extends v3d.Mesh {

        constructor() {

            super(Lensflare.Geometry, new v3d.MeshBasicMaterial({
                opacity: 0,
                transparent: true
            }));
            this.type = 'Lensflare';
      ...
      `
            ...
            const material1b = new v3d.RawShaderMaterial({
                uniforms: {
                    'map': {
                        value: tempMap
                    },
      ...
      `
            ...
            const mesh1 = new v3d.Mesh(geometry, material1a); //
            ...
            const scale = new v3d.Vector2();
            const screenPositionPixels = new v3d.Vector2();
            const validArea = new v3d.Box2();
            const viewport = new v3d.Vector4();
    ...
    class LensflareElement {
        ...
        constructor(texture, size = 1, distance = 0, color = new v3d.Color(0xffffff)) {
  ...
  `
    ...
    Lensflare.Geometry = function() {
        ...
        const interleavedBuffer = new v3d.InterleavedBuffer(float32Array, 5);
    ...
    v3d.LensflareElement = LensflareElement;
