...
v3d.Fire = function(geometry, options) {
    ...
    this.color1 = options.color1 || new v3d.Color(0xffffff);
    this.color2 = options.color2 || new v3d.Color(0xffa000);
    this.color3 = options.color3 || new v3d.Color(0x000000);
    ...
    this.windVector = options.windVector || new v3d.Vector2(0.0, 0.75);
    ...
    this.field0 = new v3d.WebGLRenderTarget(textureWidth, textureHeight, parameters);

    this.field0.background = new v3d.Color(0x000000);

    this.field1 = new v3d.WebGLRenderTarget(textureWidth, textureHeight, parameters);

    this.field0.background = new v3d.Color(0x000000);

    this.fieldProj = new v3d.WebGLRenderTarget(textureWidth, textureHeight, parameters);

    this.field0.background = new v3d.Color(0x000000);

    if (!v3d.MathUtils.isPowerOfTwo(textureWidth) ||
         ! v3d.MathUtils.isPowerOfTwo(textureHeight)) {
    ...
    this.fieldScene = new v3d.Scene();
    this.fieldScene.background = new v3d.Color(0x000000);

    this.orthoCamera = new v3d.OrthographicCamera(textureWidth / - 2, textureWidth / 2, textureHeight / 2, textureHeight / - 2, 1, 2);
    this.orthoCamera.position.z = 1;

    this.fieldGeometry = new v3d.PlaneBufferGeometry(textureWidth, textureHeight);

    this.internalSource = new v3d.DataTexture(this.sourceData, textureWidth, textureHeight, v3d.RGBAFormat);

    // Source Shader

    var shader = v3d.Fire.SourceShader;
    this.sourceMaterial = new v3d.ShaderMaterial({
    ...
    this.sourceMesh = new v3d.Mesh(this.fieldGeometry, this.sourceMaterial);
    this.fieldScene.add(this.sourceMesh);

    // Diffuse Shader

    var shader = v3d.Fire.DiffuseShader;
    this.diffuseMaterial = new v3d.ShaderMaterial({
        uniforms: shader.uniforms,
        vertexShader: shader.vertexShader,
        fragmentShader: shader.fragmentShader,
        transparent: false
    ...
    this.diffuseMesh = new v3d.Mesh(this.fieldGeometry, this.diffuseMaterial);
    this.fieldScene.add(this.diffuseMesh);

    // Drift Shader

    shader = v3d.Fire.DriftShader;
    this.driftMaterial = new v3d.ShaderMaterial({
        uniforms: shader.uniforms,
        vertexShader: shader.vertexShader,
        fragmentShader: shader.fragmentShader,
        transparent: false
    ...
    this.driftMesh = new v3d.Mesh(this.fieldGeometry, this.driftMaterial);
    this.fieldScene.add(this.driftMesh);

    // Projection Shader 1

    shader = v3d.Fire.ProjectionShader1;
    this.projMaterial1 = new v3d.ShaderMaterial({
        uniforms: shader.uniforms,
        vertexShader: shader.vertexShader,
        fragmentShader: shader.fragmentShader,
        transparent: false
    ...
    this.projMesh1 = new v3d.Mesh(this.fieldGeometry, this.projMaterial1);
    this.fieldScene.add(this.projMesh1);

    // Projection Shader 2

    shader = v3d.Fire.ProjectionShader2;
    this.projMaterial2 = new v3d.ShaderMaterial({
        uniforms: shader.uniforms,
        vertexShader: shader.vertexShader,
        fragmentShader: shader.fragmentShader,
        transparent: false
    ...
    this.projMesh2 = new v3d.Mesh(this.fieldGeometry, this.projMaterial2);
    this.fieldScene.add(this.projMesh2);

    // Projection Shader 3

    shader = v3d.Fire.ProjectionShader3;
    this.projMaterial3 = new v3d.ShaderMaterial({
        uniforms: shader.uniforms,
        vertexShader: shader.vertexShader,
        fragmentShader: shader.fragmentShader,
        transparent: false
    ...
    this.projMesh3 = new v3d.Mesh(this.fieldGeometry, this.projMaterial3);
    ...
    if (debug) {
        ...
        shader = v3d.Fire.DebugShader;

    } else {

        shader = v3d.Fire.ColorShader;
    ...
    this.onBeforeRender = function(renderer) {
        ...
        this.material.minFilter = v3d.LinearFilter,
        this.material.magFilter = v3d.LinearFilter,
...
v3d.Fire.prototype = Object.create(v3d.Mesh.prototype);
v3d.Fire.prototype.constructor = v3d.Fire;

v3d.Fire.SourceShader = {
