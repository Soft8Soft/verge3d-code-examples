 ...
 */
    ...
    class Water extends v3d.Mesh {
        ...
        constructor(geometry, options = {}) {
            ...
            const sunDirection = options.sunDirection !== undefined ? options.sunDirection : new v3d.Vector3(0.70707, 0.70707, 0.0);
            const sunColor = new v3d.Color(options.sunColor !== undefined ? options.sunColor : 0xffffff);
            const waterColor = new v3d.Color(options.waterColor !== undefined ? options.waterColor : 0x7F7F7F);
            const eye = options.eye !== undefined ? options.eye : new v3d.Vector3(0, 0, 0);
            const distortionScale = options.distortionScale !== undefined ? options.distortionScale : 20.0;
            const side = options.side !== undefined ? options.side : v3d.FrontSide;
            const fog = options.fog !== undefined ? options.fog : false; //

            const mirrorPlane = new v3d.Plane();
            const normal = new v3d.Vector3();
            const mirrorWorldPosition = new v3d.Vector3();
            const cameraWorldPosition = new v3d.Vector3();
            const rotationMatrix = new v3d.Matrix4();
            const lookAtPosition = new v3d.Vector3(0, 0, - 1);
            const clipPlane = new v3d.Vector4();
            ...
            const mirrorShader = {
                uniforms: v3d.UniformsUtils.merge([v3d.UniformsLib['fog'], v3d.UniformsLib['lights'], {
                    ...
                    'sunColor': {
                        value: new v3d.Color(0x7F7F7F)
                    },
                    'sunDirection': {
                        value: new v3d.Vector3(0.70707, 0.70707, 0)
                    },
                    'eye': {
                        value: new v3d.Vector3()
                    },
                    'waterColor': {
                        value: new v3d.Color(0x555555)
                    }
                }]),
                vertexShader:
      /* glsl */
