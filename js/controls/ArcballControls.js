(function() {
    ...
    const _transformation = {
        camera: new v3d.Matrix4(),
        gizmos: new v3d.Matrix4()
    }; //events
    ...
    const _offset = new v3d.Vector3();

    const _gizmoMatrixStateTemp = new v3d.Matrix4();

    const _cameraMatrixStateTemp = new v3d.Matrix4();

    const _scalePointTemp = new v3d.Vector3();
    /**
 *
 ...
 */
    ...
    class ArcballControls extends v3d.EventDispatcher {
        ...
        constructor(_camera, domElement, scene = null) {
            ...
            this.onWindowResize = () => {
                ...
                const curve = new v3d.EllipseCurve(0, 0, newRadius, newRadius);
                const points = curve.getPoints(this._curvePts);
                const curveGeometry = new v3d.BufferGeometry().setFromPoints(points);
                        ...
                        switch (mouseOp) {
                            ...
                            case 'FOV':
                                if (this.camera.isPerspectiveCamera) {
                                    ...
                                    xNew = v3d.MathUtils.clamp(xNew, this.minDistance, this.maxDistance);
                                    const y = x * Math.tan(v3d.MathUtils.DEG2RAD * this.camera.fov * 0.5); //calculate new fov

                                    let newFov = v3d.MathUtils.RAD2DEG * (Math.atan(y / xNew) * 2); //check min and max fov
                                    ...
                                    const newDistance = y / Math.tan(v3d.MathUtils.DEG2RAD * (newFov / 2));
                                    size = x / newDistance;
                                    this.setFov(newFov);
                        ...
                        case STATE.FOV:
                            if (this.enableZoom && this.camera.isPerspectiveCamera) {
                                ...
                                if (restart) {
                                    ...
                                    xNew = v3d.MathUtils.clamp(xNew, this.minDistance, this.maxDistance);
                                    const y = x * Math.tan(v3d.MathUtils.DEG2RAD * this._fovState * 0.5); //calculate new fov

                                    let newFov = v3d.MathUtils.RAD2DEG * (Math.atan(y / xNew) * 2); //check min and max fov

                                    newFov = v3d.MathUtils.clamp(newFov, this.minFov, this.maxFov);
                                    const newDistance = y / Math.tan(v3d.MathUtils.DEG2RAD * (newFov / 2));
                                    size = x / newDistance;
            ...
            this.onRotateMove = () => {
                ...
                if (this.enabled && this.enableRotate) {
                    ...
                    if (!this.enablePan) {
                        ...
                        rotationPoint = new v3d.Vector3().setFromMatrixPosition(this._gizmoMatrixState);
                    ...
                    const amount = v3d.MathUtils.DEG2RAD * (this._startFingerRotation - this._currentFingerRotation);
            ...
            this.calculateTbRadius = camera => {
                ...
                if (camera.type == 'PerspectiveCamera') {
                    ...
                    const halfFovV = v3d.MathUtils.DEG2RAD * camera.fov * 0.5; //vertical fov/2 in radians
            ...
            this.drawGrid = () => {
                ...
                if (this.scene != null) {
                    ...
                    if (this.camera.isOrthographicCamera) {
                        ...
                        const halfFovV = v3d.MathUtils.DEG2RAD * this.camera.fov * 0.5;
                    ...
                    if (this._grid == null) {
                        ...
                        this._grid = new v3d.GridHelper(size, divisions, color, color);
            ...
            this.makeGizmos = (tbCenter, tbRadius) => {
                ...
                const curve = new v3d.EllipseCurve(0, 0, tbRadius, tbRadius);
                const points = curve.getPoints(this._curvePts); //geometry

                const curveGeometry = new v3d.BufferGeometry().setFromPoints(points); //material

                const curveMaterialX = new v3d.LineBasicMaterial({
                    color: 0xff8080,
                    fog: false,
                    transparent: true,
                    opacity: 0.6
                });
                const curveMaterialY = new v3d.LineBasicMaterial({
                    color: 0x80ff80,
                    fog: false,
                    transparent: true,
                    opacity: 0.6
                });
                const curveMaterialZ = new v3d.LineBasicMaterial({
                    color: 0x8080ff,
                    fog: false,
                    transparent: true,
                    opacity: 0.6
                ...
                const gizmoX = new v3d.Line(curveGeometry, curveMaterialX);
                const gizmoY = new v3d.Line(curveGeometry, curveMaterialY);
                const gizmoZ = new v3d.Line(curveGeometry, curveMaterialZ);
            ...
            this.setFov = value => {
                ...
                if (this.camera.isPerspectiveCamera) {
                    ...
                    this.camera.fov = v3d.MathUtils.clamp(value, this.minFov, this.maxFov);
                    this.camera.updateProjectionMatrix();
         ...
         */
                    ...
                    if (delta >= 0) {
                        ...
                        const angle = v3d.MathUtils.RAD2DEG * this._v2_1.angle();
        ...
        */
            ...
            this.update = () => {
                ...
                if (this.camera.isOrthographicCamera) {
                    ...
                    if (this.camera.zoom > this.maxZoom || this.camera.zoom < this.minZoom) {
                        ...
                        const newZoom = v3d.MathUtils.clamp(this.camera.zoom, this.minZoom, this.maxZoom);
                    ...
                    if (distance > this.maxDistance + EPS || distance < this.minDistance - EPS) {
                        ...
                        const newDistance = v3d.MathUtils.clamp(distance, this.minDistance, this.maxDistance);
                    ...
                    if (this.camera.fov < this.minFov || this.camera.fov > this.maxFov) {
                        ...
                        this.camera.fov = v3d.MathUtils.clamp(this.camera.fov, this.minFov, this.maxFov);
                        this.camera.updateProjectionMatrix();
            ...
            this.setStateFromJSON = json => {
                ...
                if (state.arcballState != undefined) {
                    ...
                    this._tbRadius = this.calculateTbRadius(this.camera);
                    const gizmoTmp = new v3d.Matrix4().copy(this._gizmoMatrixState0);
                    this.makeGizmos(this._gizmos.position, this._tbRadius);
            ...
            this.scene = scene;
            this.target = new v3d.Vector3();
            this._currentTarget = new v3d.Vector3();
            ...
            this._v2_1 = new v3d.Vector2();
            this._v3_1 = new v3d.Vector3();
            this._v3_2 = new v3d.Vector3();
            this._m4_1 = new v3d.Matrix4();
            this._m4_2 = new v3d.Matrix4();
            this._quat = new v3d.Quaternion(); //transformation matrices

            this._translationMatrix = new v3d.Matrix4(); //matrix for translation operation

            this._rotationMatrix = new v3d.Matrix4(); //matrix for rotation operation

            this._scaleMatrix = new v3d.Matrix4(); //matrix for scaling operation

            this._rotationAxis = new v3d.Vector3(); //axis for rotate operation
            //camera state

            this._cameraMatrixState = new v3d.Matrix4();
            this._cameraProjectionState = new v3d.Matrix4();
            this._fovState = 1;
            this._upState = new v3d.Vector3();
            this._zoomState = 1;
            this._nearPos = 0;
            this._farPos = 0;
            this._gizmoMatrixState = new v3d.Matrix4(); //initial values

            this._up0 = new v3d.Vector3();
            this._zoom0 = 1;
            this._fov0 = 0;
            this._initialNear = 0;
            this._nearPos0 = 0;
            this._initialFar = 0;
            this._farPos0 = 0;
            this._cameraMatrixState0 = new v3d.Matrix4();
            this._gizmoMatrixState0 = new v3d.Matrix4(); //pointers array
            ...
            this._currentCursorPosition = new v3d.Vector3();
            this._startCursorPosition = new v3d.Vector3(); //grid

            this._grid = null; //grid to be visualized during pan operation

            this._gridPosition = new v3d.Vector3(); //gizmos

            this._gizmos = new v3d.Group();
            ...
            this._cursorPosPrev = new v3d.Vector3(); //cursor position when previous rotate operation has been detected

            this._cursorPosCurr = new v3d.Vector3(); //cursor position when current rotate operation has been detected
   ...
   */
        ...
        setTbRadius(value) {
            ...
            this._tbRadius = this.calculateTbRadius(this.camera);
            const curve = new v3d.EllipseCurve(0, 0, this._tbRadius, this._tbRadius);
            const points = curve.getPoints(this._curvePts);
            const curveGeometry = new v3d.BufferGeometry().setFromPoints(points);
   ...
   */
    ...
    v3d.ArcballControls = ArcballControls;
