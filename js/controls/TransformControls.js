...
v3d.TransformControls = function(camera, domElement) {
    ...
    var _plane = new v3d.TransformControlsPlane();
    this.add(_plane);
    ...
    var _tempVector = new v3d.Vector3();
    var _tempVector2 = new v3d.Vector3();
    var _tempQuaternion = new v3d.Quaternion();
    var _unit = {
    ...
    var rotationAxis = new v3d.Vector3();
    var startNorm = new v3d.Vector3();
    var endNorm = new v3d.Vector3();
    var rotationAngle = 0;

    var cameraPosition = new v3d.Vector3();
    var cameraQuaternion = new v3d.Quaternion();
    var cameraScale = new v3d.Vector3();

    var parentPosition = new v3d.Vector3();
    var parentQuaternion = new v3d.Quaternion();
    var parentQuaternionInv = new v3d.Quaternion();
    var parentScale = new v3d.Vector3();

    var worldPositionStart = new v3d.Vector3();
    var worldQuaternionStart = new v3d.Quaternion();
    var worldScaleStart = new v3d.Vector3();

    var worldPosition = new v3d.Vector3();
    var worldQuaternion = new v3d.Quaternion();
    var worldQuaternionInv = new v3d.Quaternion();
    var worldScale = new v3d.Vector3();

    var eye = new v3d.Vector3();

    var positionStart = new v3d.Vector3();
    var quaternionStart = new v3d.Quaternion();
    var scaleStart = new v3d.Vector3();
...
v3d.TransformControlsGizmo = function() {
    ...
    var gizmoMaterial = new v3d.MeshBasicMaterial({
        depthTest: false,
        depthWrite: false,
        transparent: true,
        side: v3d.DoubleSide,
    ...
    var gizmoLineMaterial = new v3d.LineBasicMaterial({
        depthTest: false,
        depthWrite: false,
        transparent: true,
        linewidth: 1,
    ...
    var arrowGeometry = new v3d.CylinderBufferGeometry(0, 0.05, 0.2, 12, 1, false);
    ...
    var gizmoTranslate = {
        ...
        Y: [
            [new v3d.Mesh(arrowGeometry, matGreen), [0, 1, 0], null, null, 'fwd'],
            [new v3d.Mesh(arrowGeometry, matGreen), [0, 1, 0], [Math.PI, 0, 0], null, 'bwd'],
            [new v3d.Line(lineGeometry, matLineGreen), null, [0, 0, Math.PI / 2]]
        ],
        Z: [
    ...
    var pickerTranslate = {
        ...
        Z: [
            [new v3d.Mesh(new v3d.CylinderBufferGeometry(0.2, 0, 1, 4, 1, false), matInvisible), [0, 0, 0.6], [Math.PI / 2, 0, 0]]
        ],
        XYZ: [
            [new v3d.Mesh(new v3d.OctahedronBufferGeometry(0.2, 0), matInvisible)]
        ],
        XY: [
            [new v3d.Mesh(new v3d.PlaneBufferGeometry(0.4, 0.4), matInvisible), [0.2, 0.2, 0]]
        ],
        YZ: [
    ...
    var helperTranslate = {
        START: [
            [new v3d.Mesh(new v3d.OctahedronBufferGeometry(0.01, 2), matHelper), null, null, null, 'helper']
        ],
        END: [
            [new v3d.Mesh(new v3d.OctahedronBufferGeometry(0.01, 2), matHelper), null, null, null, 'helper']
        ],
    ...
    var gizmoRotate = {
        X: [
            [new v3d.Line(CircleGeometry(1, 0.5), matLineRed)],
        ...
        Z: [
            [new v3d.Line(CircleGeometry(1, 0.5), matLineBlue), null, [0, Math.PI / 2, 0]],
            [new v3d.Mesh(new v3d.OctahedronBufferGeometry(0.04, 0), matBlue), [0.99, 0, 0], null, [1, 3, 1]],
        ],
        E: [
        ...
        XYZE: [
            [new v3d.Line(CircleGeometry(1, 1), matLineGray), null, [0, Math.PI / 2, 0]]
        ]
    };
    ...
    var pickerRotate = {
        ...
        XYZE: [
            [new v3d.Mesh(new v3d.SphereBufferGeometry(0.7, 10, 8), matInvisible)]
        ]
    };
    ...
    var gizmoScale = {
        ...
        Y: [
            [new v3d.Mesh(scaleHandleGeometry, matGreen), [0, 0.8, 0]],
            [new v3d.Line(lineGeometry, matLineGreen), null, [0, 0, Math.PI / 2], [0.8, 1, 1]]
        ],
        Z: [
        ...
        XY: [
            ...
            [new v3d.Line(lineGeometry, matLineYellow), [0.855, 0.98, 0], null, [0.125, 1, 1]],
            [new v3d.Line(lineGeometry, matLineYellow), [0.98, 0.855, 0], [0, 0, Math.PI / 2], [0.125, 1, 1]]
        ],
        YZ: [
    ...
    var pickerScale = {
        ...
        Z: [
            [new v3d.Mesh(new v3d.CylinderBufferGeometry(0.2, 0, 0.8, 4, 1, false), matInvisible), [0, 0, 0.5], [Math.PI / 2, 0, 0]]
        ],
        XY: [
            [new v3d.Mesh(scaleHandleGeometry, matInvisible), [0.85, 0.85, 0], null, [3, 3, 0.2]],
        ],
        YZ: [
            [new v3d.Mesh(scaleHandleGeometry, matInvisible), [0, 0.85, 0.85], null, [0.2, 3, 3]],
        ],
        XZ: [
            [new v3d.Mesh(scaleHandleGeometry, matInvisible), [0.85, 0, 0.85], null, [3, 0.2, 3]],
        ],
        XYZX: [
            [new v3d.Mesh(new v3d.BoxBufferGeometry(0.2, 0.2, 0.2), matInvisible), [1.1, 0, 0]],
        ],
        XYZY: [
            [new v3d.Mesh(new v3d.BoxBufferGeometry(0.2, 0.2, 0.2), matInvisible), [0, 1.1, 0]],
        ],
        XYZZ: [
            [new v3d.Mesh(new v3d.BoxBufferGeometry(0.2, 0.2, 0.2), matInvisible), [0, 0, 1.1]],
        ]
    };
    ...
    var tempVector = new v3d.Vector3(0, 0, 0);
    var tempEuler = new v3d.Euler();
    var alignVector = new v3d.Vector3(0, 1, 0);
    var zeroVector = new v3d.Vector3(0, 0, 0);
    var lookAtMatrix = new v3d.Matrix4();
    var tempQuaternion = new v3d.Quaternion();
    var tempQuaternion2 = new v3d.Quaternion();
    var identityQuaternion = new v3d.Quaternion();
...
v3d.TransformControlsGizmo.prototype = Object.assign(Object.create(v3d.Object3D.prototype), {

    constructor: v3d.TransformControlsGizmo,
...
v3d.TransformControlsPlane = function() {

    'use strict';

    v3d.Mesh.call(this,
        new v3d.PlaneBufferGeometry(100000, 100000, 2, 2),
        new v3d.MeshBasicMaterial({ visible: false, wireframe: true, side: v3d.DoubleSide, transparent: true, opacity: 0.1 })
    );
    ...
    var dirVector = new v3d.Vector3();
    var alignVector = new v3d.Vector3();
...
v3d.TransformControlsPlane.prototype = Object.assign(Object.create(v3d.Mesh.prototype), {

    constructor: v3d.TransformControlsPlane,
