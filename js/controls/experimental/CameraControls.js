(function() {
    ...
    var CameraControls = function(object, domElement) {
        ...
        if (domElement === undefined) console.warn('v3d.CameraControls: The second parameter "domElement" is now mandatory.');
        if (domElement === document) console.error('v3d.CameraControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.');
        this.object = object;
        this.domElement = domElement; // Set to false to disable this control

        this.enabled = true; // "target" sets the location of focus, where the object orbits around

        this.target = new v3d.Vector3(); // Set to true to enable trackball behavior
        ...
        this.mouseButtons = {
            LEFT: v3d.MOUSE.ROTATE,
            MIDDLE: v3d.MOUSE.DOLLY,
            RIGHT: v3d.MOUSE.PAN
        }; // Touch fingers

        this.touches = {
            ONE: v3d.TOUCH.ROTATE,
            TWO: v3d.TOUCH.DOLLY_PAN
        }; // for reset
        ...
        this.update = function() {
            ...
            var offset = new v3d.Vector3(); // so camera.up is the orbit axis

            var quat = new v3d.Quaternion().setFromUnitVectors(object.up, new v3d.Vector3(0, 1, 0));
            var quatInverse = quat.clone().invert();
            var lastPosition = new v3d.Vector3();
            var lastQuaternion = new v3d.Quaternion();
        ...
        var spherical = new v3d.Spherical();
        var sphericalDelta = new v3d.Spherical();
        var scale = 1;
        var panOffset = new v3d.Vector3();
        var zoomChanged = false;
        var rotateStart = new v3d.Vector2();
        var rotateEnd = new v3d.Vector2();
        var rotateDelta = new v3d.Vector2();
        var panStart = new v3d.Vector2();
        var panEnd = new v3d.Vector2();
        var panDelta = new v3d.Vector2();
        var dollyStart = new v3d.Vector2();
        var dollyEnd = new v3d.Vector2();
        var dollyDelta = new v3d.Vector2();
        ...
        function onMouseDown(event) {
            ...
            switch (mouseAction) {
                ...
                case v3d.MOUSE.DOLLY:
                    if (scope.enableZoom === false) return;
                    handleMouseDownDolly(event);
                    state = STATE.DOLLY;
                    break;

                case v3d.MOUSE.ROTATE:
            ...
            switch (event.touches.length) {
                ...
                case 2:
                    switch (scope.touches.TWO) {
                        ...
                        case v3d.TOUCH.DOLLY_PAN:
                            if (scope.enableZoom === false && scope.enablePan === false) return;
                            handleTouchStartDollyPan(event);
                            state = STATE.TOUCH_DOLLY_PAN;
                            break;

                        case v3d.TOUCH.DOLLY_ROTATE:
    ...
    CameraControls.prototype = Object.create(v3d.EventDispatcher.prototype);
    ...
    var OrbitControls = function(object, domElement) {
        ...
        this.mouseButtons.LEFT = v3d.MOUSE.ROTATE;
        this.mouseButtons.RIGHT = v3d.MOUSE.PAN;
        this.touches.ONE = v3d.TOUCH.ROTATE;
        this.touches.TWO = v3d.TOUCH.DOLLY_PAN;

    };

    OrbitControls.prototype = Object.create(v3d.EventDispatcher.prototype);
    ...
    var MapControls = function(object, domElement) {
        ...
        CameraControls.call(this, object, domElement);
        this.mouseButtons.LEFT = v3d.MOUSE.PAN;
        this.mouseButtons.RIGHT = v3d.MOUSE.ROTATE;
        this.touches.ONE = v3d.TOUCH.PAN;
        this.touches.TWO = v3d.TOUCH.DOLLY_ROTATE;

    };

    MapControls.prototype = Object.create(v3d.EventDispatcher.prototype);
    ...
    TrackballControls.prototype = Object.create(v3d.EventDispatcher.prototype);
    TrackballControls.prototype.constructor = TrackballControls;

    v3d.CameraControls = CameraControls;
    v3d.MapControls = MapControls;
    v3d.OrbitControls = OrbitControls;
    v3d.TrackballControls = TrackballControls;
