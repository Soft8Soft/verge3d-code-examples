...
v3d.TrackballControls = function(object, domElement) {
    ...
    this.mouseButtons = { LEFT: v3d.MOUSE.ROTATE, MIDDLE: v3d.MOUSE.ZOOM, RIGHT: v3d.MOUSE.PAN };
    ...
    this.rotateCamera = (function() {
        ...
        var axis = new v3d.Vector3(),
            quaternion = new v3d.Quaternion(),
            eyeDirection = new v3d.Vector3(),
            objectUpDirection = new v3d.Vector3(),
            objectSidewaysDirection = new v3d.Vector3(),
            moveDirection = new v3d.Vector3(),
            angle;
    ...
    this.zoomCamera = function() {
        ...
        if (_state === STATE.TOUCH_ZOOM_PAN) {
            ...
            if (_this.object.isPerspectiveCamera) {
                ...
                console.warn('v3d.TrackballControls: Unsupported camera type');
    ...
    this.panCamera = (function() {
        ...
        var mouseChange = new v3d.Vector2(),
            objectUp = new v3d.Vector3(),
            pan = new v3d.Vector3();
...
v3d.TrackballControls.prototype = Object.create(v3d.EventDispatcher.prototype);
v3d.TrackballControls.prototype.constructor = v3d.TrackballControls;
