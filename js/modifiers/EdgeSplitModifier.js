(function() {
    ...
    const _A = new v3d.Vector3();

    const _B = new v3d.Vector3();

    const _C = new v3d.Vector3();
    ...
    class EdgeSplitModifier {
        ...
        modify(geometry, cutOffAngle, tryKeepNormals = true) {
            ...
            if (geometry.isGeometry === true) {
                ...
                console.error('v3d.EdgeSplitModifier no longer supports v3d.Geometry. Use v3d.BufferGeometry instead.');
                return;
            ...
            for (const name of Object.keys(geometry.attributes)) {
                ...
                newAttributes[name] = new v3d.BufferAttribute(newArray, oldAttribute.itemSize, oldAttribute.normalized);
            ...
            geometry.setIndex(new v3d.BufferAttribute(newIndexes, 1));
    ...
    v3d.EdgeSplitModifier = EdgeSplitModifier;
