 ...
 *
 * @input v3d.Geometry, or index'd v3d.BufferGeometry with faceUV's (Not vertex uv's)
...
v3d.Face3.prototype.set = function(a, b, c) {
...
TypedArrayHelper.prototype = {
    ...
    index_to_register: function(index, register, isLoop) {
        ...
        if (register >= this.available_registers) {
            ...
            throw new Error('v3d.BufferSubdivisionModifier: Not enough registers in TypedArrayHelper.');

        }

        if (index > this.length) {

            throw new Error('v3d.BufferSubdivisionModifier: Index is out of range in TypedArrayHelper.');
...
function convertGeometryToIndexedBuffer(geometry) {
    ...
    var BGeom = new v3d.BufferGeometry();

    // create a new typed array
    var vertArray = new TypedArrayHelper(geometry.vertices.length, 0, v3d.Vector3, Float32Array, 3, ['x', 'y', 'z']);
    var indexArray = new TypedArrayHelper(geometry.faces.length, 0, v3d.Face3, Uint32Array, 3, ['a', 'b', 'c']);
    var uvArray = new TypedArrayHelper(geometry.faceVertexUvs[0].length * 3 * 3, 0, v3d.Vector2, Float32Array, 2, ['x', 'y']);
    ...
    BGeom.setIndex(new v3d.BufferAttribute(indexArray.buffer, 3));
    BGeom.addAttribute('position', new v3d.BufferAttribute(vertArray.buffer, 3));
    BGeom.addAttribute('uv', new v3d.BufferAttribute(uvArray.buffer, 2));
...
function compute_vertex_normals(geometry) {
    ...
    var oldVertices = new TypedArrayHelper(0, 5, v3d.Vector3, Float32Array, 3, XYZ);
    var oldFaces = new TypedArrayHelper(0, 3, v3d.Face3, Uint32Array, 3, ABC);
    oldVertices.from_existing(geometry.getAttribute('position').array);
    var newNormals = new TypedArrayHelper(oldVertices.length * 3, 4, v3d.Vector3, Float32Array, 3, XYZ);
    ...
    geometry.addAttribute('normal', new v3d.BufferAttribute(newNormals.buffer, 3));
...
function unIndexIndexedGeometry(geometry) {
    ...
    var oldVertices = new TypedArrayHelper(0, 3, v3d.Vector3, Float32Array, 3, XYZ);
    var oldFaces = new TypedArrayHelper(0, 3, v3d.Face3, Uint32Array, 3, ABC);
    var oldUvs = new TypedArrayHelper(0, 3, v3d.Vector2, Float32Array, 2, XY);
    var oldNormals = new TypedArrayHelper(0, 3, v3d.Vector3, Float32Array, 3, XYZ);
    ...
    var newVertices = new TypedArrayHelper(oldFaces.length * 3, 3, v3d.Vector3, Float32Array, 3, XYZ);
    var newNormals = new TypedArrayHelper(oldFaces.length * 3, 3, v3d.Vector3, Float32Array, 3, XYZ);
    var newUvs = new TypedArrayHelper(oldFaces.length * 3, 3, v3d.Vector2, Float32Array, 2, XY);
    var v, w;
    ...
    geometry.addAttribute('position', new v3d.BufferAttribute(newVertices.buffer, 3));
    geometry.addAttribute('normal', new v3d.BufferAttribute(newNormals.buffer, 3));

    if (newUvs.length !== 0) {

        geometry.addAttribute('uv', new v3d.BufferAttribute(newUvs.buffer, 2));
...
v3d.BufferSubdivisionModifier = function(subdivisions) {

    this.subdivisions = (subdivisions === undefined) ? 1 : subdivisions;

};

v3d.BufferSubdivisionModifier.prototype.modify = function(geometry) {
    ...
    } else if (!(geometry instanceof v3d.BufferGeometry)) {

        console.error('v3d.BufferSubdivisionModifier: Geometry is not an instance of v3d.BufferGeometry or v3d.Geometry');
...
(function() {
    ...
    v3d.BufferSubdivisionModifier.prototype.smooth = function(geometry) {
        ...
        oldVertices = new TypedArrayHelper(0, 3, v3d.Vector3, Float32Array, 3, XYZ);
        oldFaces = new TypedArrayHelper(0, 3, v3d.Face3, Uint32Array, 3, ABC);
        oldUvs = new TypedArrayHelper(0, 3, v3d.Vector2, Float32Array, 2, XY);
        oldVertices.from_existing(geometry.getAttribute('position').array);
        oldFaces.from_existing(geometry.index.array);
        oldUvs.from_existing(geometry.getAttribute('uv').array);
        ...
        *******************************************************/
        ...
        newVertices = new TypedArrayHelper((geometry.getAttribute('position').array.length * 2) / 3, 2, v3d.Vector3, Float32Array, 3, XYZ);
        ...
        *******************************************************/
        ...
        newFaces = new TypedArrayHelper((geometry.index.array.length * 4) / 3, 1, v3d.Face3, Float32Array, 3, ABC);
        newUVs = new TypedArrayHelper((geometry.getAttribute('uv').array.length * 4) / 2, 3, v3d.Vector2, Float32Array, 2, XY);
        ...
        geometry.setIndex(new v3d.BufferAttribute(newFaces.buffer ,3));
        geometry.addAttribute('position', new v3d.BufferAttribute(newVertices.buffer, 3));
        geometry.addAttribute('uv', new v3d.BufferAttribute(newUVs.buffer, 2));
