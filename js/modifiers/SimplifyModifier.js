 ...
 */
    ...
    class SimplifyModifier {
        ...
        modify(geometry, count) {
            ...
            if (geometry.isGeometry === true) {
                ...
                console.error('v3d.SimplifyModifier no longer supports Geometry. Use v3d.BufferGeometry instead.');
                return;
            ...
            for (let i = 0; i < positionAttribute.count; i++) {
                ...
                const v = new v3d.Vector3().fromBufferAttribute(positionAttribute, i);
            ...
            const simplifiedGeometry = new v3d.BufferGeometry();
            const position = [];
            index = []; //
            ...
            simplifiedGeometry.setAttribute('position', new v3d.Float32BufferAttribute(position, 3));
    ...
    v3d.SimplifyModifier = SimplifyModifier;
