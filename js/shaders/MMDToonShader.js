...
`;
    const MMDToonShader = {
        ...
        uniforms: v3d.UniformsUtils.merge([v3d.ShaderLib.toon.uniforms, v3d.ShaderLib.phong.uniforms, v3d.ShaderLib.matcap.uniforms]),
        vertexShader: v3d.ShaderLib.phong.vertexShader,
        fragmentShader: v3d.ShaderLib.phong.fragmentShader.replace('#include <common>', `
                    #ifdef USE_MATCAP
    ...
    v3d.MMDToonShader = MMDToonShader;
