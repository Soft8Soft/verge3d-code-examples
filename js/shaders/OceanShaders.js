...
v3d.ShaderLib['ocean_sim_vertex'] = {
    vertexShader: [
        'varying vec2 vUV;',
...
v3d.ShaderLib['ocean_subtransform'] = {
    uniforms: {
        "u_input": { value: null },
...
v3d.ShaderLib['ocean_initial_spectrum'] = {
    uniforms: {
