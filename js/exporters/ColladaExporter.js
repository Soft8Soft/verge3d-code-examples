 ...
 *
 * Usage:
 *  var exporter = new v3d.ColladaExporter();
 *
...
v3d.ColladaExporter = function() {};

v3d.ColladaExporter.prototype = {
    ...
    parse: function(object, onDone, options) {
        ...
        function processGeometry(g) {
            ...
            if (!info) {
                ...
                if (bufferGeometry instanceof v3d.Geometry) {

                    bufferGeometry = (new v3d.BufferGeometry()).fromGeometry(bufferGeometry);
        ...
        function processMaterial(m) {
            ...
            if (matid == null) {
                ...
                if (m instanceof v3d.MeshLambertMaterial) {

                    type = 'lambert';

                } else if (m instanceof v3d.MeshBasicMaterial) {
                ...
                var emissive = m.emissive ? m.emissive : new v3d.Color(0, 0, 0);
                var diffuse = m.color ? m.color : new v3d.Color(0, 0, 0);
                var specular = m.specular ? m.specular : new v3d.Color(1, 1, 1);
        ...
        function processObject(o) {
            ...
            if (o instanceof v3d.Mesh && o.geometry != null) {
                ...
                // the materials.
                var mat = o.material || new v3d.MeshBasicMaterial();
