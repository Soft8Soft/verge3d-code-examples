 ...
 */
    ...
    class ColladaExporter {
        ...
        parse(object, onDone, options = {}) {
            ...
            function getTransform(o) {
                ...
                o.updateMatrix();
                transMat = transMat || new v3d.Matrix4();
            ...
            function processGeometry(g) {
                ...
                if (!info) {
                    ...
                    if (bufferGeometry.isBufferGeometry !== true) {
                        ...
                        throw new Error('v3d.ColladaExporter: Geometry is not of type v3d.BufferGeometry.');
                ...
                if (matid == null) {
                    ...
                    if (m.isMeshLambertMaterial === true) {
                        ...
                        if (m.map !== null) {
                            ...
                            console.warn('ColladaExporter: Texture maps not supported with v3d.MeshBasicMaterial.');

                        }

                    }

                    const emissive = m.emissive ? m.emissive : new v3d.Color(0, 0, 0);
                    const diffuse = m.color ? m.color : new v3d.Color(0, 0, 0);
                    const specular = m.specular ? m.specular : new v3d.Color(1, 1, 1);
            ...
            function processObject(o) {
                ...
                if (o.isMesh === true && o.geometry !== null) {
                    ...
                    const mat = o.material || new v3d.MeshBasicMaterial();
    ...
    v3d.ColladaExporter = ColladaExporter;
