    ...
    class OBJExporter {
        ...
        parse(object) {
            ...
            function parseMesh(mesh) {
                ...
                const normalMatrixWorld = new v3d.Matrix3();

                if (geometry.isBufferGeometry !== true) {

                    throw new Error('v3d.OBJExporter: Geometry is not of type v3d.BufferGeometry.');
