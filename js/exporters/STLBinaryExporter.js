...
v3d.STLBinaryExporter = function() {};

v3d.STLBinaryExporter.prototype = {

    constructor: v3d.STLBinaryExporter,
    ...
    parse: (function() {
        ...
        return function parse(scene) {
            ...
            scene.traverse(function(object) {
                ...
                if (! (object instanceof v3d.Mesh)) return;
                ...
                if (! (geometry instanceof v3d.Geometry)) return;
