 ...
 *
 * Usage:
 *  var exporter = new v3d.PLYExporter();
 *
...
v3d.PLYExporter = function() {};

v3d.PLYExporter.prototype = {

    constructor: v3d.PLYExporter,
        ...
        object.traverse(function(child) {
            ...
            if (child.isMesh === true) {
                ...
                if (geometry.isGeometry === true) {
                    ...
                    var bufferGeometry = geomToBufferGeom.get(geometry) || new v3d.BufferGeometry().setFromObject(mesh);
