   ...
   */
        ...
        parse(input, onDone, onError, options) {
            ...
            if (typeof onError === 'object') {
                ...
                console.warn('v3d.GLTFExporter: parse() expects options as the fourth argument now.');
                options = onError;
 ...
 */
   ...
   * @param  {Integer} format of the image (v3d.RGBAFormat)
   ...
   */
            ...
            if (options.embedImages) {
                ...
                if (typeof HTMLImageElement !== 'undefined' && image instanceof HTMLImageElement || typeof HTMLCanvasElement !== 'undefined' && image instanceof HTMLCanvasElement || typeof OffscreenCanvas !== 'undefined' && image instanceof OffscreenCanvas || typeof ImageBitmap !== 'undefined' && image instanceof ImageBitmap) {
                    ...
                    if (format !== v3d.RGBAFormat) {
                        ...
                        console.error('GLTFExporter: Only v3d.RGBAFormat is supported.');
        ...
        /**
   * Process sampler
   * @param  {Texture} map v3d.Texture to process
