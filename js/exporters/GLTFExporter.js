...
v3d.GLTFExporter.prototype = {
    ...
    parse: function(input, onDone, options) {
         ...
         * @param  {v3d.WebGLAttribute} attribute Attribute to find the min/max
         ...
         * @param  {v3d.BufferAttribute} attribute     Attribute to store
         ...
         * @param  {v3d.WebGLAttribute} attribute Attribute to process
        ...
        function processMaterial(material) {
            ...
            if (material instanceof v3d.ShaderMaterial) {
            ...
            if (! (material instanceof v3d.MeshStandardMaterial)) {

                console.warn('GLTFExporter: Currently just v3d.StandardMaterial is supported. Material conversion may lose information.');
            ...
            if (material instanceof v3d.MeshBasicMaterial ||
                material instanceof v3d.LineBasicMaterial ||
                material instanceof v3d.PointsMaterial) {
        ...
        function processMesh(mesh) {
            ...
            if (mesh instanceof v3d.LineSegments) {

                mode = WEBGL_CONSTANTS.LINES;

            } else if (mesh instanceof v3d.LineLoop) {

                mode = WEBGL_CONSTANTS.LINE_LOOP;

            } else if (mesh instanceof v3d.Line) {

                mode = WEBGL_CONSTANTS.LINE_STRIP;

            } else if (mesh instanceof v3d.Points) {
        ...
        function processCamera(camera) {
            ...
            var isOrtho = camera instanceof v3d.OrthographicCamera;
        ...
        function processNode(object) {
            ...
            if (object.userData && Object.keys(object.userData).length > 0) {
                ...
                try {
                    ...
                    throw new Error('v3d.GLTFExporter: userData can\'t be serialized');
            ...
            if (object instanceof v3d.Mesh ||
                object instanceof v3d.Line ||
                object instanceof v3d.Points) {

                gltfNode.mesh = processMesh(object);

            } else if (object instanceof v3d.Camera) {
