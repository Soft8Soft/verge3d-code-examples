...
v3d.Car = function() {
    ...
    this.wheelOffset = new v3d.Vector3();
    ...
    this.root = new v3d.Object3D();

    this.frontLeftWheelRoot = new v3d.Object3D();
    this.frontRightWheelRoot = new v3d.Object3D();
    ...
    this.loadPartsBinary = function(bodyURL, wheelURL) {
        ...
        var loader = new v3d.BinaryLoader();
    ...
    this.updateCarModel = function(delta, controls) {
        ...
        if (controls.moveForward) {
            ...
            this.speed = v3d.Math.clamp(this.speed + delta * this.FRONT_ACCELERATION, this.MAX_REVERSE_SPEED, this.MAX_SPEED);
            this.acceleration = v3d.Math.clamp(this.acceleration + delta, - 1, 1);
        ...
        if (controls.moveBackward) {
            ...
            this.speed = v3d.Math.clamp(this.speed - delta * this.BACK_ACCELERATION, this.MAX_REVERSE_SPEED, this.MAX_SPEED);
            this.acceleration = v3d.Math.clamp(this.acceleration - delta, - 1, 1);
        ...
        if (controls.moveLeft) {
            ...
            this.wheelOrientation = v3d.Math.clamp(this.wheelOrientation + delta * this.WHEEL_ANGULAR_ACCELERATION, - this.MAX_WHEEL_ROTATION, this.MAX_WHEEL_ROTATION);
        ...
        if (! (controls.moveForward || controls.moveBackward)) {
            ...
            if (this.speed > 0) {
                ...
                this.speed = v3d.Math.clamp(this.speed - k * delta * this.FRONT_DECCELERATION, 0, this.MAX_SPEED);
                this.acceleration = v3d.Math.clamp(this.acceleration - k * delta, 0, 1);

            } else {

                var k = exponentialEaseOut(this.speed / this.MAX_REVERSE_SPEED);

                this.speed = v3d.Math.clamp(this.speed + k * delta * this.BACK_ACCELERATION, this.MAX_REVERSE_SPEED, 0);
                this.acceleration = v3d.Math.clamp(this.acceleration + k * delta, - 1, 0);
        ...
        if (! (controls.moveLeft || controls.moveRight)) {
            ...
            if (this.wheelOrientation > 0) {
                ...
                this.wheelOrientation = v3d.Math.clamp(this.wheelOrientation - delta * this.WHEEL_ANGULAR_DECCELERATION, 0, this.MAX_WHEEL_ROTATION);

            } else {

                this.wheelOrientation = v3d.Math.clamp(this.wheelOrientation + delta * this.WHEEL_ANGULAR_DECCELERATION, - this.MAX_WHEEL_ROTATION, 0);
    ...
    function createCar () {
        ...
        if (scope.bodyGeometry && scope.wheelGeometry) {
            ...
            scope.bodyMesh = new v3d.Mesh(scope.bodyGeometry, bodyFaceMaterial);
            ...
            delta.multiplyVectors(scope.wheelOffset, new v3d.Vector3(s, s, s));

            scope.frontLeftWheelRoot.position.add(delta);

            scope.frontLeftWheelMesh = new v3d.Mesh(scope.wheelGeometry, wheelFaceMaterial);
            ...
            scope.frontRightWheelMesh = new v3d.Mesh(scope.wheelGeometry, wheelFaceMaterial);
            ...
            scope.backLeftWheelMesh = new v3d.Mesh(scope.wheelGeometry, wheelFaceMaterial);
            ...
            scope.backRightWheelMesh = new v3d.Mesh(scope.wheelGeometry, wheelFaceMaterial);
