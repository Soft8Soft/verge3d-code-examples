...
v3d.PMREMGenerator = function(sourceTexture, samplesPerLevel, resolution) {

    this.sourceTexture = sourceTexture;
    this.resolution = (resolution !== undefined) ? resolution : 256; // NODE: 256 is currently hard coded in the glsl code for performance reasons
    this.samplesPerLevel = (samplesPerLevel !== undefined) ? samplesPerLevel : 16;

    var monotonicEncoding = (sourceTexture.encoding === v3d.LinearEncoding) ||
        (sourceTexture.encoding === v3d.GammaEncoding) || (sourceTexture.encoding === v3d.sRGBEncoding);
    ...
    this.camera = new v3d.OrthographicCamera(- 1, 1, 1, - 1, 0.0, 1000);
    ...
    getShader: function() {
        ...
        return new v3d.ShaderMaterial({
            ...
            uniforms: {
                ...
                "mapSize": { value: 0.5 },
                "envMap": { value: null },
                "queryScale": { value: new v3d.Vector3(1, 1, 1) },
