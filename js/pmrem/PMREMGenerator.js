...
v3d.PMREMGenerator = (function() {

    var shader = getShader();
    var camera = new v3d.OrthographicCamera(- 1, 1, 1, - 1, 0.0, 1000);
    var scene = new v3d.Scene();
    var planeMesh = new v3d.Mesh(new v3d.PlaneBufferGeometry(2, 2, 0), shader);
    ...
    var PMREMGenerator = function(sourceTexture, samplesPerLevel, resolution) {
        ...
        var monotonicEncoding = (this.sourceTexture.encoding === v3d.LinearEncoding) ||
            (this.sourceTexture.encoding === v3d.GammaEncoding) || (this.sourceTexture.encoding === v3d.sRGBEncoding);

        this.sourceTexture.minFilter = (monotonicEncoding) ? v3d.LinearFilter : v3d.NearestFilter;
        this.sourceTexture.magFilter = (monotonicEncoding) ? v3d.LinearFilter : v3d.NearestFilter;
        ...
        for (var i = 0; i < this.numLods; i++) {
            ...
            var renderTarget = new v3d.WebGLRenderTargetCube(size, size, params);
    ...
    PMREMGenerator.prototype = {
        ...
        update: function(renderer) {
            ...
            // a Texture created via v3d.WebGLRenderTargetCube.
