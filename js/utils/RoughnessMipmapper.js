 ...
 */
    ...
    const _mesh = new v3d.Mesh(new v3d.PlaneGeometry(2, 2), _mipmapMaterial);

    const _flatCamera = new v3d.OrthographicCamera(0, 1, 0, 1, 0, 1);
    ...
    class RoughnessMipmapper {
        ...
        generateMipmaps(material) {
            ...
            if (!v3d.MathUtils.isPowerOfTwo(width) || ! v3d.MathUtils.isPowerOfTwo(height)) return;
            ...
            if (_tempTarget === null || _tempTarget.width !== width || _tempTarget.height !== height) {
                ...
                _tempTarget = new v3d.WebGLRenderTarget(width, height, {
                    depthBuffer: false
                });
            ...
            if (width !== roughnessMap.image.width || height !== roughnessMap.image.height) {
                ...
                const newRoughnessTarget = new v3d.WebGLRenderTarget(width, height, params);
            ...
            const position = new v3d.Vector2(0, 0);
    ...
    function _getMipmapMaterial() {
        ...
        const shaderMaterial = new v3d.RawShaderMaterial({
            uniforms: {
                roughnessMap: {
                    value: null
                },
    ...
    v3d.RoughnessMipmapper = RoughnessMipmapper;
