 ...
 */
    ...
    class EncodingFuncs {
        ...
        static quantizedEncode(array, bytes) {
            ...
            const decodeMat = new v3d.Matrix4();
            ...
            decodeMat.scale(new v3d.Vector3((max[0] - min[0]) / segments, (max[1] - min[1]) / segments, (max[2] - min[2]) / segments));
        ...
        static quantizedEncodeUV(array, bytes) {
            ...
            const decodeMat = new v3d.Matrix3();
 ...
 */
    ...
    class PackedPhongMaterial extends v3d.MeshPhongMaterial {
        ...
        constructor(parameters) {
            ...
            this.vertexShader = ['#define PHONG', 'varying vec3 vViewPosition;', '#ifndef FLAT_SHADED', 'varying vec3 vNormal;', '#endif', v3d.ShaderChunk.common, v3d.ShaderChunk.uv_pars_vertex, v3d.ShaderChunk.uv2_pars_vertex, v3d.ShaderChunk.displacementmap_pars_vertex, v3d.ShaderChunk.envmap_pars_vertex, v3d.ShaderChunk.color_pars_vertex, v3d.ShaderChunk.fog_pars_vertex, v3d.ShaderChunk.morphtarget_pars_vertex, v3d.ShaderChunk.skinning_pars_vertex, v3d.ShaderChunk.shadowmap_pars_vertex, v3d.ShaderChunk.logdepthbuf_pars_vertex, v3d.ShaderChunk.clipping_planes_pars_vertex, `#ifdef USE_PACKED_NORMAL
                ...
                #endif
                `, v3d.ShaderChunk.morphnormal_vertex, v3d.ShaderChunk.skinbase_vertex, v3d.ShaderChunk.skinnormal_vertex, v3d.ShaderChunk.defaultnormal_vertex, '#ifndef FLAT_SHADED', '    vNormal = normalize(transformedNormal);', '#endif', v3d.ShaderChunk.begin_vertex, `#ifdef USE_PACKED_POSITION
                    #if USE_PACKED_POSITION == 0
    ...
    v3d.GeometryCompressionUtils = GeometryCompressionUtils;
