...
v3d.TypedArrayUtils.quicksortIP = function(arr, eleSize, orderElement) {
 ...
 *
 * If you want to further minimize memory usage, remove Node.depth and replace in search algorithm with a traversal to root node (see comments at v3d.TypedArrayUtils.Kdtree.prototype.Node)
 */

v3d.TypedArrayUtils.Kdtree = function(points, metric, eleSize) {
    ...
    function buildTree(points, depth, parent, pos) {
        ...
        v3d.TypedArrayUtils.quicksortIP(points, eleSize, dim);
    ...
    this.nearest = function(point, maxNodes, maxDistance) {
        ...
        */
        ...
        bestNodes = new v3d.TypedArrayUtils.Kdtree.BinaryHeap(
 ...
 */
v3d.TypedArrayUtils.Kdtree.prototype.Node = function(obj, depth, parent, pos) {
...
v3d.TypedArrayUtils.Kdtree.BinaryHeap = function(scoreFunction) {
...
v3d.TypedArrayUtils.Kdtree.BinaryHeap.prototype = {
