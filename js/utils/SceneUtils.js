(function() {
    ...
    v3d.SceneUtils = {};
    v3d.SceneUtils.attach = attach;
    v3d.SceneUtils.createMeshesFromInstancedMesh = createMeshesFromInstancedMesh;
    v3d.SceneUtils.createMultiMaterialObject = createMultiMaterialObject;
    v3d.SceneUtils.detach = detach;
