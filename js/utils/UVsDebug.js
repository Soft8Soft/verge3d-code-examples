 ...
 *
 * Sample usage:
 *    document.body.appendChild(UVsDebug(new v3d.SphereGeometry(10, 10, 10, 10));
 *
 */
    ...
    function UVsDebug(geometry, size = 1024) {
        ...
        const abc = 'abc';
        const a = new v3d.Vector2();
        const b = new v3d.Vector2();
        const uvs = [new v3d.Vector2(), new v3d.Vector2(), new v3d.Vector2()];
        const face = [];
        ...
        if (geometry.isGeometry) {
            ...
            console.error('v3d.UVsDebug no longer supports Geometry. Use v3d.BufferGeometry instead.');
            return;
