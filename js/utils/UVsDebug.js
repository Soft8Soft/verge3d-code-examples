 ...
 *
 * Sample usage:
 *    document.body.appendChild(v3d.UVsDebug(new v3d.SphereGeometry(10, 10, 10, 10));
 *
 */
...
v3d.UVsDebug = function(geometry, size) {
    ...
    var geo = (geometry instanceof v3d.BufferGeometry) ? new v3d.Geometry().fromBufferGeometry(geometry) : geometry;
