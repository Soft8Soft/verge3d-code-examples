(function() {
    ...
    class LDrawUtils {
        ...
        static mergeObject(object) {
            ...
            function extractGroup(geometry, group, elementSize, isConditionalLine) {
                ...
                newGeometry.setAttribute('position', new v3d.BufferAttribute(positions, 3));
                if (normals !== null) newGeometry.setAttribute('normal', new v3d.BufferAttribute(normals, 3));
                ...
                if (isConditionalLine) {
                    ...
                    newGeometry.setAttribute('control0', new v3d.BufferAttribute(controlArray0, 3, false));
                    newGeometry.setAttribute('control1', new v3d.BufferAttribute(controlArray1, 3, false));
                    newGeometry.setAttribute('direction', new v3d.BufferAttribute(directionArray, 3, false));
            ...
            const mergedObject = new v3d.Group();
            ...
            for (const i in meshMaterialsIds) {
                ...
                const mergedGeometry = v3d.mergeBufferGeometries(meshGeometry.arr);
                mergedObject.add(new v3d.Mesh(mergedGeometry, meshGeometry.mat));
            ...
            for (const i in linesMaterialsIds) {
                ...
                const mergedGeometry = v3d.mergeBufferGeometries(lineGeometry.arr);
                mergedObject.add(new v3d.LineSegments(mergedGeometry, lineGeometry.mat));
            ...
            for (const i in condLinesMaterialsIds) {
                ...
                const mergedGeometry = v3d.mergeBufferGeometries(condLineGeometry.arr);
                const condLines = new v3d.LineSegments(mergedGeometry, condLineGeometry.mat);
    ...
    v3d.LDrawUtils = {};
    v3d.LDrawUtils.LDrawUtils = LDrawUtils;
