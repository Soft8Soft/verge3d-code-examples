...
v3d.TranslucentShader = function TranslucentShader() {
    ...
    this.uniforms = v3d.UniformsUtils.merge([
...

        {
            ...
            "diffuse":  { value: new v3d.Color(0xffffff) },
            "specular": { value: new v3d.Color(0xffffff) },
            "emissive": { value: new v3d.Color(0x000000) },
            "opacity": { value: 1 },
            "shininess": { value: 1 },
