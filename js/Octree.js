...
(function(v3d) {
    ...
    v3d.Octree = function(parameters) {
        ...
        if (this.scene) {
            ...
            var helper = new v3d.BoxHelper(new v3d.Mesh(new v3d.BoxBufferGeometry(1, 1, 1)), 0xff0066);
    ...
    v3d.OctreeNode = function(parameters) {
        ...
        if (this.tree.scene) {
            ...
            this.visual = new v3d.LineSegments(this.tree.visualGeometry, this.tree.visualMaterial);
