 ...
 */
 (function(v3d) {
    ...
    v3d.Octree = function(parameters) {
        ...
        this.utilVec31Search = new v3d.Vector3();
        this.utilVec32Search = new v3d.Vector3();
        ...
        if (this.scene) {
            ...
            this.visualGeometry = new v3d.BoxGeometry(1, 1, 1);
            this.visualMaterial = new v3d.MeshBasicMaterial({ color: 0xFF0066, wireframe: true, wireframeLinewidth: 1 });
        ...
        this.root = parameters.root instanceof v3d.OctreeNode ? parameters.root : new v3d.OctreeNode(parameters);
        
    };

    v3d.Octree.prototype = {
        ...
        addDeferred: function(object, options) {
            ...
            if (object instanceof v3d.OctreeObjectData) {
            ...
            if (! object.uuid) {
                ...
                object.uuid = v3d.Math.generateUUID();
        ...
        addObjectData: function(object, part) {
            ...
            var objectData = new v3d.OctreeObjectData(object, part);
        ...
        extend: function(octree) {
            ...
            if (octree instanceof v3d.Octree) {
        ...
        rebuild: function() {
            ...
            for (i = 0, l = this.objectsData.length; i < l; i++) {
                ...
                if (node instanceof v3d.OctreeNode && ! objectData.positionLast.equals(objectData.position)) {
        ...
        search: function(position, radius, organizeByObject, direction) {
            ...
            if (direction instanceof v3d.Vector3) {
        ...
        setRoot: function(root) { 
            ...
            if (root instanceof v3d.OctreeNode) {
    ...
    v3d.OctreeObjectData = function(object, part) {
        ...
        if (part instanceof v3d.Face3) {
            
            this.faces = part;
            this.face3 = true;
            this.utilVec31FaceBounds = new v3d.Vector3();
            
        } else if (part instanceof v3d.Vector3) {
        ...
        if (this.object instanceof v3d.Object3D) {
    ...
    v3d.OctreeObjectData.prototype = {
        ...
        getFace3BoundingRadius: function(object, face) {
            ...
            if (face.centroid === undefined) face.centroid = new v3d.Vector3();
    ...
    v3d.OctreeNode = function(parameters) {
        
        // utility
        
        this.utilVec31Branch = new v3d.Vector3();
        this.utilVec31Expand = new v3d.Vector3();
        this.utilVec31Ray = new v3d.Vector3();
        ...
        if (parameters.tree instanceof v3d.Octree) {
            
            this.tree = parameters.tree;
            
        } else if (parameters.parent instanceof v3d.OctreeNode !== true) {
            
            parameters.root = this;
            
            this.tree = new v3d.Octree(parameters);
        ...
        this.position = parameters.position instanceof v3d.Vector3 ? parameters.position : new v3d.Vector3();
        ...
        if (this.tree.scene) {
            ...
            this.visual = new v3d.Mesh(this.tree.visualGeometry, this.tree.visualMaterial);
    ...
    v3d.OctreeNode.prototype = {
        ...
        updateProperties: function() {
            ...
            if (this.parent instanceof v3d.OctreeNode) {
        ...
        addObject: function(object) {
            ...
            } else if (indexOctant < - 1 && this.parent instanceof v3d.OctreeNode) {
        ...
        branch: function(indexOctant) {
            ...
            if (this.nodesByIndex[indexOctant] instanceof v3d.OctreeNode) {
                ...
                position = new v3d.Vector3().addVectors(this.position, offset);
                
                // node
                
                node = new v3d.OctreeNode({
                    tree: this.tree,
                    parent: this,
                    position: position,
                    radius: radius,
        ...
        checkMerge: function() {
            ...
            while (nodeParent.parent instanceof v3d.OctreeNode && nodeParent.getObjectCountEnd() < this.tree.objectsThreshold) {
        ...
        checkContract: function() {
            ...
            if (this.nodesIndices.length > 0) {
                ...
                for (i = 0, l = this.nodesIndices.length; i < l; i++) {
                    ...
                    if (nodeHeaviest instanceof v3d.OctreeNode === false || nodeObjectsCount > nodeHeaviestObjectsCount) {
                ...
                if (outsideHeaviestObjectsCount < this.tree.objectsThreshold && nodeHeaviest instanceof v3d.OctreeNode) {
        ...
        getOctantIndex: function(objectData) {
            ...
            if (objectData instanceof v3d.OctreeObjectData) {
            ...
            } else if (objectData instanceof v3d.OctreeNode) {
        ...
        getObjectCountStart: function() {
            ...
            while (parent instanceof v3d.OctreeNode) {
    ...
    v3d.Raycaster.prototype.intersectOctreeObject = function(object, recursive) {
        ...
        if (object.object instanceof v3d.Object3D) {
    ...
    v3d.Raycaster.prototype.intersectOctreeObjects = function(objects, recursive) {
