 ...
 */
    ...
    class BokehPass extends v3d.Pass {
        ...
        constructor(scene, camera, params) {
            ...
            this.materialDepth.blending = v3d.NoBlending; // bokeh material
            ...
            const bokehShader = v3d.BokehShader;
            const bokehUniforms = v3d.UniformsUtils.clone(bokehShader.uniforms);
            ...
            this.fsQuad = new v3d.FullScreenQuad(this.materialBokeh);
