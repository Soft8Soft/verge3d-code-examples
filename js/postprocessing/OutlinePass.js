(function() {
    ...
    class OutlinePass extends v3d.Pass {
        ...
        constructor(resolution, scene, camera, selectedObjects) {
            ...
            if (v3d.CopyShader === undefined) console.error('v3d.OutlinePass relies on v3d.CopyShader');
        ...
        render(renderer, writeBuffer, readBuffer, deltaTime, maskActive) {
            ...
            if (this.selectedObjects.length > 0) {
                ...
                } // 3. Apply Edge Detection v3d.Pass
        ...
        getEdgeDetectionMaterial() {
            ...
            return new v3d.ShaderMaterial({
                uniforms: {
                    ...
                    'visibleEdgeColor': {
                        value: new v3d.Vector3(1.0, 1.0, 1.0)
                    },
                    'hiddenEdgeColor': {
                        value: new v3d.Vector3(1.0, 1.0, 1.0)
                    }
    ...
    OutlinePass.BlurDirectionX = new v3d.Vector2(1.0, 0.0);
    OutlinePass.BlurDirectionY = new v3d.Vector2(0.0, 1.0);

    v3d.OutlinePass = OutlinePass;
