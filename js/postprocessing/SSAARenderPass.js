(function() {
    ...
    /**
*
* Supersample Anti-Aliasing Render v3d.Pass
*
...
*/
    ...
    class SSAARenderPass extends v3d.Pass {
        ...
        constructor(scene, camera, clearColor, clearAlpha) {
            ...
            this.fsQuad = new v3d.FullScreenQuad(this.copyMaterial);
        ...
        render(renderer, writeBuffer, readBuffer) {
            ...
            if (!this.sampleRenderTarget) {
                ...
                this.sampleRenderTarget = new v3d.WebGLRenderTarget(readBuffer.width, readBuffer.height, {
    ...
    v3d.SSAARenderPass = SSAARenderPass;
