...
v3d.SSAARenderPass = function(scene, camera, clearColor, clearAlpha) {
...
v3d.SSAARenderPass.prototype = Object.assign(Object.create(v3d.Pass.prototype), {

    constructor: v3d.SSAARenderPass,
    ...
    render: function(renderer, writeBuffer, readBuffer) {
        ...
        var jitterOffsets = v3d.SSAARenderPass.JitterVectors[Math.max(0, Math.min(this.sampleLevel, 5))];
...
v3d.SSAARenderPass.JitterVectors = [
    [
        [0, 0]
    ],
    [
