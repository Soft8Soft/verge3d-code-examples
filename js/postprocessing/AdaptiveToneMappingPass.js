 ...
 */
    ...
    class AdaptiveToneMappingPass extends v3d.Pass {
        ...
        constructor(adaptive, resolution) {
            ...
            if (v3d.CopyShader === undefined) console.error('v3d.AdaptiveToneMappingPass relies on v3d.CopyShader');
            ...
            if (v3d.LuminosityShader === undefined) console.error('v3d.AdaptiveToneMappingPass relies on v3d.LuminosityShader');
            ...
            if (v3d.ToneMapShader === undefined) console.error('v3d.AdaptiveToneMappingPass relies on v3d.ToneMapShader');
        ...
        reset() {
            ...
            this.fsQuad.material = new v3d.MeshBasicMaterial({
                color: 0x777777
            });
    ...
    v3d.AdaptiveToneMappingPass = AdaptiveToneMappingPass;
