...
v3d.SSAOPass = function(scene, camera, width, height) {
    ...
    if (v3d.SSAOShader === undefined) {
        ...
        console.warn('v3d.SSAOPass depends on v3d.SSAOShader');
        return new v3d.ShaderPass();

    }

    v3d.ShaderPass.call(this, v3d.SSAOShader);
 ...
 */
v3d.SSAOPass.prototype.render = function(renderer, writeBuffer, readBuffer, delta, maskActive) {
    ...
    //SSAO shaderPass
    v3d.ShaderPass.prototype.render.call(this, renderer, writeBuffer, readBuffer, delta, maskActive);
 ...
 * @param {Camera} camera
 */
v3d.SSAOPass.prototype.setCamera = function(camera) {
 ...
 * @param {Number} height
 */
v3d.SSAOPass.prototype.setSize = function(width, height) {
