 ...
 */
v3d.UnrealBloomPass = function(resolution, strength, radius, threshold) {
    ...
    if (v3d.LuminosityHighPassShader === undefined)
        console.error("v3d.UnrealBloomPass relies on v3d.LuminosityHighPassShader");

    var highPassShader = v3d.LuminosityHighPassShader;
    ...
    this.bloomTintColors = [new v3d.Vector3(1, 1, 1), new v3d.Vector3(1, 1, 1), new v3d.Vector3(1, 1, 1),
                             new v3d.Vector3(1, 1, 1), new v3d.Vector3(1, 1, 1)];
...
v3d.UnrealBloomPass.prototype = Object.assign(Object.create(v3d.Pass.prototype), {

    constructor: v3d.UnrealBloomPass,
...
v3d.UnrealBloomPass.BlurDirectionX = new v3d.Vector2(1.0, 0.0);
v3d.UnrealBloomPass.BlurDirectionY = new v3d.Vector2(0.0, 1.0);
