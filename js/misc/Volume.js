 ...
 */
v3d.Volume = function(xLength, yLength, zLength, type, arrayBuffer) {
    ...
    if (arguments.length > 0) {
        ...
        switch (type) {
            ...
            case 'uint64' :
            case 'uint64_t' :
                throw 'Error in v3d.Volume constructor : this type is not supported in JavaScript';
                break;
            case 'Float32' :
            case 'float32' :
            case 'float' :
        ...
        if (this.data.length !== this.xLength * this.yLength * this.zLength) {
            ...
            throw 'Error in v3d.Volume constructor, lengths are not matching arrayBuffer size';
    ...
    this.offset = [0, 0, 0];
    /**
     * @member {v3d.Martrix3} matrix The IJK to RAS matrix
     */
    this.matrix = new v3d.Matrix3();
    this.matrix.identity();
    /**
     * @member {v3d.Martrix3} inverseMatrix The RAS to IJK matrix
     */
    /**
    ...
    extractPerpendicularPlane: function(axis, RASIndex) {
        ...
        switch (axis) {
            ...
            case 'x' :
                ...
                IJKIndex = new v3d.Vector3(RASIndex, 0, 0);

                planeMatrix.multiply((new v3d.Matrix4()).makeRotationY(Math.PI / 2));
                positionOffset = (volume.RASDimensions[0] - 1) / 2;
                planeMatrix.setPosition(new v3d.Vector3(RASIndex - positionOffset, 0, 0));
                break;
            case 'y' :
                axisInIJK.set(0, 1, 0);
                ...
                IJKIndex = new v3d.Vector3(0, RASIndex, 0);

                planeMatrix.multiply((new v3d.Matrix4()).makeRotationX(- Math.PI / 2));
                positionOffset = (volume.RASDimensions[1] - 1) / 2;
                planeMatrix.setPosition(new v3d.Vector3(0, RASIndex - positionOffset, 0));
                break;
            case 'z' :
            default :
                axisInIJK.set(0, 0, 1);
                ...
                firstSpacing = this.spacing[0];
                secondSpacing = this.spacing[1];
                IJKIndex = new v3d.Vector3(0, 0, RASIndex);
        ...
        var base = [new v3d.Vector3(1, 0, 0), new v3d.Vector3(0, 1, 0), new v3d.Vector3(0, 0, 1)];
