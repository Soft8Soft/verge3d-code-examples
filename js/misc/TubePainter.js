(function() {
    ...
    function TubePainter() {
        ...
        const positions = new v3d.BufferAttribute(new Float32Array(BUFFER_SIZE), 3);
        positions.usage = v3d.DynamicDrawUsage;
        const normals = new v3d.BufferAttribute(new Float32Array(BUFFER_SIZE), 3);
        normals.usage = v3d.DynamicDrawUsage;
        const colors = new v3d.BufferAttribute(new Float32Array(BUFFER_SIZE), 3);
        colors.usage = v3d.DynamicDrawUsage;
        ...
        const point1 = new v3d.Vector3();
        const point2 = new v3d.Vector3();
        const matrix1 = new v3d.Matrix4();
        const matrix2 = new v3d.Matrix4();
