(function() {
    ...
    class MorphBlendMesh extends v3d.Mesh {
        ...
        update(delta) {
            ...
            for (let i = 0, il = this.animationsList.length; i < il; i++) {
                ...
                const keyframe = animation.start + v3d.MathUtils.clamp(Math.floor(animation.time / frameTime), 0, animation.length - 1);
    ...
    v3d.MorphBlendMesh = MorphBlendMesh;
