(function() {
    ...
    class MD2CharacterComplex {
        ...
        loadParts(config) {
            ...
            const loader = new v3d.MD2Loader();
        ...
        updateMovementModel(delta) {
            ...
            if (controls.moveBackward) this.speed = v3d.MathUtils.clamp(this.speed - delta * this.backAcceleration, this.maxReverseSpeed, this.maxSpeed); // orientation based on controls
    ...
    v3d.MD2CharacterComplex = MD2CharacterComplex;
