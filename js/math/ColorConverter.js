(function() {
    ...
    class ColorConverter {
        ...
        static setHSV(color, h, s, v) {
            ...
            h = v3d.MathUtils.euclideanModulo(h, 1);
            s = v3d.MathUtils.clamp(s, 0, 1);
            v = v3d.MathUtils.clamp(v, 0, 1);
        ...
        static getHSV(color, target) {
            ...
            if (target === undefined) {
                ...
                console.warn('v3d.ColorConverter: .getHSV() target is now required');
                target = {
                    h: 0,
                    s: 0,
                    l: 0
        ...
        static getCMYK(color, target) {
            ...
            if (target === undefined) {
                ...
                console.warn('v3d.ColorConverter: .getCMYK() target is now required');
                target = {
                    c: 0,
                    m: 0,
                    y: 0,
    ...
    v3d.ColorConverter = ColorConverter;
