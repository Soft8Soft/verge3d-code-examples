var Qrcode = function() {
    ...
    var color1 = new v3d.Color(0x000000);
    var color2 = new v3d.Color(0xc0c0c0);
    ...
    function f3(a, b, c, color) {
        ...
        scope.faces.push(new v3d.Face3(a, b, c, undefined, color));

    }

    function f4(a, b, c, d, color) {

        scope.faces.push(new v3d.Face3(a, b, d, undefined, color));
        scope.faces.push(new v3d.Face3(b, c, d, undefined, color));

    }

}

Qrcode.prototype = Object.create(v3d.Geometry.prototype);
