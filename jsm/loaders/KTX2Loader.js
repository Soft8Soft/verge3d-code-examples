...
class KTX2Container {
    ...
    constructor(basisModule, arrayBuffer) {
        ...
        if (id[0] !== 0xAB || // '´'
            ...
            throw new Error('v3d.KTX2Loader: Missing KTX 2.0 identifier.');
        ...
        if (this.header.pixelDepth > 0) {
            ...
            throw new Error('v3d.KTX2Loader: Only 2D textures are currently supported.');

        }

        if (this.header.arrayElementCount > 1) {

            throw new Error('v3d.KTX2Loader: Array textures are not currently supported.');

        }

        if (this.header.faceCount > 1) {

            throw new Error('v3d.KTX2Loader: Cube textures are not currently supported.');
        ...
        if (this.header.vkFormat !== 0x00 /* VK_FORMAT_UNDEFINED */ &&
            ...
            throw new Error('v3d.KTX2Loader: Only Basis Universal supercompression is currently supported.');
    ...
    async initMipmaps(transcoder, config) {
        ...
        if (!this.basisModule.isFormatSupported(targetFormat, texFormat)) {
            ...
            throw new Error('v3d.KTX2Loader: Selected texture format not supported by current transcoder build.');
        ...
        for (var level = 0; level < this.header.levelCount; level ++) {
            ...
            for (var imageIndex = 0; imageIndex < numImagesInLevel; imageIndex ++) {
                ...
                if (result.transcodedImage === undefined) {
                    ...
                    throw new Error('v3d.KTX2Loader: Unable to transcode image.');
...
class KTX2BufferReader {
    ...
    nextUint64() {
        ...
        if (!Number.isSafeInteger(value)) {
            ...
            console.warn('v3d.KTX2Loader: ' + value + ' exceeds MAX_SAFE_INTEGER. Precision may be lost.');
