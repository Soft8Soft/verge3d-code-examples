    ...
    constructor(manager) {
        ...
        if (typeof MSC_TRANSCODER !== 'undefined') {
            ...
            console.warn(
                ...
                'v3d.KTX2Loader: Please update to latest "basis_transcoder".'
        ...
        if (!this.transcoderPending) {
            ...
            if (_activeLoaders > 0) {
                ...
                console.warn(
                    ...
                    'v3d.KTX2Loader: Multiple active KTX2 loaders may cause performance issues.'
...
async function createDataTexture(container) {
    ...
    if (FORMAT_MAP[vkFormat] === undefined) {
        ...
        throw new Error('v3d.KTX2Loader: Unsupported vkFormat.');
    ...
    if (container.supercompressionScheme === KHR_SUPERCOMPRESSION_NONE) {
        ...
        throw new Error('v3d.KTX2Loader: Unsupported supercompressionScheme.');
