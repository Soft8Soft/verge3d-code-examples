        ...
        switch (obj.objectType) {
            ...
            case 'Light':
                ...
                if (geometry.isDirectionalLight) {
                    ...
                    console.warn('v3d.3DMLoader:  No conversion exists for linear lights.');
...
Rhino3dmLoader.Rhino3dmWorker = function() {
            ...
            for (var j = 0; j < textureTypes.length; j ++) {
                ...
                if (_texture) {
                    ...
                    if (image) {
                        ...
                        console.warn(`v3d.3DMLoader: Image for ${textureType} texture not embedded in file.`);
                        texture.image = null;
    ...
    function extractObjectData(object, doc) {
        ...
        switch (objectType) {
            ...
            default:
                console.warn(`v3d.3DMLoader: TODO: Implement ${objectType.constructor.name}`);
                break;
        ...
        if (Array.isArray(geometry) === false || geometry.length > 0) {
            ...
            console.warn('v3d.3DMLoader: Object has no mesh geometry. Consider opening this in Rhino, using a shaded display mode, and exporting again.');
