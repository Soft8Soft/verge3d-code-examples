...
class AdaptiveToneMappingPass extends Pass {
    ...
    constructor(adaptive, resolution) {
        ...
        if (CopyShader === undefined) console.error('v3d.AdaptiveToneMappingPass relies on CopyShader');
        ...
        if (LuminosityShader === undefined)
            console.error('v3d.AdaptiveToneMappingPass relies on LuminosityShader');
        ...
        if (ToneMapShader === undefined)
            console.error('v3d.AdaptiveToneMappingPass relies on ToneMapShader');
