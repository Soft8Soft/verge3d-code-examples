...
var SAOPass = function(scene, camera, depthTexture, useNormals, resolution) {
    ...
    if (SAOShader === undefined) {
        ...
        console.error('v3d.SAOPass relies on SAOShader');
    ...
    if (DepthLimitedBlurShader === undefined) {
        ...
        console.error('v3d.SAOPass relies on DepthLimitedBlurShader');
    ...
    if (CopyShader === undefined) {
        ...
        console.error('v3d.SAOPass relies on CopyShader');
    ...
    if (UnpackDepthRGBAShader === undefined) {
        ...
        console.error('v3d.SAOPass relies on UnpackDepthRGBAShader');
