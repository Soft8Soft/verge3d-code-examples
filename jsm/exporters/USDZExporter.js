...
function buildMaterial(material, textures) {
    ...
    if (material.side === DoubleSide) {
        ...
        console.warn('v3d.USDZExporter: USDZ does not support double sided materials', material);
...
function buildCamera(camera) {
    ...
    if (camera.matrixWorld.determinant() < 0) {
        ...
        console.warn('v3d.USDZExporter: USDZ does not support negative scales', camera);
