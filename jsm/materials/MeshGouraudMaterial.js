...
import { UniformsUtils, UniformsLib, ShaderMaterial, Color, MultiplyOperation } from 'v3d';
...
class MeshGouraudMaterial extends ShaderMaterial {
    ...
    constructor(parameters) {
        ...
        //this.color = new v3d.Color(0xffffff); // diffuse
        ...
        //this.emissive = new v3d.Color(0x000000);
