...
class ProgressiveLightMap {
    ...
    constructor(renderer, res = 1024) {
        ...
        this.tinyTarget = new v3d.WebGLRenderTarget(1, 1);
        this.buffer1Active = false;
        this.firstUpdate = true;
        this.warned = false;

        // Create the Progressive LightMap Texture
        const format = /(Android|iPad|iPhone|iPod)/g.test(navigator.userAgent) ? v3d.HalfFloatType : v3d.FloatType;
        this.progressiveLightMap1 = new v3d.WebGLRenderTarget(this.res, this.res, { type: format });
        this.progressiveLightMap2 = new v3d.WebGLRenderTarget(this.res, this.res, { type: format });

        // Inject some spicy new logic into a standard phong material
        this.uvMat = new v3d.MeshPhongMaterial();
        this.uvMat.uniforms = {};
    ...
    */
    showDebugLightmap(visible, position = undefined) {
        ...
        if (this.labelMesh == null) {
            ...
            this.labelMaterial = new v3d.MeshBasicMaterial(
                { map: this.progressiveLightMap1.texture, side: v3d.DoubleSide });
            this.labelPlane = new v3d.PlaneGeometry(100, 100);
            this.labelMesh = new v3d.Mesh(this.labelPlane, this.labelMaterial);
