...
class OculusHandPointerModel extends v3d.Object3D {
    ...
    _updatePointerVertices(rearRadius) {
        ...
        const frontFaceBase = new v3d.Vector3(
        ...
        const rearBase = new v3d.Vector3(
        ...
        const frontCenter = new v3d.Vector3(
            0,
            0,
            -1 * (POINTER_LENGTH - rearRadius)
        );
        ...
        const rearCenter = new v3d.Vector3(0, 0, rearRadius);
        ...
        this.pointerGeometry.setAttribute(
            'position',
            new v3d.Float32BufferAttribute(vertices, 3)
        );
    ...
    createPointer() {
        ...
        // const vertices = [];
        const indices = [];
        this.pointerGeometry = new v3d.BufferGeometry();
        ...
        this.pointerMesh = new v3d.Mesh(this.pointerGeometry, material);

        this.pointerMesh.position.set(0, 0, -1 * POINTER_REAR_RADIUS);
        this.pointerObject = new v3d.Object3D();
        this.pointerObject.add(this.pointerMesh);

        this.raycaster = new v3d.Raycaster();

        // create cursor
        const cursorGeometry = new v3d.SphereGeometry(CURSOR_RADIUS, 10, 10);
        const cursorMaterial = new v3d.MeshBasicMaterial();
        cursorMaterial.transparent = true;
        cursorMaterial.opacity = POINTER_OPACITY_MIN;

        this.cursorObject = new v3d.Mesh(cursorGeometry, cursorMaterial);
    ...
    checkIntersections(objects, recursive = false) {
        ...
        if (this.raycaster && ! this.attached) {
            ...
            const direction = new v3d.Vector3(0, 0, -1);
