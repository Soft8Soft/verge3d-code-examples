import { BufferAttribute, Vector3, Vector2, Plane, Line3, Triangle, Sphere, Matrix4, BackSide, DoubleSide, Box3, FrontSide, Object3D, BufferGeometry, Group, LineBasicMaterial, MeshBasicMaterial, Ray, Mesh, RGBAFormat, RGFormat, RedFormat, RGBAIntegerFormat, RGIntegerFormat, RedIntegerFormat, DataTexture, NearestFilter, IntType, UnsignedIntType, FloatType, UnsignedByteType, UnsignedShortType, ByteType, ShortType, Vector4, Matrix3 } from 'v3d';
...
// Ripped and modified From v3d.js Mesh raycast
...
const _positionVector = new Vector3();
const _normalVector = new Vector3();
const _tangentVector = new Vector3();
const _tangentVector4 = new Vector4();

const _morphVector = new Vector3();
