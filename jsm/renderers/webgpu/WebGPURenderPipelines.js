...
class WebGPURenderPipelines {
    ...
    get(object) {
        ...
        if (pipeline === undefined) {
            ...
            if (material.isMeshBasicMaterial) {
                ...
                console.error('v3d.WebGPURenderer: Unknwon shader type.');
    ...
    _getArrayStride(type) {
        ...
        console.error('v3d.WebGPURenderer: Shader variable type not supported yet.', type);
    ...
    _getAlphaBlend(material) {
        ...
        switch (blending) {
            ...
            default:
                console.error('v3d.WebGPURenderer: Blending not supported.', blending);
    ...
    _getBlendFactor(blend) {
        ...
        switch (blend) {
            ...
            default:
                console.error('v3d.WebGPURenderer: Blend factor not supported.', blend);
    ...
    _getBlendOperation(blendEquation) {
        ...
        switch (blendEquation) {
            ...
            default:
                console.error('v3d.WebGPURenderer: Blend equation not supported.', blendEquation);
    ...
    _getDepthCompare(material) {
        ...
        if (material.depthTest === false) {
            ...
            switch (depthFunc) {
                ...
                default:
                    console.error('v3d.WebGPURenderer: Invalid depth function.', depthFunc);
    ...
    _getRasterizationStateDescriptor(material) {
        ...
        switch (material.side) {
            ...
            default:
                console.error('v3d.WebGPURenderer: Unknown Material.side value.', material.side);
                break;
    ...
    _getStencilCompare(material) {
        ...
        switch (stencilFunc) {
            ...
            default:
                console.error('v3d.WebGPURenderer: Invalid stencil function.', stencilFunc);
    ...
    _getStencilOperation(op) {
        ...
        switch (op) {
            ...
            default:
                console.error('v3d.WebGPURenderer: Invalid stencil operation.', stencilOperation);
