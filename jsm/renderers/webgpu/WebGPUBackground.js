...
import { Color, Mesh, BoxGeometry, BackSide, EquirectangularReflectionMapping, EquirectangularRefractionMapping } from 'v3d';
...
class WebGPUBackground {
    ...
    update(renderList, scene) {
        ...
        if (background === null) {
            ...
            console.error('v3d.WebGPURenderer: Unsupported background configuration.', background);
