    ...
    updateTexture(texture) {
        ...
        if (texture.version > 0 && textureProperties.version !== texture.version) {
            ...
            if (image === undefined) {
                ...
                console.warn('v3d.WebGPURenderer: Texture marked for update but image is undefined.');

            } else if (image.complete === false) {

                console.warn('v3d.WebGPURenderer: Texture marked for update but image is incomplete.');
